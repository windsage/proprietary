...
static const struct {
	...
	{ 45, 0, "Flash Driver Service" },
	{ 46, 0, "Application Traffic Pairing" },
	{ 47, 0, "Data Port Mapper" },
	{ 48, 0, "Data Filter Service" },
	{ 49, 0, "IPA control service" },
	{ 51, 0, "CoreSight remote tracing service" },
	{ 52, 0, "Dynamic Heap Memory Sharing" },
	{ 53, 0, "Subsystem Request" },
	{ 55, 0, "Sensor Location Interface Manager" },
	{ 64, 0, "Service registry locator service" },
	{ 66, 0, "Service registry notification service" },
	{ 68, 0, "Over The Top service" },
	{ 69, 0, "ATH10k WLAN firmware service" },
	{ 71, 0, "UIM HTTP service" },
	{ 73, 0, "DATA INT service" },
	{ 74, 0, "ANT SWITCH service" },
	{ 76, 0, "SSG ConnSec service" },
	{ 77, 0, "IMS Private Service" },
	{ 78, 0, "Data Flow Control (DFC) Service" },
	{ 85, 0, "SSG QMSCA service" },
	{ 86, 0, "DTP service" },
	{ 87, 0, "Smart Transmit service" },
	{ 88, 0, "Qualcomm ML Context Event Exchange Private Service" },
	{ 90, 0, "Qualcomm Modem service" },
	...
	{ 1061, 0, "Telematics Power Manager Service" },
	{ 1062, 0, "Telematics SDK Audio Server" },
	{ 1063, 0, "Telematics TSENS Service" },
	{ 1064, 0, "ADSP LPM voting service" },
	{ 1071, 0, "DPED service" },
	{ 1072, 0, "Telux thermal service" },
	{ 4096, 0, "TFTP service" },
	{ DIAG_SERVICE, 0, "DIAG service" },
	{ 5001, 0, "Location HAL daemon service" },
	{ 5002, 0, "Location remote client service" },
	{ 5004, 0, "GNSS CDFW service" },
};
...
static const char *diag_instance_base_str(unsigned int instance_base)
{
	switch (instance_base) {
		...
		case 6: return "NPU";
		case 7: return "NSP1";
		case 8: return "GPDSP0";
		case 9: return "GPDSP1";
		case 10: return "HELIOS";
		case 11: return "TELE_GVM";
		case 12: return "FOTA_GVM";
		default: return "<unk>";
	}
}
