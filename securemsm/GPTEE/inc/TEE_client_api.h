...
Copyright (c) 2014, 2022-2023 Qualcomm Technologies, Inc.
All Rights Reserved.
...
/* Max WTX retry count exceeded */
#define TEEC_ERROR_WTX_TIMEOUT  (0x80003001)
 ...
 * from 0x80000000 to 0xFFFFFFFF Behavior is implementation-defined.
 */
 ...
 * The QTVM SDK allows only Trusted Applications to access the global clientEnv
 * object through the applib library. This API allows the clientEnv to be
 * propagated from the Trusted Application to the internal library.
 * @param[in] mClientEnv: ClientEnv object stored in the QTVM SDK of applib library
 * this object must be passed to GP Library before calling an GP standard API.
