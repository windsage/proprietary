...
#define IPFM_FEATURE_STATUS_ALLOWED UINT64_C(0x00000000)
#define IPFM_FEATURE_STATUS_NOT_ALLOWED UINT64_C(0x00000001)
#define IPFM_FEATURE_STATUS_PROCESSING_ERROR UINT64_C(0x00000003)
#define IPFM_FEATURE_STATUS_NO_LICENSES UINT64_C(0x00000004)
#define IPFM_FEATURE_STATUS_GRACE_ACTIVATION_NEEDED UINT64_C(0x00000005)
#define IPFM_TRANSACTION_STATUS_SUCCESS UINT64_C(0x00000000)
#define IPFM_TRANSACTION_STATUS_INCOMPLETE UINT64_C(0x00000001)
#define IPFM_TRANSACTION_STATUS_FAIL UINT64_C(0x00000002)
#define IPFM_EVENT_TYPE_STATE_CHANGE UINT64_C(0x00000000)
...
#define IPFM_ERROR_QWESSTORE_MEMORY_FULL INT32_C(52)
#define IPFM_ERROR_REVOCATION_LIST INT32_C(53)
#define IPFM_ERROR_UNSUPPORTED_REVOCATION_FID INT32_C(54)
#define IPFM_ERROR_REVOCATION_UNSUPPORTED INT32_C(55)
#define IPFM_ERROR_REVOCATION_LIST_FULL INT32_C(56)
#define IPFM_ERROR_REV_LIC_ALREADY_PROCESSED INT32_C(57)
#define IPFM_ERROR_LICENSE_ALREADY_REVOKED INT32_C(58)
#define IPFM_ERROR_INVALID_TRANSACTION_COUNT INT32_C(59)
#define IPFM_ERROR_REVOCATION_FID_UNAVAILABLE INT32_C(60)
...
#define IPFM_ERROR_GPBTTA_GRACE_EXPIRED INT32_C(66)
#define IPFM_ERROR_GRACE_COUNT_EXHAUSTED INT32_C(67)
...
#define IPFM_OP_RegisterCallback 22
...
static inline int32_t
IPFM_RegisterCallback(Object self, Object Callback_val, const void *FidsCBOR_ptr, size_t FidsCBOR_len, void *ResponseCBOR_ptr, size_t ResponseCBOR_len, size_t *ResponseCBOR_lenout, Object *CallbackHandle_ptr)
{
  ObjectArg a[4]={{{0,0}}};
  a[2].o = Callback_val;
  ...
  int32_t result = Object_invoke(self, IPFM_OP_RegisterCallback, a, ObjectCounts_pack(1, 1, 1, 1));

  *ResponseCBOR_lenout = a[1].b.size / 1;
  *CallbackHandle_ptr = a[3].o;
