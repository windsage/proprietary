...
extern "C++" int GetAesKeyExportDeUserSuccess(void);
extern "C++" int RebootAndAesKeyExportDeUser(void);
...
void usage(void) {
    ...
    printf("   " APP_NAME " 7\n");
    printf("To run AES Wrapped Key sample:\n");
    printf("   " APP_NAME " 8\n");
...
int main(int argc, char **argv) {
    ...
    switch (argv[1][0]) {
        ...
        case '7':
            ...
            break;
        case '8':
            err = GetAesKeyExportDeUserSuccess();
            break;
        case '9':
            err = RebootAndAesKeyExportDeUser();
            break;
        case 'a':
