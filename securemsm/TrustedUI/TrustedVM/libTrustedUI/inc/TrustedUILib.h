...
typedef struct TUISessionConfig {
  ...
  int32_t sessionTimeOut;      /* Delete coreservice session if timeout (in
                                  milliseconds) occurs, negative value indicates
                                  NO session timeout */
  uint32_t enableSystemEvents; /* Use system helper for system events */
};
...
/**----------------------------------------------------------------------------
  @title  TUISessionStatus
  @brief  Session status
-----------------------------------------------------------------------------*/
typedef enum TUISessionStatus {
    TUI_SESSION_OK = 0x0,
    TUI_SESSION_ABORTING = 0x1,
} tuiSessionStatus_t;
...
/**----------------------------------------------------------------------------
  ...
  @return TUIResult
-----------------------------------------------------------------------------*/
TUIResult TUIGetColorModes(uint32_t sessionId, displayColorModes *colorModes);
...
/**----------------------------------------------------------------------------
  ...
  @return TUIResult
-----------------------------------------------------------------------------*/
TUIResult TUISetColorMode(uint32_t sessionId, displayColorMode *colorMode);
