/********************************************************************
  ---------------------------------------------------------------------
  Copyright (c) 2015-2016, 2020-2021, 2023 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
/* After using the unwrapped font Fd from TUIApp, we need to release the font Object obtained from HLOS */
extern Object gFontFdObject;
        ...
        uint32_t *respDataSize)
{
    ...
    qseeRes = gFontMgrCallcback(req, reqSize, &fontFd,
    ...
    appBuffer = (uint8_t*)mmap(
            NULL, appBufferLen, PROT_READ, MAP_SHARED, fontFd, 0);
    if (NULL == appBuffer)
    {
...
cleanup:
    ...
    Object_ASSIGN_NULL(gFontFdObject);
