...
#include "CTTouchControlService.hpp"
#include "ITrustedInput.hpp"
#include "ITrustedInput_invoke.hpp"
#include "ITTouchControlService.hpp"
...
class CTouchInput : public TrustedInputImplBase
{
    ...
    *****************************************************************************/
    ...
    string mTouchDevicePathFile = "";
    /* FDs for Event and Touch */
    int32_t mAbortFd = -1;
    ...
    inline static const std::vector<std::string> controlFileName = {"trusted_touch_type",
                                                                    ...
                                                                    "trusted_touch_device_path"};
    inline static const std::string mQTSFileLocation = {"/sys/kernel/qts/"};
    std::string mDeviceBusPath = "";
    ATOMIC(uint32_t) refcount;

    ITTouchControlService *mTouchControl = nullptr;
    ...
    */
    ...
    /* Description :  This API is used to get Bus path for touch device
    *
    * Return :  -EINVAL
    *           ITrustedInput::SUCCESS,
    *
    */
    int32_t getDeviceBusPath();

    /* Description :  This API is used to release touch if mink hub dies
    *
    * Return :  ITrustedInput::ERROR_OPEN_CONTROLFD
    *           ITrustedInput::ERROR_ACCESS_CONTROLFD
    *           ITrustedInput::ERROR_WRITE_CONTROLFD
    *           ITrustedInput::SUCCESS,
    *
    */
    int32_t releaseTouchHubDied();
    ...
    *
    *
    * In : displayType : displayType value from the Coreservice.
    ...
    *
    */
    int32_t init(uint32_t displayType, uint32_t screenX, uint32_t screenY);
    ...
    *
    */
    int32_t registerCallback(const TrustedInputCallBack &TouchInputCBORef);
    ...
    *
    */
    int32_t deregisterCallback();

    CTouchInput() : refcount(1) { TUILOGD("CTouchInput: Constructor");}
    ~CTouchInput() {
        TUILOGD("~CTouchInput: Destructor");
        this->terminate();
    }
};
