...
class AuthorizationSetBuilder {
  public:
    ...
    AuthorizationSetBuilder& EcdsaKeyCurve(keymaster_ec_curve_t curve);
    ...
    AuthorizationSetBuilder& EcdsaSigningKeyCurve(keymaster_ec_curve_t key_size);
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::EcdsaKeyCurve(keymaster_ec_curve_t curve) {
    Authorization(TAG_ALGORITHM, KM_ALGORITHM_EC);
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::EcdsaSigningKeyCurve(keymaster_ec_curve_t curve) {
    EcdsaKeyCurve(curve);
    return SigningKey();
}
