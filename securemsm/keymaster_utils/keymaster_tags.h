...
typedef struct {
    ...
    uint8_t nonce[KM_HMAC_PARAMS_SIZE];
    size_t seed_length;
} hmac_sharing_with_seed_len_params_t;
...
static const keymaster_tag_t KM_TAG_BIND_KEYS_TO_GK_DATA =
        static_cast<keymaster_tag_t>(KM_UINT | 15001);
...
// New KM41 tags
static const keymaster_tag_t KM_TAG_STORAGE_KEY = static_cast<keymaster_tag_t>(KM_BOOL | 722);
