...
class KeymasterKeyProvision {
  public:
    ...
    int KeyMasterProvisionDeviceId(string Brand, string Device, string Product, string SerialNum,
                                   string Manufacturer, string Model, keymaster_device_id_t Imei, keymaster_device_id_t Meid);
    int SetProvisioningKeyboxSuccess();
    int SetProvisioningDeviceIdSuccess();
  ...
  private:
    ...
    int SetProvisioningKeyboxSuccessOld(void);
