...
#ifndef SYSTEM_KEYMINT_AUTHORIZATION_SET_H_
#define SYSTEM_KEYMINT_AUTHORIZATION_SET_H_
...
class AuthorizationSetBuilder {
  public:
    ...
    AuthorizationSetBuilder& EcdsaKey(keymaster_ec_curve_t curve);
    ...
    AuthorizationSetBuilder& EcdsaSigningKey(keymaster_ec_curve_t curve);
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::EcdsaKey(keymaster_ec_curve_t curve) {
    Authorization(TAG_ALGORITHM, KM_ALGORITHM_EC);
...
inline AuthorizationSetBuilder& AuthorizationSetBuilder::EcdsaSigningKey(keymaster_ec_curve_t curve) {
    EcdsaKey(curve);
    return SigningKey();
}
...
#endif  // SYSTEM_KEYMINT_KEY_AUTHORIZATION_SET_H_
