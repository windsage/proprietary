...
typedef struct km_auth_list {
    ...
    ASN1_OCTET_STRING* attestation_id_imei[KM_MAX_SUBS];
    ASN1_OCTET_STRING* attestation_id_meid[KM_MAX_SUBS];
...
ASN1_SEQUENCE(KM_AUTH_LIST) = {
        ...
        ASN1_EXP_OPT(KM_AUTH_LIST, attestation_id_imei[0], ASN1_OCTET_STRING,
                     TAG_ATTESTATION_ID_IMEI.masked_tag()),
        ASN1_EXP_OPT(KM_AUTH_LIST, attestation_id_meid[0], ASN1_OCTET_STRING,
                     TAG_ATTESTATION_ID_MEID.masked_tag()),
        ASN1_EXP_OPT(KM_AUTH_LIST, attestation_id_meid[1], ASN1_OCTET_STRING,
                     TAG_ATTESTATION_ID_MEID.masked_tag()),
        ...
        ASN1_EXP_OPT(KM_AUTH_LIST, attestation_id_imei[1], ASN1_OCTET_STRING,
...
static keymaster_error_t extract_auth_list(const KM_AUTH_LIST* record,
    ...
    // IMEI
    if (record->attestation_id_imei[0] &&
        !auth_list->push_back(TAG_ATTESTATION_ID_IMEI, record->attestation_id_imei[0]->data,
                              record->attestation_id_imei[0]->length))
        return KM_ERROR_MEMORY_ALLOCATION_FAILED;

    // MEID
    if (record->attestation_id_meid[0] &&
        !auth_list->push_back(TAG_ATTESTATION_ID_MEID, record->attestation_id_meid[0]->data,
                              record->attestation_id_meid[0]->length))
        return KM_ERROR_MEMORY_ALLOCATION_FAILED;

    if (record->attestation_id_meid[1] &&
        !auth_list->push_back(TAG_ATTESTATION_ID_MEID, record->attestation_id_meid[1]->data,
                              record->attestation_id_meid[1]->length))
        return KM_ERROR_MEMORY_ALLOCATION_FAILED;
    ...
    // Second IMEI
    if (record->attestation_id_imei[1] &&
        !auth_list->push_back(TAG_ATTESTATION_ID_SECOND_IMEI, record->attestation_id_imei[1]->data,
                             record->attestation_id_imei[1]->length))
       return KM_ERROR_MEMORY_ALLOCATION_FAILED;
