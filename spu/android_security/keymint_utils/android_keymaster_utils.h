...
#ifndef SYSTEM_KEYMINT_ANDROID_KEYMINT_UTILS_H_
#define SYSTEM_KEYMINT_ANDROID_KEYMINT_UTILS_H_
...
static inline uint8_t* dup_buffer(const void* buf, size_t size) {
...
#endif  // SYSTEM_KEYMINT_ANDROID_KEYMINT_UTILS_H_
