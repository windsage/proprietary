...
public:
  ...
  SegmentTimeoutMessage(uint16_t txId, SegmentTracker::MessageId_t msgId, SegmentationStatus_t status, std::string name)
  ...
  std::string getEndPointName() {return mEndpointname;}
};
