...
public:
  ...
  inline bool hasIsSecPdu() { return mIsSecPdu ? true : false; }
  inline uint32_t getIsSecPdu() { return *mIsSecPdu; }
  inline void setIsSecPdu(bool isSecPdu) { mIsSecPdu = isSecPdu; }
};
