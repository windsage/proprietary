...
enum class AttachListAction {
  NONE,
  DISCONNECT_ATTACH_APN_ONLY,
};

enum class AttachListCap {
  ACTION_SUPPORTED,
  ACTION_NOT_SUPPORTED
};

enum class BringUpCapability {
  BRING_UP_LEGACY = 1 << 0,
  BRING_UP_APN_NAME = 1 << 1,
  BRING_UP_APN_TYPE = 1 << 2,
};
