...
#define ATP_V01_IDL_MINOR_VERS 0x01
...
/** @addtogroup atp_qmi_messages
    @{
  */
/** Request Message; Queries the ATP activation status. */
typedef struct {
...
/** @addtogroup atp_qmi_messages
    @{
  */
/** Request Message; Queries the ATP policy information. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Update Interval */
  uint8_t update_interval_valid;  /**< Must be set to true if update_interval is being passed */
  uint32_t update_interval;
  /**<   Update interval in milliseconds.
  */

  /* Optional */
  /*  Is Application Statistic Feature */
  uint8_t is_app_statistics_valid;  /**< Must be set to true if is_app_statistics is being passed */
  uint8_t is_app_statistics;
  /**<   Application statistic status. Values:\n
      - 0: Application statistic OFF.\n
      - 1: Enable application statistic instead of ATP feature.
  */
...
/** @addtogroup atp_qmi_enums
  ...
  */
typedef enum {
  ATP_FILTER_APP_STATUS_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  ATP_FILTER_APP_STATUS_BACKGROUND_V01 = 0, /**<  background \n */
  ATP_FILTER_APP_STATUS_FOREGROUND_V01 = 1, /**<  foreground  */
  ATP_FILTER_APP_STATUS_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}atp_filter_app_status_enum_type_v01;
/**
    @}
  */
 ...
 */
  ...
  /**<   Application statistic status. Values:\n
      - 0: Application statistic OFF.\n
      - 1: Application statistic ON instead of ATP feature.
  */

  /* Optional */
  /*  AP timestamp */
  uint8_t ap_timestamp_valid;  /**< Must be set to true if ap_timestamp is being passed */
  uint64_t ap_timestamp;
  /**<   AP timestamp in milliseconds in UTC format
       to indicate the time the report is sent.
                             */

  /* Optional */
  /*  Application Status */
  uint8_t app_status_valid;  /**< Must be set to true if app_status is being passed */
  atp_filter_app_status_enum_type_v01 app_status;
  /**<   Application status. Values: \n
      - ATP_FILTER_APP_STATUS_BACKGROUND (0) --  background \n
      - ATP_FILTER_APP_STATUS_FOREGROUND (1) --  foreground
 */
  ...
  /* Optional */
  /*  Last Interval Tx Bytes */
  uint8_t tx_bytes_in_last_interval_valid;  /**< Must be set to true if tx_bytes_in_last_interval is being passed */
  uint32_t tx_bytes_in_last_interval;
  /**<   Number of TX bytes transmitted since the last report.
     */

  /* Optional */
  /*  Last Interval Rx Bytes */
  uint8_t rx_bytes_in_last_interval_valid;  /**< Must be set to true if rx_bytes_in_last_interval is being passed */
  uint32_t rx_bytes_in_last_interval;
  /**<   Number of RX bytes received since the last report.
     */
...
//#define REMOVE_QMI_ATP_ACTIVATION_STATUS_IND_V01
//#define REMOVE_QMI_ATP_ACTIVATION_STATUS_QUERY_V01
//#define REMOVE_QMI_ATP_GET_SUPPORTED_FIELDS_V01
//#define REMOVE_QMI_ATP_GET_SUPPORTED_MSGS_V01
//#define REMOVE_QMI_ATP_INDICATION_REGISTER_V01
//#define REMOVE_QMI_ATP_POLICY_INFO_CHANGE_IND_V01
//#define REMOVE_QMI_ATP_POLICY_INFO_QUERY_V01
//#define REMOVE_QMI_ATP_SEND_FILTER_REPORT_V01
//#define REMOVE_QMI_ATP_SEND_FILTER_REPORT_IND_V01
