...
#define DFS_V01_IDL_MINOR_VERS 0x10
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DFS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DFS_V01_MAX_MESSAGE_ID 0x0044
/**
    @}
  */
...
/** @addtogroup dfs_qmi_enums
  ...
  */
typedef enum {
  DFS_POWERSAVE_FILTER_TYPE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DFS_POWERSAVE_FILTER_TYPE_WHITELIST_V01 = 1, /**<  Powersave filter type is WHITELIST.
       Route the packet to upper layers if it
       matches any installed filter.This is
       the default value */
  DFS_POWERSAVE_FILTER_TYPE_BLACKLIST_V01 = 2, /**<  Powersave filter type is BLACKLIST.
       Drop the packet if it matches any
	   installed filter */
  DFS_POWERSAVE_FILTER_TYPE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dfs_powersave_filter_type_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  dfs_ipv4_addr_type_v01 ip_addr;
  /**<     IPv4 address.
   */
}dfs_ipv4_addr_type_ex_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  dfs_ipv6_addr_type_v01 ip_addr;
  /**<     IPv6 address.
   */
}dfs_ipv6_addr_type_ex_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<     IPv6 traffic class.
   */
}dfs_ipv6_trf_class_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<     IPv6 flow label.
   */
}dfs_ipv6_flow_label_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  dfs_port_type_v01 port_info;
  /**<     Port information.
  */
}dfs_port_info_ex_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<     ICMP type.
  */
}dfs_icmp_type_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<     ICMP code.
  */
}dfs_icmp_code_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<     SPI for ESP.
   */
}dfs_esp_spi_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<     Filter handle
   */
}dfs_filter_handle_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  dfs_filter_param_error_mask_v01 filter_error_mask;
  /**<     Filter error mask
   */
}dfs_filter_error_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Filter status \n
      ...
      - DFS_FILTER_STATUS_MAX (0xFF) --  Filter status max \n
 */
}dfs_filter_status_info_ex_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Maximum LL Filters */
  uint8_t max_ll_filters_valid;  /**< Must be set to true if max_ll_filters is being passed */
  dfs_filter_capability_type_v01 max_ll_filters;
  /**<    \n( Maximum number of filters that can be added on modem for LL
            , in total, and per filter add requests.)
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Filter Type */
  uint8_t powersave_filter_type_valid;  /**< Must be set to true if powersave_filter_type is being passed */
  dfs_powersave_filter_type_enum_v01 powersave_filter_type;
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Query all powersave filters. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dfs_query_powersave_filters_req_msg_v01;
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Query all powersave filters. */
typedef struct {
  ...
  /* Optional */
  /*  Filter Rules */
  uint8_t powersave_filter_rules_valid;  /**< Must be set to true if powersave_filter_rules is being passed */
  uint32_t powersave_filter_rules_len;  /**< Must be set to # of elements in powersave_filter_rules */
  dfs_filter_rule_type_v01 powersave_filter_rules[QMI_DFS_MAX_FILTERS_V01];
}dfs_query_powersave_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Remote Socket Allocated  */
  uint8_t report_remote_socket_allocated_valid;  /**< Must be set to true if report_remote_socket_allocated is being passed */
  uint8_t report_remote_socket_allocated;
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report remote socket allocated
  */

  /* Optional */
  /*  LL Filter Update  */
  uint8_t report_ll_filter_update_valid;  /**< Must be set to true if report_ll_filter_update is being passed */
  uint8_t report_ll_filter_update;
  /**<   Values:  \n
       - 0 -- Do not report \n
       - 1 -- Report low latency filter update used for steering data
		      on low latency channel towards the TE
    */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Indication Message; Sends a list of allocated sockets with other qualifying information. */
typedef struct {
  ...
  /**<   \n List of sockets allocated on the TE for use by the modem.
    */
}dfs_remote_socket_allocated_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Filter Ids for filter rules */
  uint32_t filter_ids_len;  /**< Must be set to # of elements in filter_ids */
  uint16_t filter_ids[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n Unique identifier for a filter used to correlate various
  filter parameters passed in the rest of the TLVs of this message. */

  /* Optional */
  /*  IPV4 Source Address Filter Rules */
  uint8_t ipv4_src_addr_filter_rules_valid;  /**< Must be set to true if ipv4_src_addr_filter_rules is being passed */
  uint32_t ipv4_src_addr_filter_rules_len;  /**< Must be set to # of elements in ipv4_src_addr_filter_rules */
  dfs_ipv4_addr_type_ex_v01 ipv4_src_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v4 source address filter rules. */

  /* Optional */
  /*  IPV4 Destination Address Filter Rules */
  uint8_t ipv4_dest_addr_filter_rules_valid;  /**< Must be set to true if ipv4_dest_addr_filter_rules is being passed */
  uint32_t ipv4_dest_addr_filter_rules_len;  /**< Must be set to # of elements in ipv4_dest_addr_filter_rules */
  dfs_ipv4_addr_type_ex_v01 ipv4_dest_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v4 destination address filter rules. */

  /* Optional */
  /*  IPV4 TOS Filter Rules */
  uint8_t ipv4_tos_filter_rules_valid;  /**< Must be set to true if ipv4_tos_filter_rules is being passed */
  uint32_t ipv4_tos_filter_rules_len;  /**< Must be set to # of elements in ipv4_tos_filter_rules */
  dfs_ipv4_tos_type_ex_v01 ipv4_tos_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v4 TOS filter rules. */

  /* Optional */
  /*  IPV6 Source Address Filter Rules */
  uint8_t ipv6_src_addr_filter_rules_valid;  /**< Must be set to true if ipv6_src_addr_filter_rules is being passed */
  uint32_t ipv6_src_addr_filter_rules_len;  /**< Must be set to # of elements in ipv6_src_addr_filter_rules */
  dfs_ipv6_addr_type_ex_v01 ipv6_src_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 source address filter rules. */

  /* Optional */
  /*  IPV6 Destination  Address Filter Rules */
  uint8_t ipv6_dest_addr_filter_rules_valid;  /**< Must be set to true if ipv6_dest_addr_filter_rules is being passed */
  uint32_t ipv6_dest_addr_filter_rules_len;  /**< Must be set to # of elements in ipv6_dest_addr_filter_rules */
  dfs_ipv6_addr_type_ex_v01 ipv6_dest_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 destination address filter rules. */

  /* Optional */
  /*  IPV6 Traffic Class Filter Rules */
  uint8_t ipv6_trf_class_filter_rules_valid;  /**< Must be set to true if ipv6_trf_class_filter_rules is being passed */
  uint32_t ipv6_trf_class_filter_rules_len;  /**< Must be set to # of elements in ipv6_trf_class_filter_rules */
  dfs_ipv6_trf_class_type_v01 ipv6_trf_class_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 traffic class filter rules. */

  /* Optional */
  /*  IPV6 Flow Label Filter Rules */
  uint8_t ipv6_flow_label_filter_rules_valid;  /**< Must be set to true if ipv6_flow_label_filter_rules is being passed */
  uint32_t ipv6_flow_label_filter_rules_len;  /**< Must be set to # of elements in ipv6_flow_label_filter_rules */
  dfs_ipv6_flow_label_type_v01 ipv6_flow_label_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 flow label filter rules. */

  /* Optional */
  /*  UDP Source Port Filter Rules */
  uint8_t udp_src_port_filter_rules_valid;  /**< Must be set to true if udp_src_port_filter_rules is being passed */
  uint32_t udp_src_port_filter_rules_len;  /**< Must be set to # of elements in udp_src_port_filter_rules */
  dfs_port_info_ex_type_v01 udp_src_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of UDP source port rules. */

  /* Optional */
  /*  UDP Destination Port Filter Rules */
  uint8_t udp_dest_port_filter_rules_valid;  /**< Must be set to true if udp_dest_port_filter_rules is being passed */
  uint32_t udp_dest_port_filter_rules_len;  /**< Must be set to # of elements in udp_dest_port_filter_rules */
  dfs_port_info_ex_type_v01 udp_dest_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of UDP destination port rules. */

  /* Optional */
  /*  TCP Source Port Filter Rules */
  uint8_t tcp_src_port_filter_rules_valid;  /**< Must be set to true if tcp_src_port_filter_rules is being passed */
  uint32_t tcp_src_port_filter_rules_len;  /**< Must be set to # of elements in tcp_src_port_filter_rules */
  dfs_port_info_ex_type_v01 tcp_src_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of TCP source port rules. */

  /* Optional */
  /*  TCP Destination Port Filter Rules */
  uint8_t tcp_dest_port_filter_rules_valid;  /**< Must be set to true if tcp_dest_port_filter_rules is being passed */
  uint32_t tcp_dest_port_filter_rules_len;  /**< Must be set to # of elements in tcp_dest_port_filter_rules */
  dfs_port_info_ex_type_v01 tcp_dest_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of TCP destination port rules. */

  /* Optional */
  /*  ICMP type Filter Rules */
  uint8_t icmp_type_filter_rules_valid;  /**< Must be set to true if icmp_type_filter_rules is being passed */
  uint32_t icmp_type_filter_rules_len;  /**< Must be set to # of elements in icmp_type_filter_rules */
  dfs_icmp_type_info_type_v01 icmp_type_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of ICMP type rules. */

  /* Optional */
  /*  ICMP code Filter Rules */
  uint8_t icmp_code_filter_rules_valid;  /**< Must be set to true if icmp_code_filter_rules is being passed */
  uint32_t icmp_code_filter_rules_len;  /**< Must be set to # of elements in icmp_code_filter_rules */
  dfs_icmp_code_info_type_v01 icmp_code_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of ICMP code rules. */

  /* Optional */
  /*  ESP SPI Filter Rules */
  uint8_t esp_spi_filter_rules_valid;  /**< Must be set to true if esp_spi_filter_rules is being passed */
  uint32_t esp_spi_filter_rules_len;  /**< Must be set to # of elements in esp_spi_filter_rules */
  dfs_esp_spi_info_type_v01 esp_spi_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of ESP SPI rules. */

  /* Optional */
  /*  AH SPI Filter Rules */
  uint8_t ah_spi_filter_rules_valid;  /**< Must be set to true if ah_spi_filter_rules is being passed */
  uint32_t ah_spi_filter_rules_len;  /**< Must be set to # of elements in ah_spi_filter_rules */
  dfs_ah_spi_info_type_v01 ah_spi_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of AH SPI rules. */

  /* Optional */
  /*  Filter Type */
  uint8_t powersave_filter_type_valid;  /**< Must be set to true if powersave_filter_type is being passed */
  dfs_powersave_filter_type_enum_v01 powersave_filter_type;
}dfs_add_powersave_filters_ex_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t filter_handles_valid;  /**< Must be set to true if filter_handles is being passed */
  uint32_t filter_handles_len;  /**< Must be set to # of elements in filter_handles */
  dfs_filter_handle_type_v01 filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles that uniquely identifies filter rules that have been added.
       This TLV is returned when there is no error.
   */
  ...
  uint8_t filter_rule_error_valid;  /**< Must be set to true if filter_rule_error is being passed */
  uint32_t filter_rule_error_len;  /**< Must be set to # of elements in filter_rule_error */
  dfs_filter_error_type_v01 filter_rule_error[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of error masks that contain errors for each filter id. This TLV
       is returned when the error is QMI_ERR_INVALID_ARG. @MASK()
   */
}dfs_add_powersave_filters_ex_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Adds list of filters to steer data on low latency data channel */
typedef struct {
  ...
  uint8_t ipv4_src_addr_filter_rules_valid;  /**< Must be set to true if ipv4_src_addr_filter_rules is being passed */
  uint32_t ipv4_src_addr_filter_rules_len;  /**< Must be set to # of elements in ipv4_src_addr_filter_rules */
  data_ipv4_addr_ex_type_v01 ipv4_src_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v4 source address filter rules. */
  ...
  uint8_t ipv4_dest_addr_filter_rules_valid;  /**< Must be set to true if ipv4_dest_addr_filter_rules is being passed */
  uint32_t ipv4_dest_addr_filter_rules_len;  /**< Must be set to # of elements in ipv4_dest_addr_filter_rules */
  data_ipv4_addr_ex_type_v01 ipv4_dest_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v4 destination address filter rules. */
  ...
  uint8_t ipv4_tos_filter_rules_valid;  /**< Must be set to true if ipv4_tos_filter_rules is being passed */
  uint32_t ipv4_tos_filter_rules_len;  /**< Must be set to # of elements in ipv4_tos_filter_rules */
  data_ipv4_tos_ex_type_v01 ipv4_tos_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v4 TOS filter rules. */
  ...
  uint8_t ipv6_src_addr_filter_rules_valid;  /**< Must be set to true if ipv6_src_addr_filter_rules is being passed */
  uint32_t ipv6_src_addr_filter_rules_len;  /**< Must be set to # of elements in ipv6_src_addr_filter_rules */
  data_ipv6_addr_ex_type_v01 ipv6_src_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 source address filter rules. */
  ...
  uint8_t ipv6_dest_addr_filter_rules_valid;  /**< Must be set to true if ipv6_dest_addr_filter_rules is being passed */
  uint32_t ipv6_dest_addr_filter_rules_len;  /**< Must be set to # of elements in ipv6_dest_addr_filter_rules */
  data_ipv6_addr_ex_type_v01 ipv6_dest_addr_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 destination address filter rules. */
  ...
  uint8_t ipv6_trf_class_filter_rules_valid;  /**< Must be set to true if ipv6_trf_class_filter_rules is being passed */
  uint32_t ipv6_trf_class_filter_rules_len;  /**< Must be set to # of elements in ipv6_trf_class_filter_rules */
  data_ipv6_trf_cls_ex_type_v01 ipv6_trf_class_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 traffic class filter rules. */
  ...
  uint8_t ipv6_flow_label_filter_rules_valid;  /**< Must be set to true if ipv6_flow_label_filter_rules is being passed */
  uint32_t ipv6_flow_label_filter_rules_len;  /**< Must be set to # of elements in ipv6_flow_label_filter_rules */
  data_ipv6_flow_label_type_v01 ipv6_flow_label_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of v6 flow label filter rules. */
  ...
  uint8_t udp_src_port_filter_rules_valid;  /**< Must be set to true if udp_src_port_filter_rules is being passed */
  uint32_t udp_src_port_filter_rules_len;  /**< Must be set to # of elements in udp_src_port_filter_rules */
  data_port_ex_type_v01 udp_src_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of UDP source port rules. */
  ...
  uint8_t udp_dest_port_filter_rules_valid;  /**< Must be set to true if udp_dest_port_filter_rules is being passed */
  uint32_t udp_dest_port_filter_rules_len;  /**< Must be set to # of elements in udp_dest_port_filter_rules */
  data_port_ex_type_v01 udp_dest_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of UDP destination port rules. */
  ...
  uint8_t tcp_src_port_filter_rules_valid;  /**< Must be set to true if tcp_src_port_filter_rules is being passed */
  uint32_t tcp_src_port_filter_rules_len;  /**< Must be set to # of elements in tcp_src_port_filter_rules */
  data_port_ex_type_v01 tcp_src_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of TCP source port rules. */
  ...
  uint8_t tcp_dest_port_filter_rules_valid;  /**< Must be set to true if tcp_dest_port_filter_rules is being passed */
  uint32_t tcp_dest_port_filter_rules_len;  /**< Must be set to # of elements in tcp_dest_port_filter_rules */
  data_port_ex_type_v01 tcp_dest_port_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of TCP destination port rules. */
  ...
  uint8_t icmp_type_filter_rules_valid;  /**< Must be set to true if icmp_type_filter_rules is being passed */
  uint32_t icmp_type_filter_rules_len;  /**< Must be set to # of elements in icmp_type_filter_rules */
  data_icmp_type_info_type_v01 icmp_type_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of ICMP type rules. */
  ...
  uint8_t icmp_code_filter_rules_valid;  /**< Must be set to true if icmp_code_filter_rules is being passed */
  uint32_t icmp_code_filter_rules_len;  /**< Must be set to # of elements in icmp_code_filter_rules */
  data_icmp_code_info_type_v01 icmp_code_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of ICMP code rules. */
  ...
  uint8_t esp_spi_filter_rules_valid;  /**< Must be set to true if esp_spi_filter_rules is being passed */
  uint32_t esp_spi_filter_rules_len;  /**< Must be set to # of elements in esp_spi_filter_rules */
  data_spi_info_type_v01 esp_spi_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of ESP SPI rules. */
  ...
  uint8_t ah_spi_filter_rules_valid;  /**< Must be set to true if ah_spi_filter_rules is being passed */
  uint32_t ah_spi_filter_rules_len;  /**< Must be set to # of elements in ah_spi_filter_rules */
  data_spi_info_type_v01 ah_spi_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of AH SPI rules. */
}dfs_add_ll_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Adds list of filters to steer data on low latency data channel */
typedef struct {
  ...
  /**<   List of error masks that contain errors for each filter id. This TLV
       is returned when the error is QMI_ERR_INVALID_ARG. @MASK()
   */
}dfs_add_ll_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Modifies a list of filters for steering data over low latency channel towards TE. */
typedef struct {
  ...
  uint32_t filter_handles_len;  /**< Must be set to # of elements in filter_handles */
  dfs_filter_handle_type_v01 filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles that uniquely identifies filter rules that need to be modified.
   */
  ...
  data_spi_info_type_v01 ah_spi_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of AH SPI rules. */
}dfs_modify_ll_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Modifies a list of filters for steering data over low latency channel towards TE. */
typedef struct {
  ...
  uint32_t filter_handles_len;  /**< Must be set to # of elements in filter_handles */
  dfs_filter_handle_type_v01 filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles that uniquely identifies filter rules that have been modified.
   */
  ...
  /**<   List of error masks that contain errors for each filter id. This TLV
       is returned when the error is QMI_ERR_INVALID_ARG. @MASK()
   */
}dfs_modify_ll_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Deletes a list of filters used to steer data on low latency channel towards TE. */
typedef struct {
  ...
  uint32_t filter_handles_len;  /**< Must be set to # of elements in filter_handles */
  dfs_filter_handle_type_v01 filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles that uniquely identifies filter rules that need to be deleted.
   */
}dfs_delete_ll_filters_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Deletes a list of filters used to steer data on low latency channel towards TE. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.     */
}dfs_delete_ll_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Request Message; Query the LL filters installed on the modem. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dfs_query_ll_filters_req_msg_v01;
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Response Message; Query the LL filters installed on the modem. */
typedef struct {
  ...
  uint8_t tx_id;
  /**<   Transaction id to tie indications to a request.
   */

  /* Optional */
  /*  Filter Rule Count */
  uint8_t num_ll_filter_rules_valid;  /**< Must be set to true if num_ll_filter_rules is being passed */
  uint16_t num_ll_filter_rules;
}dfs_query_ll_filters_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Indication Message; Query the LL filters installed on the modem. */
typedef struct {
  ...
  /*  Filter Handles */
  uint32_t filter_handles_len;  /**< Must be set to # of elements in filter_handles */
  dfs_filter_status_info_ex_type_v01 filter_handles[QMI_DFS_MAX_FILTERS_V01];
  /**<   List of handles that uniquely identifies filter rules that need to be modified.
	  */
  ...
  data_spi_info_type_v01 ah_spi_filter_rules[QMI_DFS_MAX_FILTERS_V01];
  /**<   \n List of AH SPI rules. */
}dfs_query_ll_filters_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup dfs_qmi_messages
    @{
  */
/** Indication Message; Notifies the status of the low latency filters on the modem */
typedef struct {
  ...
  uint32_t filter_status_len;  /**< Must be set to # of elements in filter_status */
  dfs_filter_status_info_type_v01 filter_status[QMI_DFS_MAX_FILTERS_V01];
}dfs_ll_filters_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_DFS_ADD_LL_FILTERS_V01
...
//#define REMOVE_QMI_DFS_ADD_POWERSAVE_FILTERS_EX_V01
//#define REMOVE_QMI_DFS_BIND_CLIENT_V01
//#define REMOVE_QMI_DFS_COALESCING_FILTERS_UPDATE_IND_V01
//#define REMOVE_QMI_DFS_DELETE_LL_FILTERS_V01
...
//#define REMOVE_QMI_DFS_LL_FILTERS_STATUS_IND_V01
//#define REMOVE_QMI_DFS_LOW_LATENCY_TRAFFIC_IND_V01
//#define REMOVE_QMI_DFS_MODIFY_LL_FILTERS_V01
//#define REMOVE_QMI_DFS_POWERSAVE_FILTER_MODE_IND_V01
//#define REMOVE_QMI_DFS_QUERY_COALESCING_FILTERS_V01
//#define REMOVE_QMI_DFS_QUERY_LL_FILTERS_V01
//#define REMOVE_QMI_DFS_QUERY_POWERSAVE_FILTERS_V01
//#define REMOVE_QMI_DFS_REMOTE_SOCKET_ALLOCATED_V01
//#define REMOVE_QMI_DFS_REMOTE_SOCKET_ALLOCATED_IND_V01
...
#define QMI_DFS_REMOTE_SOCKET_ALLOCATED_IND_V01 0x003D
#define QMI_DFS_QUERY_POWERSAVE_FILTERS_REQ_V01 0x003E
#define QMI_DFS_QUERY_POWERSAVE_FILTERS_RESP_V01 0x003E
#define QMI_DFS_ADD_POWERSAVE_FILTERS_EX_REQ_V01 0x003F
#define QMI_DFS_ADD_POWERSAVE_FILTERS_EX_RESP_V01 0x003F
#define QMI_DFS_ADD_LL_FILTERS_REQ_V01 0x0040
#define QMI_DFS_ADD_LL_FILTERS_RESP_V01 0x0040
#define QMI_DFS_MODIFY_LL_FILTERS_REQ_V01 0x0041
#define QMI_DFS_MODIFY_LL_FILTERS_RESP_V01 0x0041
#define QMI_DFS_DELETE_LL_FILTERS_REQ_V01 0x0042
#define QMI_DFS_DELETE_LL_FILTERS_RESP_V01 0x0042
#define QMI_DFS_QUERY_LL_FILTERS_REQ_V01 0x0043
#define QMI_DFS_QUERY_LL_FILTERS_RESP_V01 0x0043
#define QMI_DFS_QUERY_LL_FILTERS_IND_V01 0x0043
#define QMI_DFS_LL_FILTERS_STATUS_IND_V01 0x0044
/**
    @}
  */
