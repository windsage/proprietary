...
/* This file was generated with Tool version 6.14.9
   It was generated on: Thu Mar 18 2021 (Spin 0)
...
static const uint8_t qos_global_qos_flow_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ind_msg_v01, tx_filter_match_all) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ind_msg_v01, tx_filter_match_all_valid)),
  0x1B,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ind_msg_v01, sec_pdu_id) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ind_msg_v01, sec_pdu_id_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ind_msg_v01, sec_pdu_id)
};
...
static const uint8_t qos_global_qos_flow_ex_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_filter_match_all) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, tx_filter_match_all_valid)),
  0x1A,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, sec_pdu_id) - QMI_IDL_OFFSET16RELATIVE(qos_global_qos_flow_ex_ind_msg_v01, sec_pdu_id_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_global_qos_flow_ex_ind_msg_v01, sec_pdu_id)
};
...
static const uint8_t qos_get_qos_ids_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, qos_ids_list) - QMI_IDL_OFFSET8(qos_get_qos_ids_resp_msg_v01, qos_ids_list_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_4_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_get_qos_ids_resp_msg_v01, sec_pdu_id) - QMI_IDL_OFFSET16RELATIVE(qos_get_qos_ids_resp_msg_v01, sec_pdu_id_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_get_qos_ids_resp_msg_v01, sec_pdu_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(qos_get_qos_ids_resp_msg_v01, sec_pdu_qos_ids_list) - QMI_IDL_OFFSET16RELATIVE(qos_get_qos_ids_resp_msg_v01, sec_pdu_qos_ids_list_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(qos_get_qos_ids_resp_msg_v01, sec_pdu_qos_ids_list),
  QMI_QOS_MAX_QOS_IDS_V01,
  QMI_IDL_OFFSET16RELATIVE(qos_get_qos_ids_resp_msg_v01, sec_pdu_qos_ids_list) - QMI_IDL_OFFSET16RELATIVE(qos_get_qos_ids_resp_msg_v01, sec_pdu_qos_ids_list_len)
};
...
static const qmi_idl_service_message_table_entry qos_service_response_messages_v01[] = {
  ...
  {QMI_QOS_GET_QOS_IDS_RESP_V01, QMI_IDL_TYPE16(0, 51), 534},
...
static const qmi_idl_service_message_table_entry qos_service_indication_messages_v01[] = {
  ...
  {QMI_QOS_GLOBAL_QOS_FLOW_IND_V01, QMI_IDL_TYPE16(0, 42), 5031},
  {QMI_QOS_GLOBAL_QOS_FLOW_EX_IND_V01, QMI_IDL_TYPE16(0, 47), 2653}
};
