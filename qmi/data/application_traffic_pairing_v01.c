...
/* This file was generated with Tool version 6.14.7
   It was generated on: Fri Dec 17 2021 (Spin 0)
...
static const uint8_t atp_policy_info_change_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(atp_policy_info_change_ind_msg_v01, atp_policy_list) - QMI_IDL_OFFSET8(atp_policy_info_change_ind_msg_v01, atp_policy_list_valid)),
  0x10,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(atp_policy_info_change_ind_msg_v01, atp_policy_list),
  QMI_IDL_TYPE88(0, 1),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_policy_info_change_ind_msg_v01, update_interval) - QMI_IDL_OFFSET16RELATIVE(atp_policy_info_change_ind_msg_v01, update_interval_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_policy_info_change_ind_msg_v01, update_interval),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_policy_info_change_ind_msg_v01, is_app_statistics) - QMI_IDL_OFFSET16RELATIVE(atp_policy_info_change_ind_msg_v01, is_app_statistics_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_policy_info_change_ind_msg_v01, is_app_statistics)
};
...
static const uint8_t atp_send_filter_report_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, protocol) - QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, protocol_valid)),
  0x1B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_send_filter_report_req_msg_v01, protocol),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, is_app_statistics) - QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, is_app_statistics_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_send_filter_report_req_msg_v01, is_app_statistics),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, ap_timestamp) - QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, ap_timestamp_valid)),
  0x1D,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_send_filter_report_req_msg_v01, ap_timestamp),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, app_status) - QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, app_status_valid)),
  0x1E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_send_filter_report_req_msg_v01, app_status),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, record_num) - QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, record_num_valid)),
  0x1F,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_send_filter_report_req_msg_v01, record_num),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, tx_bytes_in_last_interval) - QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, tx_bytes_in_last_interval_valid)),
  0x20,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_send_filter_report_req_msg_v01, tx_bytes_in_last_interval),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, rx_bytes_in_last_interval) - QMI_IDL_OFFSET16RELATIVE(atp_send_filter_report_req_msg_v01, rx_bytes_in_last_interval_valid)),
  0x21,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(atp_send_filter_report_req_msg_v01, rx_bytes_in_last_interval)
};
...
static const qmi_idl_service_message_table_entry atp_service_command_messages_v01[] = {
  ...
  {QMI_ATP_SEND_FILTER_REPORT_REQ_V01, QMI_IDL_TYPE16(0, 8), 661}
};
...
static const qmi_idl_service_message_table_entry atp_service_indication_messages_v01[] = {
  ...
  {QMI_ATP_POLICY_INFO_CHANGE_IND_V01, QMI_IDL_TYPE16(0, 7), 51823},
