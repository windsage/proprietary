...
def setUpEnvironment():
    ...
    subprocess.call("adb shell mkdir /data/nativetest64/VtsHalBluetooth1_1_TransportTest")

    # if the VTS test binary doesn't exist on the DUT, push it to the above path"
    subprocess.call("adb push VtsHalBluetooth1_1_TransportTest /data/nativetest64/VtsHalBluetooth1_1_TransportTest")
    subprocess.call("adb shell chmod 755 /data/nativetest64/VtsHalBluetooth1_1_TransportTest/VtsHalBluetooth1_1_TransportTest")
    if listTestCases:
        subprocess.call("adb shell /data/nativetest64/VtsHalBluetooth1_1_TransportTest/VtsHalBluetooth1_1_TransportTest --gtest_list_tests")
        exit(0)
    ...
    subprocess.call("adb push BT-Transport-Tests.sh /data/nativetest64/VtsHalBluetooth1_1_TransportTest")
    subprocess.call("adb shell chmod 755 /data/nativetest64/VtsHalBluetooth1_1_TransportTest/BT-Transport-Tests.sh")
...
def executeTests(count):
    ...
    subprocess.call(["adb", "-s", str(adbDevice), "shell", "rm", "/data/nativetest64/VtsHalBluetooth1_1_TransportTest/tstlog.txt"])
    subprocess.call(["adb", "-s", str(adbDevice), "shell", "rm", "/data/nativetest64/VtsHalBluetooth1_1_TransportTest/logcat.txt"])
    subprocess.call(["adb", "-s", str(adbDevice), "shell", "nohup" , "logcat", "-vthreadtime -b kernel -b main -b system",
                         " > /data/nativetest64/VtsHalBluetooth1_1_TransportTest/logcat.txt 2>&1 < /dev/null &"])
    if usbDisc:
        subprocess.call(["adb", "-s", str(adbDevice), "shell", "nohup" , "/data/nativetest64/VtsHalBluetooth1_1_TransportTest/BT-Transport-Tests.sh",
                         ...
                         " > /data/nativetest64/VtsHalBluetooth1_1_TransportTest/tstlog.txt 2>&1 < /dev/null &"])
        ...
        subprocess.call(["adb", "-s", str(adbDevice), "shell", "/data/nativetest64/VtsHalBluetooth1_1_TransportTest/BT-Transport-Tests.sh",
                         str(loop), str(testfilter), str(maxappsleeptimer), str(minappsleeptimer), str(maxiterations),
                         str(maxmsgsperiteration), str(logcommands),
                         str(logevents), str(logdata), str(consolelog),
                         " > /data/nativetest64/VtsHalBluetooth1_1_TransportTest/tstlog.txt 2>&1"])

def collectLogs(count):
    subprocess.call(["adb", "-s", str(adbDevice), "shell", "pkill", "logcat"])
    subprocess.call(["adb", "-s", str(adbDevice), "pull", "/data/nativetest64/VtsHalBluetooth1_1_TransportTest/tstlog.txt", combinedPath])
    ...
    subprocess.call(["adb", "-s", str(adbDevice), "pull", "/data/nativetest64/VtsHalBluetooth1_1_TransportTest/logcat.txt", combinedPath])
