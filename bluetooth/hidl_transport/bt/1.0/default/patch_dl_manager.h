...
enum {
  ...
  PROD_ID_GANGES_PERI = 0x1e,
  PROD_ID_GANGES_BT = 0x1e,
...
enum {
  QCA_EVROS_BT_SOC_ID_0100 = 0x40200100,
  QCA_EVROS_BT_SOC_ID_0102 = 0x40200102,
  QCA_EVROS_BT_SOC_ID_0104 = 0x40200104
};

enum {
  QCA_EVROS_BT_SOC_ID_0200 = 0x40200200
};

enum {
  EVROS_BT_VER_1_0   = QCA_BT_VER(QCA_EVROS_BT_SOC_ID_0100, PROD_ID_BT_SOC_EVROS, EVROS_BT_BUILD_VER_0100),
  EVROS_BT_VER_1_2   = QCA_BT_VER(QCA_EVROS_BT_SOC_ID_0102, PROD_ID_BT_SOC_EVROS, EVROS_BT_BUILD_VER_0100),
  EVROS_BT_VER_1_4   = QCA_BT_VER(QCA_EVROS_BT_SOC_ID_0104, PROD_ID_BT_SOC_EVROS, EVROS_BT_BUILD_VER_0100),
};

enum {
  EVROS_BT_VER_2_0   = QCA_BT_VER(QCA_EVROS_BT_SOC_ID_0200, PROD_ID_BT_SOC_EVROS, EVROS_BT_BUILD_VER_0200),
};
...
// GANGES BT Build details
enum {
  GANGES_BT_BUILD_VER_0100 = 0x0100,
  GANGES_BT_BUILD_VER_0200 = 0x0200
};

enum {
  QCA_GANGES_BT_SOC_ID_0100 = 0x40210100,
  QCA_GANGES_BT_SOC_ID_0200 = 0x40210200
};

enum {
  GANGES_BT_VER_1_0   = QCA_BT_VER(QCA_GANGES_BT_SOC_ID_0100, PROD_ID_GANGES_BT, GANGES_BT_BUILD_VER_0100),
  GANGES_BT_VER_2_0   = QCA_BT_VER(QCA_GANGES_BT_SOC_ID_0200, PROD_ID_GANGES_BT, GANGES_BT_BUILD_VER_0200)
};
