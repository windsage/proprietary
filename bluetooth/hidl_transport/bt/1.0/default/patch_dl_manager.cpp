...
int PatchDLManager::SocInit(uint8_t *bdaddr, bool is_emb_wp_mode)
{
  ...
  if (chipset_ver_ == GANGES_BT_VER_1_0 ||
      chipset_ver_ == GANGES_BT_VER_2_0) {
      /* Checking Baud rate */
...
void PatchDLManager::LoadPatchMaptable() {
  ...
  PatchPathInfoMap_.insert(std::make_pair<uint64_t, PatchPathManager*>(GANGES_BT_VER_1_0,
                        new PatchPathManager("GAN_BT1_0", "gngbtfw10.tlv", "gngbtnv10.bin")));
  PatchPathInfoMap_.insert(std::make_pair<uint64_t, PatchPathManager*>(GANGES_BT_VER_2_0,
                        new PatchPathManager("GAN_BT2_0", "gngbtfw20.tlv", "gngnv20.bin")));
  PatchPathInfoMap_.insert(std::make_pair<uint64_t, PatchPathManager*>(EVROS_BT_VER_1_0,
                        new PatchPathManager("EVROS_BT1_0", "evrbtfw10.tlv", "evrnv10.bin")));
  PatchPathInfoMap_.insert(std::make_pair<uint64_t, PatchPathManager*>(EVROS_BT_VER_1_2,
                        new PatchPathManager("EVROS_BT1_2", "evrbtfw10.tlv", "evrnv10.bin")));
  PatchPathInfoMap_.insert(std::make_pair<uint64_t, PatchPathManager*>(EVROS_BT_VER_1_4,
                        new PatchPathManager("EVROS_BT1_4", "evrbtfw10.tlv", "evrnv10.bin")));
  PatchPathInfoMap_.insert(std::make_pair<uint64_t, PatchPathManager*>(EVROS_BT_VER_2_0,
                        new PatchPathManager("EVROS_BT2_0", "evrbtfw20.tlv", "evrnv20.bin")));
}
