...
typedef enum {
  ...
  BT_HOST_REASON_TME_ARBITRATION_CMD_STUCK  = 0xC0,

  PERI_SOC_REASON_DEFAULT                   = 0xC2,
  TME_SOC_REASON_DEFAULT                    = 0xC3,
#endif
  BT_HOST_REASON_PATCHING_FAILED            =  0xC1
} SecondaryReasonCode;
...
static SecondaryReasonMap secReasonMap[] = {
  ...
  { TME_SOC_REASON_DEFAULT                         ,  "Default"},
#endif
