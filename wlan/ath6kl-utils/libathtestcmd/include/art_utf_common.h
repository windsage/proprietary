...
typedef enum {
    ...
    PHY_RF_MODE_SINGLE_PHY_EMLSR = 7,
    PHY_RF_MODE_SPLIT_PHY_EMLSR = 8,
} PHY_RF_MODE;

typedef enum {
    PHY_RF_SUBMODE_AUTO = 0,
    PHY_RF_SUBMODE_DBS = 1,
    PHY_RF_SUBMODE_SBS = 2,
} PHY_RF_SUBMODE;
...
typedef enum {
  ...
  TCMD_RATEBW_NON_HT_DUP40 = 50,
  TCMD_RATEBW_NON_HT_DUP80 = 51,
  TCMD_RATEBW_NON_HT_DUP160 = 52,
  TCMD_RATEBW_NON_HT_DUP320 = 53,
  TCMD_RATEBW_INVALID
} TCMD_RATEBW;
