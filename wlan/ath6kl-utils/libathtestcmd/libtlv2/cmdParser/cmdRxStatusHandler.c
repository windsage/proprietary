...
void* initRXSTATUSRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pRXSTATUSRSPParms->evmScaleFactor = pParmDict[PARM_OPCCTRL].v.valU8;
    memset(pRXSTATUSRSPParms->pad3, 0, sizeof(pRXSTATUSRSPParms->pad3));
    pRXSTATUSRSPParms->pad3[0] = pParmDict[PARM_PAD3].v.ptU8[0];
    pRXSTATUSRSPParms->pad3[1] = pParmDict[PARM_PAD3].v.ptU8[1];
    ...
    fillParmOffsetTbl((A_UINT32)PARM_CHAINMASK, (A_UINT32)(((A_UINT8 *)&(pRXSTATUSRSPParms->chainMask)) - (A_UINT8 *)pRXSTATUSRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BANDWIDTH, (A_UINT32)(((A_UINT8 *)&(pRXSTATUSRSPParms->bandwidth)) - (A_UINT8 *)pRXSTATUSRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_NUM20MHZ, (A_UINT32)(((A_UINT8 *)&(pRXSTATUSRSPParms->num20Mhz)) - (A_UINT8 *)pRXSTATUSRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_NUMCHAIN, (A_UINT32)(((A_UINT8 *)&(pRXSTATUSRSPParms->numChain)) - (A_UINT8 *)pRXSTATUSRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_OPCCTRL, (A_UINT32)(((A_UINT8 *)&(pRXSTATUSRSPParms->evmScaleFactor)) - (A_UINT8 *)pRXSTATUSRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD3, (A_UINT32)(((A_UINT8 *)&(pRXSTATUSRSPParms->pad3)) - (A_UINT8 *)pRXSTATUSRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RSSIPERCHAIN20MHZ, (A_UINT32)(((A_UINT8 *)&(pRXSTATUSRSPParms->rssiPerChain20Mhz)) - (A_UINT8 *)pRXSTATUSRSPParms), pParmsOffset);
