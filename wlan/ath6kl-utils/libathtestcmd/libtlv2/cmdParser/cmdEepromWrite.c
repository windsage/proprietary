...
void* initEEPROMWRITEOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pEEPROMWRITEParms->eepromCompressFlag = pParmDict[PARM_EEPROMCOMPRESSFLAG].v.valU8;
    ...
    fillParmOffsetTbl((A_UINT32)PARM_EEPROMCOMPRESSFLAG, (A_UINT32)(((A_UINT32)&(pEEPROMWRITEParms->eepromCompressFlag)) - (A_UINT32)pEEPROMWRITEParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("EEPROMWRITEOp: eepromCompressFlag %u\n", pEEPROMWRITEParms->eepromCompressFlag);
#endif //_DEBUG
