...
void* initEEPROMREADOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pEEPROMREADParms->checksumsts = pParmDict[PARM_CHECKSUMSTS].v.valU8;
    ...
    fillParmOffsetTbl((A_UINT32)PARM_CHECKSUMSTS, (A_UINT32)(((A_UINT32)&(pEEPROMREADParms->checksumsts)) - (A_UINT32)pEEPROMREADParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("EEPROMREADOp: checksumsts %u\n", pEEPROMREADParms->checksumsts);
#endif //_DEBUG
