...
void* initEEPROMGETSIZEOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    CMD_EEPROMGETSIZE_PARMS  *pEEPROMGETSIZEParms = (CMD_EEPROMGETSIZE_PARMS *)pParmsCommon;
    ...
    pEEPROMGETSIZEParms->eepromCompressFlag = pParmDict[PARM_EEPROMCOMPRESSFLAG].v.valU8;

    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_EEPROMCOMPRESSFLAG, (A_UINT32)(((A_UINT32)&(pEEPROMGETSIZEParms->eepromCompressFlag)) - (A_UINT32)pEEPROMGETSIZEParms), pParmsOffset);
    return((void*) pEEPROMGETSIZEParms);
}
...
{
    CMD_EEPROMGETSIZE_PARMS *pEEPROMGETSIZEParms = (CMD_EEPROMGETSIZE_PARMS *)pParms;
...
//#ifdef _DEBUG
    ...
    A_PRINTF("EEPROMGETSIZEOp: eepromCompressFlag %u\n", pEEPROMGETSIZEParms->eepromCompressFlag);
#endif //_DEBUG

    if (NULL != EEPROMGETSIZEOpFunc) {
        (*EEPROMGETSIZEOpFunc)(pEEPROMGETSIZEParms);
    }
    return(TRUE);
}
