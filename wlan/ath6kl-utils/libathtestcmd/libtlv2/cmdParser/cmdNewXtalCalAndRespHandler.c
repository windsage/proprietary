...
void* initNEWXTALCALPROCOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pNEWXTALCALPROCParms->ppmOffset = pParmDict[PARM_PPMOFFSET].v.valS16;
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PPMOFFSET, (A_UINT32)(((A_UINT32)&(pNEWXTALCALPROCParms->ppmOffset)) - (A_UINT32)pNEWXTALCALPROCParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("NEWXTALCALPROCOp: ppmOffset %u\n", pNEWXTALCALPROCParms->ppmOffset);
#endif //_DEBUG
