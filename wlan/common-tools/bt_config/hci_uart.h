...
#define HCI_READ_LOCAL_VER_INFO               (0x1000 | 0x0001)
#define HCI_READ_BD_ADDR                      (0x1000 | 0x0009)
#define HCI_WRITE_SCAN_ENABLE                 (0x0C00 | 0x001A)
#define HCI_ULP_EXT_SCAN_SET_PARAMS                       (0x2000 | 0x0041)
#define HCI_ULP_EXT_SCAN_ENABLE                           (0x2000 | 0x0042)
...
#define ALOGI if(print_enabled) printf
#define ALOGD if(print_enabled) printf
#define ALOGE printf
#define ALOGV if(print_enabled) printf
