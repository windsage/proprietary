...
static const uint8_t cnss_plat_ipc_qmi_reg_client_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_reg_client_req_msg_v01, client_id) - QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_reg_client_req_msg_v01, client_id_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_reg_client_req_msg_v01, client_id)
};

static const uint8_t cnss_plat_ipc_qmi_reg_client_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_reg_client_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t cnss_plat_ipc_qmi_send_config_param_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_send_config_param_req_msg_v01, client_id),

  0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_send_config_param_req_msg_v01, instance_id),

  0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_send_config_param_req_msg_v01, param),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x04,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_send_config_param_req_msg_v01, value)
};

static const uint8_t cnss_plat_ipc_qmi_send_config_param_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(cnss_plat_ipc_qmi_send_config_param_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry cnss_platform_message_table_v01[] = {
  ...
  {sizeof(cnss_plat_ipc_qmi_reg_client_req_msg_v01), cnss_plat_ipc_qmi_reg_client_req_msg_data_v01},
  {sizeof(cnss_plat_ipc_qmi_reg_client_resp_msg_v01), cnss_plat_ipc_qmi_reg_client_resp_msg_data_v01},
  {sizeof(cnss_plat_ipc_qmi_send_config_param_req_msg_v01), cnss_plat_ipc_qmi_send_config_param_req_msg_data_v01},
  {sizeof(cnss_plat_ipc_qmi_send_config_param_resp_msg_v01), cnss_plat_ipc_qmi_send_config_param_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry cnss_platform_service_command_messages_v01[] = {
  ...
  {CNSS_PLAT_IPC_QMI_REG_CLIENT_REQ_V01, QMI_IDL_TYPE16(0, 8), 7},
  {CNSS_PLAT_IPC_QMI_SEND_CONFIG_PARAM_REQ_V01, QMI_IDL_TYPE16(0, 10), 32}
};
...
static const qmi_idl_service_message_table_entry cnss_platform_service_response_messages_v01[] = {
  ...
  {CNSS_PLAT_IPC_QMI_REG_CLIENT_RESP_V01, QMI_IDL_TYPE16(0, 9), 7},
  {CNSS_PLAT_IPC_QMI_SEND_CONFIG_PARAM_RESP_V01, QMI_IDL_TYPE16(0, 11), 7}
};
