...
/* This file was generated with Tool version 6.14.7
   It was generated on: Tue May 24 2022 (Spin 0)
...
#define CNSS_PLATFORM_V01_MAX_MESSAGE_ID 0x0007
/**
    @}
  */
...
/** @addtogroup cnss_platform_qmi_enums
    @{
  */
typedef enum {
  CNSS_PLAT_IPC_QMI_CLIENT_ID_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CNSS_PLAT_IPC_BT_QMI_CLIENT_V01 = 0, /**<  BT QMI client ID  */
  CNSS_PLAT_IPC_DAEMON_QMI_CLIENT_V01 = 1, /**<  CNSS Daemon QMI client ID  */
  CNSS_PLAT_IPC_QMI_CLIENT_ID_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}cnss_plat_ipc_qmi_client_id_v01;
/**
    @}
  */
...
/** @addtogroup cnss_platform_qmi_enums
  ...
  */
typedef enum {
  CNSS_PLAT_IPC_QMI_CONFIG_PARAM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  CNSS_PLAT_IPC_PARAM_TYPE_UNSPEC_V01 = 0, /**<  Unused  */
  CNSS_PLAT_IPC_PARAM_TYPE_QDSS_V01 = 1, /**<  QDSS save  */
  CNSS_PLAT_IPC_PARAM_TYPE_DAEMON_SUPPORT_V01 = 2, /**<  Daemon support  */
  CNSS_PLAT_IPC_PARAM_TYPE_COLD_BOOT_SUPPORT_V01 = 3, /**<  Cold boot support  */
  CNSS_PLAT_IPC_PARAM_TYPE_HDS_SUPPORT_V01 = 4, /**<  HDS support  */
  CNSS_PLAT_IPC_PARAM_TYPE_REGDB_SUPPORT_V01 = 5, /**<  REGDB support  */
  CNSS_PLAT_IPC_PARAM_TYPE_QDSS_SUPPORT_V01 = 6, /**<  QDSS support  */
  CNSS_PLAT_IPC_PARAM_TYPE_QDSS_START_V01 = 7, /**<  QDSS start  */
  CNSS_PLAT_IPC_PARAM_TYPE_QDSS_STOP_V01 = 8, /**<  QDSS stop  */
  CNSS_PLAT_IPC_QMI_CONFIG_PARAM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}cnss_plat_ipc_qmi_config_param_type_v01;
/**
    @}
  */
...
/** @addtogroup cnss_platform_qmi_messages
    @{
  */
/** Request Message; This command is for QMI client registration */
typedef struct {

  /* Optional */
  /*  QMI Client ID */
  uint8_t client_id_valid;  /**< Must be set to true if client_id is being passed */
  cnss_plat_ipc_qmi_client_id_v01 client_id;
}cnss_plat_ipc_qmi_reg_client_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup cnss_platform_qmi_messages
    @{
  */
/** Response Message; This command is for QMI client registration */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}cnss_plat_ipc_qmi_reg_client_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup cnss_platform_qmi_messages
    @{
  */
/** Request Message; This command is used to send config param values from cnsscli */
typedef struct {
  ...
  /* Mandatory */
  /*  Config param whose value needs to be set */
  cnss_plat_ipc_qmi_config_param_type_v01 param;

  /* Mandatory */
  /*  Value of config param */
  uint64_t value;
}cnss_plat_ipc_qmi_send_config_param_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup cnss_platform_qmi_messages
    @{
  */
/** Response Message; This command is used to send config param values from cnsscli */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}cnss_plat_ipc_qmi_send_config_param_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_CNSS_PLAT_IPC_QMI_REG_CLIENT_V01
//#define REMOVE_CNSS_PLAT_IPC_QMI_SEND_CONFIG_PARAM_V01
