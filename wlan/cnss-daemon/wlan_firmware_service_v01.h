...
#define WLFW_V01_MAX_MESSAGE_ID 0x0062
/**
    @}
  */
...
typedef enum {
  ...
  QMI_WLFW_MEM_LPASS_SHARED_V01 = 11, /**<  Memory region shared with LPASS for Direct Link usecase  */
  QMI_WLFW_MEM_CALDB_SEG_V01 = 12, /**<  Segment memory region used for calibration  */
...
/** @addtogroup wlfw_qmi_enums
  ...
  */
typedef enum {
  WLFW_LPASS_SSR_REASON_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WLFW_LPASS_SSR_REASON_NON_CE_V01 = 0, /**<  LPASS SSR non CE driver reason code  */
  WLFW_LPASS_SSR_REASON_CE_V01 = 1, /**<  LPASS SSR reason is due to CE driver  */
  WLFW_LPASS_SSR_REASON_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wlfw_lpass_ssr_reason_v01;
/**
    @}
  */
...
#define QMI_WLFW_CALDB_SEG_DDR_SUPPORT_V01 ((wlfw_fw_caps_v01)0x08ull) /**<  If set, FW supports segment DDR for CALDB during memory request  */
/**  WLAN FW capabilities based on Soft SKU License */
typedef uint64_t wlfw_soft_sku_features_v01;
#define QMI_WLFW_DIRECT_LINK_SKU_SUPPORT_V01 ((wlfw_soft_sku_features_v01)0x01ull) /**<  If set, FW has valid Soft SKU licene to enable DIRECT_LINK  */
...
typedef struct {
  ...
  mlo_chip_info_s_v01 mlo_chip_info;

  uint8_t adj_mlo_num_chips;

  mlo_chip_info_s_v01 adj_mlo_chip_info[QMI_WLFW_MAX_ADJ_CHIP_V01];
}mlo_chip_v2_info_s_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_aggregates
    @{
  */
/**  structure for wlanchip serial id
 */
typedef struct {
...
typedef struct {
  ...
  /* Optional */
  /*  Subscribe option of wlfw_driver_async_data_ind_msg */
  uint8_t async_data_enable_valid;  /**< Must be set to true if async_data_enable is being passed */
  uint8_t async_data_enable;

  /* Optional */
  /*  Subscribe option of wlfw_dump_ddr_region_ind_msg */
  uint8_t dump_ddr_region_enable_valid;  /**< Must be set to true if dump_ddr_region_enable is being passed */
  uint8_t dump_ddr_region_enable;
...
typedef struct {
  ...
  /* Optional */
  /*  WLCHIP Serial Number */
  uint8_t serial_id_valid;  /**< Must be set to true if serial_id is being passed */
  wlchip_serial_id_v01 serial_id;
...
typedef struct {
  ...
  mlo_chip_info_s_v01 mlo_chip_info[QMI_WLFW_MAX_MLO_CHIP_V01];
  ...
  mlo_chip_v2_info_s_v01 mlo_chip_v2_info[QMI_WLFW_MLO_V2_CHP_V01];
...
typedef struct {
  ...
  /* Optional */
  /*  Soft SKU based feature */
  uint8_t soft_sku_features_valid;  /**< Must be set to true if soft_sku_features is being passed */
  wlfw_soft_sku_features_v01 soft_sku_features;
...
typedef struct {
  ...
  /* Optional */
  /*  Indicate Single Chip MLO Support */
  uint8_t single_chip_mlo_support_valid;  /**< Must be set to true if single_chip_mlo_support is being passed */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command sends the SOFT SKU information to server. */
typedef struct {
  ...
  /*  Size of Memory in Bytes */
  uint32_t size;
}wlfw_soft_sku_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command sends the SOFT SKU information to server. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_soft_sku_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  wlfw_lpass_ssr_reason_v01 reason_code;
}wlfw_lpass_ssr_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Request Message; This command sends WLAN MLO reconfiguration info to server. */
typedef struct {
  ...
  uint8_t mlo_chip_v2_info_valid;  /**< Must be set to true if mlo_chip_v2_info is being passed */
  mlo_chip_v2_info_s_v01 mlo_chip_v2_info[QMI_WLFW_MLO_V2_CHP_V01];
}wlfw_mlo_reconfig_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Response Message; This command sends WLAN MLO reconfiguration info to server. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}wlfw_mlo_reconfig_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Indication Message; indicates the chipset statistics from firmware */
typedef struct {
  ...
  /* Mandatory */
  uint16_t type;
}wlfw_driver_async_data_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wlfw_qmi_messages
    @{
  */
/** Indication Message; This command tells client to save DDR region */
typedef struct {
  ...
  uint8_t file_name_valid;  /**< Must be set to true if file_name is being passed */
  char file_name[QMI_WLFW_MAX_STR_LEN_V01 + 1];
}wlfw_dump_ddr_region_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_WLFW_DRIVER_ASYNC_DATA_IND_V01
//#define REMOVE_QMI_WLFW_DUMP_DDR_REGION_IND_V01
...
//#define REMOVE_QMI_WLFW_MLO_RECONFIG_INFO_V01
...
//#define REMOVE_QMI_WLFW_SOFT_SKU_INFO_V01
