...
/* This file was generated with Tool version 6.14.11
   It was generated on: Mon Sep 30 2024 (Spin 0)
...
static const uint8_t mlo_chip_info_s_data_v01[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mlo_chip_info_s_v01, chip_id),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mlo_chip_info_s_v01, num_local_links),

  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mlo_chip_info_s_v01, hw_link_id),
  QMI_WLFW_MAX_NUM_MLO_LINKS_PER_CHIP_V01,

  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mlo_chip_info_s_v01, valid_mlo_link_id),
  QMI_WLFW_MAX_NUM_MLO_LINKS_PER_CHIP_V01,

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t mlo_chip_v2_info_s_data_v01[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(mlo_chip_v2_info_s_v01, mlo_chip_info),
  QMI_IDL_TYPE88(0, 17),
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mlo_chip_v2_info_s_v01, adj_mlo_num_chips),

  QMI_IDL_FLAGS_IS_ARRAY |QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(mlo_chip_v2_info_s_v01, adj_mlo_chip_info),
  QMI_WLFW_MAX_ADJ_CHIP_V01,
  QMI_IDL_TYPE88(0, 17),
  QMI_IDL_FLAG_END_VALUE
};
...
static const uint8_t wlchip_serial_id_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlchip_serial_id_v01, serial_id_msb),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlchip_serial_id_v01, serial_id_lsb),
...
static const uint8_t wlfw_ind_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, fw_ssr_enable) - QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, fw_ssr_enable_valid)),
  0x24,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, fw_ssr_enable),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, async_data_enable) - QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, async_data_enable_valid)),
  0x25,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, async_data_enable),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, dump_ddr_region_enable) - QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, dump_ddr_region_enable_valid)),
  0x26,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_ind_register_req_msg_v01, dump_ddr_region_enable)
};
...
static const uint8_t wlfw_cap_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, phy_qam_cap) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, phy_qam_cap_valid)),
  0x27,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, phy_qam_cap),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, serial_id) - QMI_IDL_OFFSET16RELATIVE(wlfw_cap_resp_msg_v01, serial_id_valid)),
  0x28,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlfw_cap_resp_msg_v01, serial_id),
  QMI_IDL_TYPE88(0, 24)
};
...
static const uint8_t wlfw_fw_init_done_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_length) - QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_length_valid)),
  0x11,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, hang_data_length),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, soft_sku_features) - QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, soft_sku_features_valid)),
  0x12,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_fw_init_done_ind_msg_v01, soft_sku_features)
};
...
static const uint8_t wlfw_phy_cap_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, mlo_cap_v2_support) - QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, mlo_cap_v2_support_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, mlo_cap_v2_support),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, single_chip_mlo_support) - QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, single_chip_mlo_support_valid)),
  0x13,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_phy_cap_resp_msg_v01, single_chip_mlo_support)
};
...
static const uint8_t wlfw_soft_sku_info_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(wlfw_soft_sku_info_req_msg_v01, addr),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_soft_sku_info_req_msg_v01, size)
};

static const uint8_t wlfw_soft_sku_info_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_soft_sku_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const uint8_t wlfw_lpass_ssr_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlfw_lpass_ssr_req_msg_v01, reason_code)
};
...
static const uint8_t wlfw_mlo_reconfig_info_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_capable) - QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_capable_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_capable),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_id) - QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_id_valid)),
  0x11,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_group_id) - QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_group_id_valid)),
  0x12,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_group_id),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, max_mlo_peer) - QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, max_mlo_peer_valid)),
  0x13,
   QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, max_mlo_peer),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_num_chips) - QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_num_chips_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_num_chips),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_info) - QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_info_valid)),
  0x15,
  QMI_IDL_FLAGS_IS_ARRAY |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_info),
  QMI_WLFW_MAX_MLO_CHIP_V01,
  QMI_IDL_TYPE88(0, 17),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_v2_info) - QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_v2_info_valid)),
  0x16,
  QMI_IDL_FLAGS_IS_ARRAY |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_req_msg_v01, mlo_chip_v2_info),
  QMI_WLFW_MLO_V2_CHP_V01,
  QMI_IDL_TYPE88(0, 18)
};

static const uint8_t wlfw_mlo_reconfig_info_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_mlo_reconfig_info_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t wlfw_driver_async_data_ind_msg_data_v01[] = {
  0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(wlfw_driver_async_data_ind_msg_v01, data),
  ((QMI_WLFW_MAX_DATA_SIZE_V01) & 0xFF), ((QMI_WLFW_MAX_DATA_SIZE_V01) >> 8),
  QMI_IDL_OFFSET8(wlfw_driver_async_data_ind_msg_v01, data) - QMI_IDL_OFFSET8(wlfw_driver_async_data_ind_msg_v01, data_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(wlfw_driver_async_data_ind_msg_v01, type)
};

static const uint8_t wlfw_dump_ddr_region_ind_msg_data_v01[] = {
  0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wlfw_dump_ddr_region_ind_msg_v01, mem_seg),
  QMI_WLFW_MAX_NUM_MEM_SEG_V01,
  QMI_IDL_OFFSET8(wlfw_dump_ddr_region_ind_msg_v01, mem_seg) - QMI_IDL_OFFSET8(wlfw_dump_ddr_region_ind_msg_v01, mem_seg_len),
  QMI_IDL_TYPE88(0, 9),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlfw_dump_ddr_region_ind_msg_v01, file_name) - QMI_IDL_OFFSET16RELATIVE(wlfw_dump_ddr_region_ind_msg_v01, file_name_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
  QMI_IDL_OFFSET16ARRAY(wlfw_dump_ddr_region_ind_msg_v01, file_name),
  QMI_WLFW_MAX_STR_LEN_V01
};
...
static const qmi_idl_type_table_entry  wlfw_type_table_v01[] = {
  ...
  {sizeof(mlo_chip_info_s_v01), mlo_chip_info_s_data_v01},
  {sizeof(mlo_chip_v2_info_s_v01), mlo_chip_v2_info_s_data_v01},
  ...
  {sizeof(wlchip_serial_id_v01), wlchip_serial_id_data_v01}
};
...
static const qmi_idl_message_table_entry wlfw_message_table_v01[] = {
  ...
  {sizeof(wlfw_soft_sku_info_req_msg_v01), wlfw_soft_sku_info_req_msg_data_v01},
  {sizeof(wlfw_soft_sku_info_resp_msg_v01), wlfw_soft_sku_info_resp_msg_data_v01},
  ...
  {sizeof(wlfw_lpass_ssr_req_msg_v01), wlfw_lpass_ssr_req_msg_data_v01},
  {sizeof(wlfw_lpass_ssr_resp_msg_v01), wlfw_lpass_ssr_resp_msg_data_v01},
  {sizeof(wlfw_mlo_reconfig_info_req_msg_v01), wlfw_mlo_reconfig_info_req_msg_data_v01},
  {sizeof(wlfw_mlo_reconfig_info_resp_msg_v01), wlfw_mlo_reconfig_info_resp_msg_data_v01},
  {sizeof(wlfw_driver_async_data_ind_msg_v01), wlfw_driver_async_data_ind_msg_data_v01},
  {sizeof(wlfw_dump_ddr_region_ind_msg_v01), wlfw_dump_ddr_region_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_command_messages_v01[] = {
  {QMI_WLFW_IND_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 0), 98},
  ...
  {QMI_WLFW_BMPS_CTRL_REQ_V01, QMI_IDL_TYPE16(0, 104), 7},
  {QMI_WLFW_LPASS_SSR_REQ_V01, QMI_IDL_TYPE16(0, 106), 7},
  {QMI_WLFW_MLO_RECONFIG_INFO_REQ_V01, QMI_IDL_TYPE16(0, 108), 122},
  {QMI_WLFW_SOFT_SKU_INFO_REQ_V01, QMI_IDL_TYPE16(0, 101), 18}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_response_messages_v01[] = {
  ...
  {QMI_WLFW_CAP_RESP_V01, QMI_IDL_TYPE16(0, 10), 1171},
  ...
  {QMI_WLFW_PHY_CAP_RESP_V01, QMI_IDL_TYPE16(0, 92), 29},
  ...
  {QMI_WLFW_BMPS_CTRL_RESP_V01, QMI_IDL_TYPE16(0, 105), 7},
  {QMI_WLFW_LPASS_SSR_RESP_V01, QMI_IDL_TYPE16(0, 107), 7},
  {QMI_WLFW_MLO_RECONFIG_INFO_RESP_V01, QMI_IDL_TYPE16(0, 109), 7},
  {QMI_WLFW_SOFT_SKU_INFO_RESP_V01, QMI_IDL_TYPE16(0, 102), 7}
};
...
static const qmi_idl_service_message_table_entry wlfw_service_indication_messages_v01[] = {
  ...
  {QMI_WLFW_FW_INIT_DONE_IND_V01, QMI_IDL_TYPE16(0, 41), 23},
  ...
  {QMI_WLFW_FW_SSR_IND_V01, QMI_IDL_TYPE16(0, 103), 7},
  {QMI_WLFW_DRIVER_ASYNC_DATA_IND_V01, QMI_IDL_TYPE16(0, 110), 6154},
  {QMI_WLFW_DUMP_DDR_REGION_IND_V01, QMI_IDL_TYPE16(0, 111), 907}
};
