...
ifneq ($(QCOM_WLAN_ROOT), )
    ...
    LOCAL_C_INCLUDES += $(QCOM_WLAN_ROOT)/qcwcn/wifi_hal/vendor_nan
else
    LOCAL_C_INCLUDES += hardware/qcom/wlan/qcwcn/wifi_hal
    LOCAL_C_INCLUDES += hardware/qcom/wlan/qcwcn/wifi_hal/vendor_nan
...
LOCAL_C_INCLUDES += \
    hardware/interfaces/wifi/legacy_headers/include \
