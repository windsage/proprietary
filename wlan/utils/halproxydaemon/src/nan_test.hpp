...
namespace NAN_TEST
{
    ...
    public:
        ...
        static const char *NAN_SET_OEM_CMD;
...
#if (NAN_CERT_VERSION >= 6)
        static void nanNotifyVendorResponse(transaction_id id,
                                            NanVendorResponseMsg *response);
        static void nanVendorEventIndication(NanVendorEventInd* event);
#endif
    private:
...
#if (NAN_CERT_VERSION >= 6)
        void nanSendOemCommandRequest(int argc, char **argv);
#endif
