...
namespace ROAM_TEST
{
    ...
    int RoamTestSuite::processRoamCmd(int argc, char *argv[])
    {
        ...
        if (argc > 3) {
            ...
            fprintf(stderr, "    Type 2 for Disable (0), Enable (1), or"
                    " Aggressive (2) firmware roaming\n");
            ...
            while (1) {
                ...
                switch(cmdId) {
                    ...
                    case 2:
                        int temp;
                        fprintf(stderr, "Enter Firmware roam state (0 for "
                                "Disable, 1 for Enable, 2 for Aggressive):\n");
