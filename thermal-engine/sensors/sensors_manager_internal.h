/*===========================================================================
  ...
  Copyright (c) 2012-2016,2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#define IS_ALARM_V2_TYPE(sensor)  \
		((!strncmp(sensor, "pm", strlen("pm"))) &&	\
		(strlen(sensor) > strlen("_tz")) &&	\
		(!strncmp(sensor+(strlen(sensor)-strlen("_tz")),	\
				"_tz", strlen("_tz"))))
