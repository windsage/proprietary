...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/tmd/src/thermal_mitigation_device_service_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t tmd_get_mitigation_device_list_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(tmd_get_mitigation_device_list_resp_msg_v01, mitigation_device_list) - QMI_IDL_OFFSET8(tmd_get_mitigation_device_list_resp_msg_v01, mitigation_device_list_valid)),
  0x10,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(tmd_get_mitigation_device_list_resp_msg_v01, mitigation_device_list_ext01) - QMI_IDL_OFFSET16RELATIVE(tmd_get_mitigation_device_list_resp_msg_v01, mitigation_device_list_ext01_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(tmd_get_mitigation_device_list_resp_msg_v01, mitigation_device_list_ext01),
  QMI_TMD_MITIGATION_DEV_LIST_EXT01_MAX_V01,
  QMI_IDL_OFFSET16RELATIVE(tmd_get_mitigation_device_list_resp_msg_v01, mitigation_device_list_ext01) - QMI_IDL_OFFSET16RELATIVE(tmd_get_mitigation_device_list_resp_msg_v01, mitigation_device_list_ext01_len),
  QMI_IDL_TYPE88(0, 1)
};
...
static const qmi_idl_service_message_table_entry tmd_service_response_messages_v01[] = {
  ...
  {QMI_TMD_GET_MITIGATION_DEVICE_LIST_RESP_V01, QMI_IDL_TYPE16(0, 1), 3279},
