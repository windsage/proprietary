...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/voice/src/voice_service_v02.c#92 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Wed Jan 24 2024 (Spin 0)
...
static const uint8_t voice_srtp_status_info_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_srtp_status_info_type_v02, call_id),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_srtp_status_info_type_v02, audio_srtp),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_srtp_status_info_type_v02, video_srtp),

  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_srtp_status_info_type_v02, text_srtp),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t sip_vos_move_sequence_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sip_vos_move_sequence_type_v02, slide),

  QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sip_vos_move_sequence_type_v02, timestamp),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sip_vos_move_sequence_type_v02, slide_duration),

  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t sip_vos_move_slide_info_type_data_v02[] = {
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sip_vos_move_slide_info_type_v02, move_coordinates),
  QMI_IDL_TYPE88(0, 122),
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sip_vos_move_slide_info_type_v02, move_sequence),
  QMI_IDL_TYPE88(0, 126),
  QMI_IDL_FLAG_END_VALUE
};

static const uint8_t voice_call_reason_type_data_v02[] = {
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_call_reason_type_v02, call_id),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(voice_call_reason_type_v02, call_reason),
  QMI_VOICE_CALL_REASON_MAX_LEN_V02,
  QMI_IDL_OFFSET8(voice_call_reason_type_v02, call_reason) - QMI_IDL_OFFSET8(voice_call_reason_type_v02, call_reason_len),
...
static const uint8_t voice_indication_register_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, notify_clir_mode_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, notify_clir_mode_events_valid)),
  0x30,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, notify_clir_mode_events),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, srtp_status_info_event) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, srtp_status_info_event_valid)),
  0x31,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, srtp_status_info_event),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_get_latest_msd_event) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_get_latest_msd_event_valid)),
  0x32,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, ecall_get_latest_msd_event)
};
...
static const uint8_t voice_all_call_status_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vos_support) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vos_support_valid)),
  0x53,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_reason) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_reason_valid)),
  0x54,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(voice_all_call_status_ind_msg_v02, call_reason),
  QMI_VOICE_CALL_REASON_ARRAY_MAX_V02,
  QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_reason) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, call_reason_len),
...
static const uint8_t auto_rejected_incoming_call_end_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, is_dc_call) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, is_dc_call_valid)),
  0x1C,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, is_dc_call),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_reason) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_reason_valid)),
  0x1D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET16ARRAY(auto_rejected_incoming_call_end_ind_msg_v02, call_reason),
  QMI_VOICE_CALL_REASON_MAX_LEN_V02,
  QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_reason) - QMI_IDL_OFFSET16RELATIVE(auto_rejected_incoming_call_end_ind_msg_v02, call_reason_len)
};
...
static const uint8_t voice_sip_vos_action_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_touch_info) - QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_touch_info_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_touch_info),
  QMI_IDL_TYPE88(0, 124),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_move_slide_info) - QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_move_slide_info_valid)),
  0x12,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_sip_vos_action_req_msg_v02, sip_vos_move_slide_info),
...
static const uint8_t voice_srtp_status_ind_msg_data_v02[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(voice_srtp_status_ind_msg_v02, srtp_status_info),
  QMI_IDL_TYPE88(0, 125)
};

/*
 * voice_ecall_get_latest_msd_ind_msg is empty
 * static const uint8_t voice_ecall_get_latest_msd_ind_msg_data_v02[] = {
 * };
 */
...
static const qmi_idl_type_table_entry  voice_type_table_v02[] = {
  ...
  {sizeof(voice_srtp_status_info_type_v02), voice_srtp_status_info_type_data_v02},
  {sizeof(sip_vos_move_sequence_type_v02), sip_vos_move_sequence_type_data_v02},
  {sizeof(sip_vos_move_slide_info_type_v02), sip_vos_move_slide_info_type_data_v02},
  {sizeof(voice_call_reason_type_v02), voice_call_reason_type_data_v02}
};
...
static const qmi_idl_message_table_entry voice_message_table_v02[] = {
  ...
  {sizeof(voice_srtp_status_ind_msg_v02), voice_srtp_status_ind_msg_data_v02},
  {sizeof(voice_ecall_get_latest_msd_ind_msg_v02), 0}
};
...
static const qmi_idl_service_message_table_entry voice_service_command_messages_v02[] = {
  {QMI_VOICE_INDICATION_REGISTER_REQ_V02, QMI_IDL_TYPE16(0, 0), 140},
  ...
  {QMI_VOICE_SIP_VOS_ACTION_REQ_V02, QMI_IDL_TYPE16(0, 162), 46}
};
...
static const qmi_idl_service_message_table_entry voice_service_indication_messages_v02[] = {
  ...
  {QMI_VOICE_ALL_CALL_STATUS_IND_V02, QMI_IDL_TYPE16(0, 24), 51014},
  ...
  {QMI_AUTO_REJECTED_INCOMING_CALL_END_IND_V02, QMI_IDL_TYPE16(0, 132), 2236},
  ...
  {QMI_VOICE_SRTP_STATUS_IND_V02, QMI_IDL_TYPE16(0, 164), 7},
  {QMI_VOICE_ECALL_GET_LATEST_MSD_IND_V02, QMI_IDL_TYPE16(0, 165), 0}
};
