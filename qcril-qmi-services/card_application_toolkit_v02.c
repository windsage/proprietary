...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.0/cat/src/card_application_toolkit_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t cat_pdu_session_est_type_data_v02[] = {
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(cat_pdu_session_est_type_v02, dnn_address),
  QMI_CAT_DNN_ADDRESS_MAX_LENGTH_V02,
  QMI_IDL_OFFSET8(cat_pdu_session_est_type_v02, dnn_address) - QMI_IDL_OFFSET8(cat_pdu_session_est_type_v02, dnn_address_len),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(cat_pdu_session_est_type_v02, pdu_session_est_data),
  QMI_CAT_PDU_SESSION_EST_MAX_LENGTH_V02,
  QMI_IDL_OFFSET8(cat_pdu_session_est_type_v02, pdu_session_est_data) - QMI_IDL_OFFSET8(cat_pdu_session_est_type_v02, pdu_session_est_data_len),
...
static const uint8_t cat_send_decoded_envelope_cmd_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_call_disconnect_cause) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, ims_call_disconnect_cause_valid)),
  0x2A,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, ims_call_disconnect_cause),
  QMI_IDL_TYPE88(0, 110),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, pdu_session_est) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_req_msg_v02, pdu_session_est_valid)),
  0x2B,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_req_msg_v02, pdu_session_est),
...
static const uint8_t cat_send_decoded_envelope_cmd_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, media_type) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, media_type_valid)),
  0x21,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_resp_msg_v02, media_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, pdu_session_est) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_resp_msg_v02, pdu_session_est_valid)),
  0x22,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_resp_msg_v02, pdu_session_est),
  QMI_IDL_TYPE88(0, 111)
};
...
static const uint8_t cat_send_decoded_envelope_cmd_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, media_type) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, media_type_valid)),
  0x20,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, media_type),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, pdu_session_est) - QMI_IDL_OFFSET16RELATIVE(cat_send_decoded_envelope_cmd_ind_msg_v02, pdu_session_est_valid)),
  0x21,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(cat_send_decoded_envelope_cmd_ind_msg_v02, pdu_session_est),
  QMI_IDL_TYPE88(0, 111)
};
...
static const qmi_idl_type_table_entry  cat_type_table_v02[] = {
  ...
  {sizeof(cat_pdu_session_est_type_v02), cat_pdu_session_est_type_data_v02}
};
...
static const qmi_idl_service_message_table_entry cat_service_command_messages_v02[] = {
  ...
  {QMI_CAT_SEND_DECODED_ENVELOPE_CMD_REQ_V02, QMI_IDL_TYPE16(0, 15), 3187},
...
static const qmi_idl_service_message_table_entry cat_service_response_messages_v02[] = {
  ...
  {QMI_CAT_SEND_DECODED_ENVELOPE_CMD_RESP_V02, QMI_IDL_TYPE16(0, 16), 2983},
...
static const qmi_idl_service_message_table_entry cat_service_indication_messages_v02[] = {
  ...
  {QMI_CAT_SEND_DECODED_ENVELOPE_CMD_IND_V02, QMI_IDL_TYPE16(0, 43), 2983},
