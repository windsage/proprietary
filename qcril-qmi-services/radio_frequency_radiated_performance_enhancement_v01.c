...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.0/rfrpe/src/radio_frequency_radiated_performance_enhancement_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t rfrpe_set_port_req_data_v01[] = {
  0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(rfrpe_set_port_req_v01, asm_instance),
  RFRPE_ASM_DEVICES_MAX_V01,
  QMI_IDL_OFFSET8(rfrpe_set_port_req_v01, asm_instance) - QMI_IDL_OFFSET8(rfrpe_set_port_req_v01, asm_instance_len),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(rfrpe_set_port_req_v01, port),
  RFRPE_ASM_DEVICES_MAX_V01,
  QMI_IDL_OFFSET8(rfrpe_set_port_req_v01, port) - QMI_IDL_OFFSET8(rfrpe_set_port_req_v01, port_len)
};

static const uint8_t rfrpe_set_port_resp_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(rfrpe_set_port_resp_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};

static const uint8_t rfrpe_set_port_ind_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(rfrpe_set_port_ind_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry rfrpe_message_table_v01[] = {
  ...
  {sizeof(rfrpe_set_port_req_v01), rfrpe_set_port_req_data_v01},
  {sizeof(rfrpe_set_port_resp_v01), rfrpe_set_port_resp_data_v01},
  {sizeof(rfrpe_set_port_ind_msg_v01), rfrpe_set_port_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry rfrpe_service_command_messages_v01[] = {
  ...
  {QMI_RFRPE_SET_PORT_REQ_V01, QMI_IDL_TYPE16(0, 6), 18}
};
...
static const qmi_idl_service_message_table_entry rfrpe_service_response_messages_v01[] = {
  ...
  {QMI_RFRPE_SET_PORT_RESP_V01, QMI_IDL_TYPE16(0, 7), 7}
};

static const qmi_idl_service_message_table_entry rfrpe_service_indication_messages_v01[] = {
  {QMI_RFRPE_SET_PORT_IND_V01, QMI_IDL_TYPE16(0, 8), 7}
};
...
struct qmi_idl_service_object rfrpe_qmi_idl_service_object_v01 = {
  ...
  { sizeof(rfrpe_service_command_messages_v01)/sizeof(qmi_idl_service_message_table_entry),
    ...
    sizeof(rfrpe_service_indication_messages_v01)/sizeof(qmi_idl_service_message_table_entry) },
  { rfrpe_service_command_messages_v01, rfrpe_service_response_messages_v01, rfrpe_service_indication_messages_v01},
