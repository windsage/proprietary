...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/6.3/sar/src/specific_absorption_rate_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Fri Nov 11 2022 (Spin 0)
...
static const uint8_t sar_mmw_module_disable_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sar_mmw_module_disable_req_msg_v01, is_persistent) - QMI_IDL_OFFSET8(sar_mmw_module_disable_req_msg_v01, is_persistent_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sar_mmw_module_disable_req_msg_v01, is_persistent)
};
...
/*
 * sar_mmw_module_disable_status_req_msg is empty
 * static const uint8_t sar_mmw_module_disable_status_req_msg_data_v01[] = {
 * };
 */

static const uint8_t sar_mmw_module_disable_status_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sar_mmw_module_disable_status_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sar_mmw_module_disable_status_resp_msg_v01, module_disable_bitmask),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x04,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sar_mmw_module_disable_status_resp_msg_v01, is_persistent)
};
...
static const qmi_idl_message_table_entry sar_message_table_v01[] = {
  ...
  {sizeof(sar_mmw_module_disable_status_req_msg_v01), 0},
  {sizeof(sar_mmw_module_disable_status_resp_msg_v01), sar_mmw_module_disable_status_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry sar_service_command_messages_v01[] = {
  ...
  {QMI_SAR_MMW_MODULE_DISABLE_REQ_V01, QMI_IDL_TYPE16(0, 6), 11},
  ...
  {QMI_SAR_MMW_MODULE_DISABLE_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 23), 0}
};
...
static const qmi_idl_service_message_table_entry sar_service_response_messages_v01[] = {
  ...
  {QMI_SAR_MMW_MODULE_DISABLE_STATUS_RESP_V01, QMI_IDL_TYPE16(0, 24), 18}
};
