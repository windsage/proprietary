...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/10.0/pdc/src/persistent_device_configuration_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Mon Dec  4 2023 (Spin 0)
...
static const uint8_t pdc_backup_config_info_type_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_info_type_v01, total_backup_config_size),

  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_info_type_v01, config_frame),
  ((PDC_CONFIG_FRAME_SIZE_MAX_V01) & 0xFF), ((PDC_CONFIG_FRAME_SIZE_MAX_V01) >> 8),
  QMI_IDL_OFFSET8(pdc_backup_config_info_type_v01, config_frame) - QMI_IDL_OFFSET8(pdc_backup_config_info_type_v01, config_frame_len),
...
static const uint8_t pdc_delete_config_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_delete_config_req_msg_v01, config_id) - QMI_IDL_OFFSET8(pdc_delete_config_req_msg_v01, config_id_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_delete_config_req_msg_v01, subscription_id) - QMI_IDL_OFFSET8(pdc_delete_config_req_msg_v01, subscription_id_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_delete_config_req_msg_v01, subscription_id)
};
...
static const uint8_t pdc_load_config_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pdc_load_config_req_msg_v01, storage) - QMI_IDL_OFFSET16RELATIVE(pdc_load_config_req_msg_v01, storage_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(pdc_load_config_req_msg_v01, storage),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pdc_load_config_req_msg_v01, subscription_id) - QMI_IDL_OFFSET16RELATIVE(pdc_load_config_req_msg_v01, subscription_id_valid)),
  0x12,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(pdc_load_config_req_msg_v01, subscription_id)
};
...
static const uint8_t pdc_get_config_info_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_info_req_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_get_config_info_req_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_info_req_msg_v01, ind_token),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_config_info_req_msg_v01, subscription_id) - QMI_IDL_OFFSET8(pdc_get_config_info_req_msg_v01, subscription_id_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_get_config_info_req_msg_v01, subscription_id)
};
...
static const uint8_t pdc_backup_config_req_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_backup_config_req_msg_v01, backup_config_info),
  QMI_IDL_TYPE88(0, 4),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(pdc_backup_config_req_msg_v01, ind_token) - QMI_IDL_OFFSET16RELATIVE(pdc_backup_config_req_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET16ARRAY(pdc_backup_config_req_msg_v01, ind_token)
};

static const uint8_t pdc_backup_config_resp_msg_data_v01[] = {
  0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(pdc_backup_config_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_resp_msg_v01, frame_data_reset) - QMI_IDL_OFFSET8(pdc_backup_config_resp_msg_v01, frame_data_reset_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_resp_msg_v01, frame_data_reset)
};

static const uint8_t pdc_backup_config_ind_msg_data_v01[] = {
  0x01,
   QMI_IDL_2_BYTE_ENUM,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, error),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, ind_token) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, ind_token_valid)),
  0x10,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, ind_token),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, received_config_size) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, received_config_size_valid)),
  0x11,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, received_config_size),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, remaining_config_size) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, remaining_config_size_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, remaining_config_size),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_format) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_format_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_format),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, frame_index) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, frame_index_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, frame_index),

  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, frame_data_reset) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, frame_data_reset_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, frame_data_reset),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_frame) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_frame_valid)),
  0x16,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_frame),
  ((PDC_CONFIG_FRAME_SIZE_MAX_V01) & 0xFF), ((PDC_CONFIG_FRAME_SIZE_MAX_V01) >> 8),
  QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_frame) - QMI_IDL_OFFSET8(pdc_backup_config_ind_msg_v01, result_frame_len)
};
...
static const qmi_idl_type_table_entry  pdc_type_table_v01[] = {
  ...
  {sizeof(pdc_backup_config_info_type_v01), pdc_backup_config_info_type_data_v01}
};
...
static const qmi_idl_message_table_entry pdc_message_table_v01[] = {
  ...
  {sizeof(pdc_backup_config_req_msg_v01), pdc_backup_config_req_msg_data_v01},
  {sizeof(pdc_backup_config_resp_msg_v01), pdc_backup_config_resp_msg_data_v01},
  {sizeof(pdc_backup_config_ind_msg_v01), pdc_backup_config_ind_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry pdc_service_command_messages_v01[] = {
  ...
  {QMI_PDC_DELETE_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 14), 149},
  {QMI_PDC_LOAD_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 17), 32927},
  {QMI_PDC_ACTIVATE_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 20), 35},
  {QMI_PDC_GET_CONFIG_INFO_REQ_V01, QMI_IDL_TYPE16(0, 23), 146},
  ...
  {QMI_PDC_BACKUP_CONFIG_REQ_V01, QMI_IDL_TYPE16(0, 54), 32784}
};
...
static const qmi_idl_service_message_table_entry pdc_service_response_messages_v01[] = {
  ...
  {QMI_PDC_BACKUP_CONFIG_RESP_V01, QMI_IDL_TYPE16(0, 55), 11}
};
...
static const qmi_idl_service_message_table_entry pdc_service_indication_messages_v01[] = {
  ...
  {QMI_PDC_BACKUP_CONFIG_IND_V01, QMI_IDL_TYPE16(0, 56), 32817}
};
