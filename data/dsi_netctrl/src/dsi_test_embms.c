...
/*===========================================================================
  ...
  Copyright (c) 2011-2013, 2016, 2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
                   ...
                   dsi_net_evt_t evt)
{
  ...
  case DSI_NET_TMGI_ACTIVATED:
    DSI_TEST_REPORT_LOG("dsi_test_embms_cb: evt DSI_NET_TMGI_ACTIVATED recvd");
    break;
  case DSI_NET_TMGI_DEACTIVATED:
    DSI_TEST_REPORT_LOG("dsi_test_embms_cb: evt DSI_NET_TMGI_DEACTIVATED recvd");
    break;
  case DSI_NET_TMGI_ACTIVATED_DEACTIVATED:
    DSI_TEST_REPORT_LOG("dsi_test_embms_cb: evt DSI_NET_TMGI_ACTIVATED_DEACTIVATED recvd");
    break;
  case DSI_NET_TMGI_LIST_CHANGED:
    DSI_TEST_REPORT_LOG("dsi_test_embms_cb: evt DSI_NET_TMGI_LIST_CHANGED");
    break;
  case DSI_NET_SAI_LIST_CHANGED:
    DSI_TEST_REPORT_LOG("dsi_test_embms_cb: evt DSI_NET_SAI_LIST_CHANGED");
    break;
  default:
...
int test_embms_execute(dsi_test_obj_t * obj)
{
  ...
  {  
    ...
    if(TRUE == evt_rcvd)
    {
      ...
      {
        DSI_TEST_REPORT_LOG("verified NET_TMGI_ACTIVATED rcvd");
      }
    }
    else
    {
      DSI_TEST_ERR("NET_TMGI_ACTIVATED not rcvd");
      break;
    }
    evt_rcvd = FALSE;
    ...
    if(TRUE == evt_rcvd)
    {
      ...
      {
        DSI_TEST_REPORT_LOG("verified NET_TMGI_DEACTIVATED rcvd");
      }
    }
    else
    {
      DSI_TEST_ERR("NET_TMGI_DEACTIVATED not rcvd");
      break;
    }
    evt_rcvd = FALSE;
    ...
    if(TRUE == evt_rcvd)
    {
      ...
      {
        DSI_TEST_REPORT_LOG("verified DSI_NET_TMGI_ACTIVATED_DEACTIVATED rcvd");
      }
    }
    else
    {
    ...
    if(TRUE == evt_rcvd)
    {
      ...
      {
        DSI_TEST_REPORT_LOG("verified DSI_NET_TMGI_LIST_CHANGED rcvd");
      }
    }
    else
    {
      DSI_TEST_ERR("DSI_NET_TMGI_LIST_CHANGED not rcvd");
      break;
    }
    evt_rcvd = FALSE;
    ...
    if (TRUE == evt_rcvd)
    {
       ...
       {
         DSI_TEST_REPORT_LOG("verified DSI_NET_SAI_LIST_CHANGED rcvd");
       }
    }
