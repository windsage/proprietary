                   ...
                   dsi_net_evt_t evt)
{
  ...
  case DSI_EVT_NET_IS_CONN:
    DSI_TEST_REPORT_LOG("dsi_test_1_cb: evt DSI_EVT_NET_IS_CONN rcvd");
    break;
  case DSI_EVT_NET_NO_NET:
    DSI_TEST_REPORT_LOG("dsi_test_1_cb: evt DSI_EVT_NET_NO_NET rcvd");
    break;
  default:
...
int test_1_execute(dsi_test_obj_t * obj)
{
  ...
  do
  {
    ...
    pthread_mutex_unlock(&mutex);
    DSI_TEST_REPORT_LOG("verified NET_IS_CONN rcvd");
    ...
    DSI_TEST_REPORT_LOG("verified NET_NO_NET rcvd in modem oos");
    ...
    {
      DSI_TEST_REPORT_LOG("verified can't get hndl when modem oos");
    }    
    ...
    pthread_mutex_unlock(&mutex);
    DSI_TEST_REPORT_LOG("verified NET_IS_CONN rcvd after modem is");
    ...
    pthread_mutex_unlock(&mutex);
    DSI_TEST_REPORT_LOG("verified NET_NO_NET rcvd after test posted platform down");
