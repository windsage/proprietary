...
typedef enum dsi_ce_reason_code_e
{
  ...
  DSI_CE_REASON_CODE_RESTART_ONGOING,
  DSI_CE_REASON_CODE_ERROR,
...
#define DSI_IP_VERSION_INVALID    (0)
...
typedef enum
{
  ...
  DSI_EVT_FLOW_ACTIVATED,
  DSI_EVT_FLOW_DELETED,
  DSI_EVT_FLOW_MODIFIED,
  DSI_EVT_FLOW_SUSPENDED,
  DSI_EVT_FLOW_ENABLED,
  DSI_EVT_FLOW_DISABLED,
...
#define DSI_MODE_LOW_LATENCY_EX 0x0002
...
===========================================================================*/
/** @ingroup dsi_get_lib_version_info

    function to get dsi library version

    @return
    DSI_NETCRTL_VERSION -- if dsi library version is defined
    INVALID REQUEST -- if not defined.
...
extern const char*  dsi_get_lib_version_info(void);
