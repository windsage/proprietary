TARGET_LIST := msm8998 sdm845 sdm710 msmnile $(MSMSTEPPE) $(TRINKET) kona lito atoll bengal lahaina holi taro kalama monaco blair
...
PILSPLITTER_BASE := $(QC_PROP_ROOT)/common/scripts
...
# blair IPA FWs configs (IPAv4.11)
ifeq ($(call is-board-platform-in-list,blair),true)
$(info IPA_FWS creation for blair)
DPS_ADDR := 0x05881000
HPS_ADDR := 0x05881080
GSI_ADDR := 0x0581F000
