...
static const ds_target_str_map_t ds_target_str_map[] =
{
    ...
    { DS_TARGET_LANAI, "lanai" },
    { DS_TARGET_BLAIR, "blair" },
      ...
      else
      {
        ...
        switch((int)soc_id)
        {
          ...
          case DS_TARGET_SOC_ID_SGP_CPU_KALAMA:
            ...
            break;
          case DS_TARGET_SOC_ID_SM_LANAI:
          case DS_TARGET_SOC_ID_SMP_LANAI:
          case DS_TARGET_SOC_ID_SM_CLIFFS:
          case DS_TARGET_SOC_ID_SM_CLIFFS7:
          case DS_TARGET_SOC_ID_PITTI:
          case DS_TARGET_SOC_ID_VOLCANO:
          case DS_TARGET_SOC_ID_VOLCANO6:
          case DS_TARGET_SOC_ID_VOLCANO6_SMP:
          case DS_TARGET_SOC_ID_VOLCANO_IOT:
            target = DS_TARGET_LANAI;
            break;
          case DS_TARGET_SOC_ID_BLAIR:
          case DS_TARGET_SOC_ID_HOLI:
          case DS_TARGET_SOC_ID_HOLI_H:
          case DS_TARGET_SOC_ID_BLAIR_LITE:
            target = DS_TARGET_BLAIR;
            break;
