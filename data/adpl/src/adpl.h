...
#define ODL_IPA_CTRL_IOCTL_MAGIC             0xCF
#define ODL_IPA_CTRL_IOCTL_EP_LOOKUP         _IOWR(ODL_IPA_CTRL_IOCTL_MAGIC, 61, odl_ep_info)
#define ODL_IPA_CTRL_IOCTL_MODEM_CONFIG      _IOWR(ODL_IPA_CTRL_IOCTL_MAGIC, 63, odl_modem_config)
...
typedef struct {
  uint32_t cons_pipe_num;
  uint32_t prod_pipe_num;
  uint32_t peripheral_iface_id;
  uint32_t ep_type;
}odl_ep_info;
