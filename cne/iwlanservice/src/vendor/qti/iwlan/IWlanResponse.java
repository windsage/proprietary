...
public class IWlanResponse
{
    ...
    static String responseSetupInfoToString(RadioResponseInfo responseInfo) {
        StringBuilder b = new StringBuilder();
        b.append("Type = " + responseInfo.type);
        b.append("Serial = " + responseInfo.serial);
        b.append(", RadioError = " + responseInfo.error);
        return b.toString();
    }
    ...
    static String setDataCallResponseToString(SetupDataCallResult setupDataCallResult) {
        ...
        b.append(", cid = " + setupDataCallResult.cid);
        ...
        b.append(", Iface Name  = " + setupDataCallResult.ifname);
        ...
        b.append(", Default Qos = " + setupDataCallResult.defaultQos);
        b.append(", Qos Session = [" + TextUtils.join(",", setupDataCallResult.qosSessions) + "]");
        b.append(", Handover Failure Mode = " + setupDataCallResult.handoverFailureMode);
        b.append(", Pdu Session Id = " + setupDataCallResult.pduSessionId);
        b.append(", Traffic Descriptor  = [" + TextUtils.join(",", setupDataCallResult.trafficDescriptors) + "]");
        return b.toString();
    }
    ...
    public void setupDataCallResponse(RadioResponseInfo responseInfo,
        ...
        mProxy.iwlanLog.d(IWlanDataService.TAG, "setupDataCallResponse: " + responseSetupInfoToString(responseInfo));
        mProxy.iwlanLog.d(IWlanDataService.TAG, "setupDataCallResponse: " + setDataCallResponseToString(setupDataCallResult));
        setupResponse(responseInfo, setupDataCallResult);
    }
    ...
    public void getDataCallListResponse(RadioResponseInfo responseInfo,
        ...
        dataCallListResponse(responseInfo, dataCallResultList);
    }
    ...
    private void setupResponse(RadioResponseInfo responseInfo,
                               SetupDataCallResult setupDataCallResult) {

        IWlanResponseInfo iwlanResponse = new IWlanResponseInfo();
        iwlanResponse.serial = responseInfo.serial;
        iwlanResponse.error = responseInfo.error;
        IWlanRequest rr = mProxy.processResponse(iwlanResponse, false, IWlanDataService.TAG);
        ...
        if (rr != null) {
            ...
            mProxy.iwlanLog.e(IWlanDataService.TAG, "setupResponse: request not found");
        }
    }

    private void dataCallListResponse(RadioResponseInfo responseInfo,
                                      ArrayList<SetupDataCallResult> dataCallResultList) {
        IWlanResponseInfo iwlanResponse = new IWlanResponseInfo();
        iwlanResponse.serial = responseInfo.serial;
        iwlanResponse.error = responseInfo.error;
        ...
        if (rr != null) {
            ...
            mProxy.iwlanLog.e(IWlanDataService.TAG, "dataCallListSetupResponse: request not found");
        }
    }
