...
public class QualifiedNetworksServiceImpl extends QualifiedNetworksService {
    ...
    private class NetworkAvailabilityProviderImpl extends NetworkAvailabilityProvider {
                ...
                public void handleMessage(Message message) {
                    ...
                    switch (message.what) {
                        case GET_QUALIFIED_NETWORKS_COMPLETE:
                            ...
                            updateQualifiedNetworks((List<vendor.qti.hardware.data.iwlandata.QualifiedNetworks>) ar.result);
        ...
        private void updateQualifiedNetworks(List<vendor.qti.hardware.data.iwlandata.QualifiedNetworks> qnpList) {
            ...
            for (vendor.qti.hardware.data.iwlandata.QualifiedNetworks qNetwork : qnpList) {
