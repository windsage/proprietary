...
/* Log code to track buffers in OEM  */
#define LOG_QBI_MBOEM_EXTENDED_RX_MESSAGE_C                   ((0xE8D) + LOG_1X_BASE_C)
#define LOG_QBI_MBOEM_EXTENDED_TX_MESSAGE_C                   ((0xE8E) + LOG_1X_BASE_C)

/* The last defined DMSS log code */
#define LOG_1X_LAST_C                                         ((0xE8E) + LOG_1X_BASE_C)
