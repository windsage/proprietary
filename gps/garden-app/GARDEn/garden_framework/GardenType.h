...
typedef struct command_line_options {
    ...
    int sessionCount; // Number of sessions to loop through.
    ...
    char iGnssApiCmdFile[256]; // Path to IGnssApi input file
    char iGnssApiCmdStr[1024]; // IGnssApiCase command string
