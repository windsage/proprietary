...
=============================================================================*/
#define LOG_TAG "GARDEN_LocationClientApiCase"
    ...
    while (!exit_loop) {
        ...
        switch (type) {
            ...
            case TEST_NETWORK_UP:
                mPLocationClient->updateNetworkAvailability(0x0123456789ABCDEF, true, 0, NULL);
                break;
            case TEST_NETWORK_DOWN:
                mPLocationClient->updateNetworkAvailability(~0, false, 0, NULL);
                break;
