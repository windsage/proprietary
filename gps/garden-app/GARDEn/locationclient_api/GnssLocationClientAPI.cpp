...
static void gnssMeasurementsCb(const location_client::GnssMeasurements& gnssMeasurements) {
    ...
    if (mPlocationClient->getCbOutput()) {
        ...
        gardenPrint(" time_ns: %" PRId64 " full_bias_ns: %" PRId64 ""
            ...
            " hw_clock_discontinuity_count: %d, elapsedRealTime: %" PRIu64 ""
            " elapsedRealTimeUnc: %" PRIu64 " elapsedgPTPTime: %" PRIu64 ""
            " elapsedRealTimeUnc: %" PRIu64 ", flags: 0x%04x, isNHz: %d",
            ...
            gnssMeasurements.clock.elapsedRealTime,
            gnssMeasurements.clock.elapsedRealTimeUnc,
            gnssMeasurements.clock.elapsedgPTPTime,
            gnssMeasurements.clock.elapsedgPTPTimeUnc,
