...
GnssMultiClientFileTest::cmdSetBlacklist(const std::vector<std::string>& cmdTokens)
{
    ...
    PRINTLN("GPS: 0x%" PRIx64, gpsMask);
    PRINTLN("GAL: 0x%" PRIx64, galMask);
    PRINTLN("GLO: 0x%" PRIx64, gloMask);
    PRINTLN("BDS: 0x%" PRIx64, bdsMask);
    PRINTLN("QZSS: 0x%" PRIx64, qzssMask);
