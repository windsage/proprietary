...
enum QDgnssDataSource {
    ...
    /** Internal Ntrip source */
    CDFW_DATA_SOURCE_INTERNAL_1 = 2,
    /** External QESDK app */
    CDFW_DATA_SOURCE_EXTERNAL = 3,
    /** Modem 3GPP RTK Rel-16 */
    CDFW_DATA_SOURCE_MODEM  = 4,
    /** QPPE SSR2OSR lib */
    CDFW_DATA_SOURCE_QPPE = 5,
};

enum QDgnssInjectDataFormat{
    /** Source data format is unknown */
    CDFW_DATA_FORMAT_UNKNOWN                = 0,
    /** Source data original format is RTCM_3 */
    CDFW_DATA_FORMAT_RTCM_3                 = 1,
    /** Source data original format is 3GPP RTK Rel-16 */
    CDFW_DATA_FORMAT_3GPP_RTK_R16           = 2,
};
...
enum QDgnssMsgId {
    ...
    QDGNSS_OBSERVATION_AVAIL_MSG_ID                 = 15,
    QDGNSS_SSR_PHASE_BIAS_MSG_ID                    = 16,
    QDGNSS_SSR_GRID_POINTS_MSG_ID                   = 17,
    QDGNSS_SSR_STEC_CORRECTION_MSG_ID               = 18,
    QDGNSS_SSR_STEC_RESIDUAL_CORRECTION_MSG_ID      = 19,
    QDGNSS_SSR_TROPOSPHERIC_CORRECTION_MSG_ID       = 20,
    QDGNSS_DGNSS_MSG_MAX_ID                         = 21,
...
#define QDGNSS_OBSERVATION_AVAIL_MSG_BIT \
        QDGNSS_MSG_ID_TO_MSG_MASK(QDGNSS_OBSERVATION_AVAIL_MSG_ID)
#define QDGNSS_SSR_PHASE_BIAS_MSG_BIT \
        QDGNSS_MSG_ID_TO_MSG_MASK(QDGNSS_SSR_PHASE_BIAS_MSG_ID)
#define QDGNSS_SSR_GRID_POINTS_MSG_BIT \
        QDGNSS_MSG_ID_TO_MSG_MASK(QDGNSS_SSR_GRID_POINTS_MSG_ID)
#define QDGNSS_SSR_STEC_CORRECTION_MSG_BIT \
        QDGNSS_MSG_ID_TO_MSG_MASK(QDGNSS_SSR_STEC_CORRECTION_MSG_ID)
#define QDGNSS_SSR_STEC_RESIDUAL_CORRECTION_MSG_BIT \
        QDGNSS_MSG_ID_TO_MSG_MASK(QDGNSS_SSR_STEC_RESIDUAL_CORRECTION_MSG_ID)
#define QDGNSS_SSR_TROPOSPHERIC_CORRECTION_MSG_BIT \
        QDGNSS_MSG_ID_TO_MSG_MASK(QDGNSS_SSR_TROPOSPHERIC_CORRECTION_MSG_ID)
