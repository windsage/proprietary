...
#include <deque>
#include <chrono>
#include "qsh_utils_register_cb_reference.h"
...
class ssc_qmi : public ssc_interface {
public:
  ssc_qmi();
  ~ssc_qmi();
...
private:
  ...
  std::unordered_map<sensor_uid, ssc_register_cb, cb_sensor_uid_hash>     _callback_map_table;
