...
#define VN_ENABLE_BUFFERED_DATA_ID               "VN_ENABLE_BUFFERED_DATA"
#define VN_DATA_TIMESTAMP_SRC_ID                 "VN_DATA_TIMESTAMP_SRC"
...
VehicleNetworkConfiguration::VehicleNetworkConfiguration()
  ...
  mVnwEnableBufferedData(0x01),
  mVnwDataTimeSource(SLIM_VNW_TIMESTAMP_SRC_CAN_CONTROLLER)
{
}
...
// See header file for function documentation
uint8_t VehicleNetworkConfiguration::GetVnwEnableBufferedDataValue() const
{
  return mVnwEnableBufferedData;
}

uint32_t VehicleNetworkConfiguration::GetVnwDataTimeSrcValue() const
{
  return mVnwDataTimeSource;
}
...
void VehicleNetworkConfiguration::Load()
{
  ...
  { VN_ENABLE_BUFFERED_DATA_ID, &mVnwEnableBufferedData, NULL, 'n' },
  { VN_DATA_TIMESTAMP_SRC_ID, &mVnwDataTimeSource, NULL, 'n' }
  };
...
void VehicleNetworkConfiguration::ToString(char* pStr, size_t sLen) const
{
  ...
  snprintf(pStr, sLen, "[file:'%s', m_dCanApClockRatio:%f, "
                       ...
                       "mVnwEnableBufferedData:%X, "
                       "mVnwDataTimeSource: %d]",
           VN_CFG_FILE_NAME,
           m_dCanApClockRatio,
