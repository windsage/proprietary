...
void VehicleNetworkMessageProcessor::flushPrevData()
{
  SLIM_LOG_ENTRY();
  return;
}
...
void VehicleNetworkCONF1AccelMP::flushPrevData()
{
  /* if samples are present */
  if (0 != mZData.samples_len) {
    /* record time variable and route data to client */
    m_tLastCANPktTime = mZData.timeBase +
               mZData.samples[mZData.samples_len].sampleTimeOffset;
    m_tLastAPSSPktTime = slim_TimeTickGetMilliseconds();
    m_pzParent->routeIndication(eSLIM_SERVICE_VEHICLE_ACCEL, mZData);
    /* Re initialize sample length and Last CAN packet time*/
    mZData.samples_len = 0;
    mZData.samples[0].sampleTimeOffset = 0;
...
void VehicleNetworkCONF1GyroMP::flushPrevData()
{
  /* if samples are present */
  if (0 != mZData.samples_len) {
    /* record time variable and route data to client */
...
void VehicleNetworkCONF1OdometryMP::flushPrevData()
{
  /* if samples are present */
  if (0 != mZData.samples_len) {
    /* record time variable and route data to client */
...
void VehicleNetworkCONF1SpeedMP::flushPrevData()
{
  /* if samples are present */
  if (0 != mZData.samples_len) {
    /* record time variable and route data to client */
...
void VehicleNetworkCONF1DwsMP::flushPrevData()
{
  /* if samples are present */
  if (0 != mZData.samples_len) {
    /* record time variable and route data to client */
...
void VehicleNetworkCONF1GearMP::flushPrevData()
{
  /* if samples are present */
  if (0 != mZData.samples_len) {
    /* record time variable and route data to client */
...
void VehicleNetworkCONF1SteeringWheelMP::flushPrevData()
{
  /* if samples are present */
  if (0 != mZData.samples_len) {
    /* record time variable and route data to client */
