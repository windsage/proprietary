...
Copyright (c) 2013-2017, 2019-2022 Qualcomm Technologies, Inc.
All Rights Reserved.
...
#define SLIM_SHD_VENDOR_NAME_MAX 100
#define SLIM_SENSOR_SETTING_PROVIDER_MAX 32
/**
@brief FullScale, Vendor Name and sensor ODR Info

@sa slimSensorInfoStructT
*/
typedef struct {
  /*! current full-scale setting of specified service
     Values are specific to each service
     ACC_RANGE values are(G) 2 4 8 16
     GYRO_RANGE values are(dps) 125 250 500 1000 2000 4000
    */
  uint16_t fullScaleSetting;
  /* Sensor Vendor Name */
  uint8_t  vendorName[SLIM_SHD_VENDOR_NAME_MAX];
  /* Sensor ODR */
  uint16_t samplingRate;
}slimSensorInfoStructT;
...
typedef struct {
  ...
  slimSensorInfoStructT m_qsensorInfo[SLIM_SENSOR_SETTING_PROVIDER_MAX];
  /**< current full-scale setting of specified service
     Values are specific to each service
     ACC_RANGE values are(G) 2 4 8 16
     GYRO_RANGE values are(dps) 125 250 500 1000 2000 4000
    */
}slimServiceMaskFullScaleT;
