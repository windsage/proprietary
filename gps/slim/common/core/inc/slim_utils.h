...
/*============================================================================
Copyright (c) 2014-2015, 2019, 2021-2022 Qualcomm Technologies, Inc.
All Rights Reserved.
...
typedef struct slim_ProviderConfigChangeStructType
{
  ...
  slimSensorInfoStructT     q_SensorInfo[SLIM_SENSOR_SETTING_PROVIDER_MAX];
                            /*!< sensor setting Information */
