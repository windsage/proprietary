...
*/
/*
  Copyright (c) 2014-2017, 2021-2022 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
boolean slim_QSEncodeServiceFullScaleSetting
(
  uint16_t q_FullScale,
  uint8_t *pu_FullScaleOutValid,
  uint16_t *pq_FullScaleOut
);

/**
  @brief Translates VendorName QMI-SLIM type
  ...
  @ingroup slim_QSEncDec
 */
boolean slim_QSEncodeServiceVendorName
(
  uint8_t *pu_VendorName,
  uint8_t *pu_vendorName_valid,
  uint8_t *pu_VendorNameOut,
  uint8_t *pu_VendorNameLengthOut
);

/**
  @brief Translates SamplingRate QMI-SLIM type
  ...
  @ingroup slim_QSEncDec
 */
boolean slim_QSEncodeServiceSamplingRate
(
  uint16_t q_samplingRate,
  uint8_t *pu_samplingRateOutValid,
  uint16_t *pq_samplingRateOut
);
...
boolean slim_QSDecodeServiceFullScaleSetting
(
  uint8_t u_FullScaleValid,
  uint16_t q_FullScale,
  uint16_t *pq_FullScaleOut
);
/**
  @brief Translates QMI-SLIM VendorName

  When QMI-SLIM field is not present, fullScaleSetting set to zero.
  ...
  @ingroup slim_QSEncDec
 */
boolean slim_QSDecodeServiceVendorName
(
  uint8_t u_vendorName_valid,
  uint8_t u_vendorName_len,
  uint8_t *pu_VendorName,
  uint8_t *pu_VendorNameOut
);
/**
  @brief Translates QMI-SLIM SamplingRate
  ...
  @ingroup slim_QSEncDec
 */
boolean slim_QSDecodeServiceSamplingRate
(
  uint8_t u_samplingRateValid,
  uint16_t q_samplingRate,
  uint16_t *pq_samplingRateOut
);
/**
