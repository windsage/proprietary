...
private:
  ...
  /**
   * @brief Configuration flag for selecting SHD provider.
   */
#if  defined(FEATURE_LOCTECH_SLIM_SENSOR_HAL_DAEMON) || defined(FEATURE_LOCTECH_SLIM_SENSOR_HAL)
  bool                         m_uSensorHalDeamonProviderEnabled;
#endif
  /**
...
public:
  ...
  inline uint32_t getLaunchTriggerMask() {return m_launchTriggerMask;}
};
