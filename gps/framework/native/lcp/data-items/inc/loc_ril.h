...
enum LOC_RilTechType
{
  LOC_RIL_TECH_INVALID  = 0x0,
  LOC_RIL_TECH_CDMA     = 0x1,
  LOC_RIL_TECH_GSM      = 0x2,
  LOC_RIL_TECH_WCDMA    = 0x4,
  LOC_RIL_TECH_LTE      = 0x8,
  LOC_RIL_TECH_TD_SCDMA = 0x10,
  LOC_RIL_TECH_NR       = 0x20,
...
struct LOC_RilTechNrCinfo
{
  ...
  // MAX_INT32 for unknown
  int32_t tac;

  // 64-bit NR Cell Identity described in 3GPP TS 38.331
  uint64_t nci;

  /* 32-bit Physical cell id described in 3GPP TS 38.331, INT_MAX if unknown  */
  uint32_t pci;

  /*NR Absolute Radio Frequency Channel Number Reference:
  3GPP TS 38.101-1 and 3GPP TS 38.101-2 section 5.4.2.1*/
  int32_t nrarfcn;
};
...
// The following defines are for valid_mask in LOC_RilTechNrCinfo
#define LOC_RIL_TECH_NR_HAS_MCC      0x00000008
#define LOC_RIL_TECH_NR_HAS_MNC      0x00000010
#define LOC_RIL_TECH_NR_HAS_TAC      0x00000020
#define LOC_RIL_TECH_NR_HAS_NCI      0x00000040
#define LOC_RIL_TECH_NR_HAS_PCI      0x00000080
#define LOC_RIL_TECH_NR_HAS_NRARFCN  0x00000100
