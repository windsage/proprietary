    ...
    inline LocationUpdaterWrapper(remoteClientInfo *pClientInfo, void* clientData) :
        ...
        if (pClientInfo->locCb) {
            location_client::GnssLocationCb locationCb =
                ...
                if (LCA_GNSS_LOCATION_INFO_ALTITUDE_MEAN_SEA_LEVEL_BIT &
                        gnssLocation.gnssInfoFlags) {
                    locationExtended.flags |= GPS_LOCATION_EXTENDED_HAS_ALTITUDE_MEAN_SEA_LEVEL;
                    locationExtended.altitudeMeanSeaLevel = gnssLocation.altitudeMeanSeaLevel;
                }

                if (LCA_GNSS_LOCATION_INFO_DOP_BIT & gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_EXT_DOP_BIT & gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_MAGNETIC_DEVIATION_BIT &
                        gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_HOR_RELIABILITY_BIT &
                        gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_VER_RELIABILITY_BIT &
                        gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_HOR_ACCURACY_ELIP_SEMI_MAJOR_BIT &
                        gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_HOR_ACCURACY_ELIP_SEMI_MINOR_BIT &
                        gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_HOR_ACCURACY_ELIP_AZIMUTH_BIT &
                        gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_GNSS_SV_USED_DATA_BIT &
                      gnssLocation.gnssInfoFlags) {
                ...
                if (LCA_GNSS_LOCATION_INFO_NAV_SOLUTION_MASK_BIT &
                        gnssLocation.gnssInfoFlags) {
