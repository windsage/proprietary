...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2015-2016, 2018-2020, 2024 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
public:
    ...
    /**
     * @brief Gets request Type.
     * @details Gets request Type.
     * @return Instance of IzatRequestType.
     */
    IzatRequestType getRequestType () const {
        return mRequestType;
    }

    /**
     * @brief Gets request UID.
     * @details Gets request UID.
     * @return UID.
     */
    uint32_t getRequestUID () const {
        return mUID;
    }
    ...
    /**
     * @brief Sets Izat request Type.
     * @details Sets Izat request Type.
     *
     * @param IzatRequestType.
     */
    void setRequestType (IzatRequestType reqType) {
        mRequestType = reqType;
    }

    /**
     * @brief Sets Izat request UID.
     * @details Sets Izat request UID.
     *
     * @param UID.
     */
    void setRequestUID (uint32_t uid) {
        mUID = uid;
    }
