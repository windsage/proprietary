...
GENERAL DESCRIPTION
  ...
  Copyright (c) 2015 - 2016, 2023, 2024 Qualcomm Technologies, Inc.
...
public:
    ...
    virtual void onLocationChanged (const IzatLocation * location, int locCnt,
            const IzatLocationStatus status) = 0;
    ...
    /**
     * @brief Invoked when wwan positioning need to open/release network connection
     * @details Invoked when wwan positioning need to open/release network connection
     *
     * @param bool isStart indicates to oepn or release network connection
     */
    virtual void onRequestNetwork (bool isStart) {}
    /**
     * @brief Destructor
     * @details Destructor
     */
