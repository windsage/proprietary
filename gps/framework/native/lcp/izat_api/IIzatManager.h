...
GENERAL DESCRIPTION
  ...
  Copyright  (c) 2015 - 2016, 2020 - 2024 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
public:
    ...
    /**
     * @brief provide network connection status
     * @details provider network connection status
     *
     * @param status network status
     * @return Zero for sucess and non zero for failure
     */
    virtual int32 notifyNetworkStatus (const IzatNetworkStatus& status) = 0;
