...
public:
    ...
    void reset () {
        ...
        mHasGpsTime = false;
        mHasExtDOP = false;
        mHasSystemTick = false;
        mHasConformityIndex = false;
    }
    ...
    */
    ...
    /**
    * Boolean flag to indicate presence of system tick
    */
    bool mHasSystemTick;
    ...
    */
    ...
    /**
    * Boolean flag to indicate presence of conformity index
    */
    bool mHasConformityIndex;

    /**
    * Conformity Index
    */
    float mConformityIndex;

    /**
    * Boolean flag to indicate presence of altitude reference type
    */
    bool mHasAltitudeRefType;

    /**
    * Altitude reference type
    */
    IzatAltitudeRefType mAltitudeRefType;
...
private:
    ...
    void makeCopy  (const IzatLocation & rhs) {
        ...
        mHasSystemTick = rhs.mHasSystemTick;
        mSystemTick = rhs.mSystemTick;

        mHasConformityIndex = rhs.mHasConformityIndex;
        mConformityIndex = rhs.mConformityIndex;

        mHasAltitudeRefType = rhs.mHasAltitudeRefType;
        mAltitudeRefType = rhs.mAltitudeRefType;
    }
};
