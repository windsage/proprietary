...
public:
    ...
    typedef enum LocationRequestAction {
        ...
        LocationRequestAction_Realign_tbf_Immediate
    } LocationRequestAction;

    typedef enum LocationRequestAccuracy {
        LocationRequestAccuracy_Nominal,
        LocationRequestAccuracy_High
    ...
    typedef struct {
        ...
        LocationRequestAccuracy accuracy;
        uint32_t               uid;
    } LocationRequest;
