...
private:
    ...
    qmi_client_error_type locQmiWdsGetProfileSettingsLite(qmi_client_type& qmiSvcClient,
    ...
    qmi_client_error_type locQmiWdsGetProfileListLite(qmi_client_type& qmiSvcClient,
...
public:
    ...
    std::string queryEsProfileIndexLite(int qcmapSubId, uint8_t& esProfileIndex);
};
