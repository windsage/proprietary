...
public:
          ...
          m_conn(conn)
  {
    ...
    do
    {
      ...
      BREAK_IF_ZERO(5, reg_card);
      BREAK_IF_NON_ZERO(6, reg_card->init());
      BREAK_IF_NON_ZERO(7, reg_card->addString("TO", "SERVER"));
      BREAK_IF_NON_ZERO(8, reg_card->addString("FROM", clientName));
      BREAK_IF_NON_ZERO(9, reg_card->addString("REQ", "REGISTER"));
      BREAK_IF_NON_ZERO(10, reg_card->finalize());
      BREAK_IF_NON_ZERO(11, m_conn->send(reg_card->getEncodedBuffer()));
      delete reg_card;
      reg_card = 0;
