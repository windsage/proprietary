...
/** Minor File Version */
#define EP_INTERFACE_FILE_MINOR_VERSION  4
...
#define EP_DELETE_NAVIC_EPHEMERIS_DATA  ((epAidingdataMask)0x20000000)
/** Delete NAVIC Polynomial data */
#define EP_DELETE_NAVIC_POLYNOMIAL_DATA ((epAidingdataMask)0x40000000)
...
#define EP_GNSS_SIGNAL_NAVIC_L5_I     ((epGnssSignalTypeMask)0x00200000)
...
/**NAVIC  Constellation */
#define EP_GNSS_CONSTELLATION_NAVIC ((epGnssConstellationTypeMask) 0x0080)
...
#define EP_POSITION_FLAG_SBAS_CORRECTED_SV_USED ((epPositionFlags)0x00004000)
...
#define EP_SVID_OFFSET_NAVIC       (400)
...
typedef enum {
    ...
    */
     ...
     * device taken through suspend/resume or reboot power-state cycles. */
    EP_COMMAND_PAUSE_RETAIN,
