/******************************************************************************
    Copyright (c) 2007-2011, 2014, 2016, 2018-2024 Qualcomm Technologies, Inc.
    All Rights Reserved.
...
#define EP_1C5E_DIAG_VERSION 11
/* EP correction data version*/
#define EP_1C86_DIAG_VERSION 3
/* EPH Info Diag Version*/
#define EP_1C7B_DIAG_VERSION 8
/* PVT Diag MSG*/
#define EP_1C5B_DIAG_VERSION 16
/* IONO Params Info Diag Version*/
#define EP_1C8B_DIAG_VERSION 5
/* GLO ADD Params Info Diag Version*/
#define EP_1C8C_DIAG_VERSION 4
/* Control command Version*/
#define EP_1C56_DIAG_VERSION 6
/* Subscription info */
#define EP_1C57_DIAG_VERSION 6
/* Error info */
...
/**NAVIC L5_I Band - Data*/
#define EP_DIAG_GNSS_SIGNAL_NAVIC_L5_I      ((epDiagGnssSignalTypeMask)0x00200000)
...
/** NAVIC  Constellation */
#define EP_DIAG_GNSS_CONSTELLATION_NAVIC ((epDiagGnssConstellationTypeMask) 0x0080)
...
typedef uint8_t epDiagCdfwSource;
#define EP_DIAG_CDFW_SOURCE_UNKNOWN  (0)
#define EP_DIAG_CDFW_SOURCE_CV2X     (1)
#define EP_DIAG_CDFW_SOURCE_NTRIP    (2)
#define EP_DIAG_CDFW_SOURCE_QESDK    (3)
#define EP_DIAG_CDFW_SOURCE_MODEM    (4)
#define EP_DIAG_CDFW_SOURCE_QPPE     (5)

typedef uint8_t epDiagCdfwFormat;
#define EP_DIAG_CDFW_FORMAT_UNKNOWN       (0)
#define EP_DIAG_CDFW_FORMAT_RTCM_3        (1)
#define EP_DIAG_CDFW_FORMAT_3GPP_RTK_R16  (2)

TYPEDEF_PACKED_STRUCT {
    epDiagLogGenericHeader header;
    /** Source of correction data */
    epDiagCdfwSource correctionSource;
    /** Length of correction data in correctionData */
    uint32_t correctionLength;
    /** Format of correction data being injected to CDFW */
    epDiagCdfwFormat correctionFormat;
    /** correction data message ID */
    uint8_t messageId;
    /** correction data source provider ID */
    uint32_t correctionSourceProviderId;
...
#define EP_DIAG_POSITION_FLAG_SBAS_CORRECTED_SV_USED ((epDiagPositionFlags)0x00004000)
...
/** Delete NAVIC Ephemeris data*/
#define EP_DIAG_DELETE_NAVIC_EPHEMERIS_DATA  ((epDiagAidingdataMask)0x20000000)
/** Delete NAVIC Polynomial data */
#define EP_DIAG_DELETE_NAVIC_POLYNOMIAL_DATA ((epDiagAidingdataMask)0x40000000)
