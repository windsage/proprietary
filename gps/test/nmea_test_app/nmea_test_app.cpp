...
#define LOC_NMEA_MASK_DEBUG_V02 ((NmeaSentenceTypesMask)0x00020000) /**<  Enable DEBUG NMEA type  */
...
#define LOC_NMEA_ALL_SUPPORTED_MASK  (LOC_NMEA_MASK_GGA_V02 | LOC_NMEA_MASK_RMC_V02 | \
        ...
        LOC_NMEA_MASK_DEBUG_V02 | LOC_NMEA_MASK_GPDTM_V02 | LOC_NMEA_MASK_GNGGA_V02 | \
        LOC_NMEA_MASK_GNRMC_V02 | LOC_NMEA_MASK_GNVTG_V02 | LOC_NMEA_MASK_GAGNS_V02 | \
        LOC_NMEA_MASK_GBGGA_V02 | LOC_NMEA_MASK_GBGSA_V02 | LOC_NMEA_MASK_GBGSV_V02 | \
        LOC_NMEA_MASK_GBRMC_V02 | LOC_NMEA_MASK_GBVTG_V02 | LOC_NMEA_MASK_GQGSV_V02 | \
...
typedef struct command_line_options {
    ...
    int alterEOS;                 // Alter End of Strings
    ...
    void *pClientCookie)
{
    ...
    case QMI_LOC_EVENT_NMEA_IND_V02:
    {
        ...
        if (sOptions.alterEOS) {
            ...
            n = write(tty_fd, buffer, strlen(eventIndPayload.pNmeaReportEvent->nmea));
        }
        if (n < 0) {
...
void printHelp(char **arg)
{
    ...
    printf("    -m:  nmea types subscription mask\n"
           ...
           "         NMEA_MASK_DEBUG      (0x00020000) Enable DEBUG NMEA type\n"
           ...
           "         NMEA_MASK_GBGGA      (0x00800000) Enable GBGGA type\n"
           "         NMEA_MASK_GBGSA      (0x01000000) Enable GBGSA type\n"
           "         NMEA_MASK_GBGSV      (0x02000000) Enable GBGSV type\n"
           "         NMEA_MASK_GBRMC      (0x04000000) Enable GBRMC type\n"
           "         NMEA_MASK_GBVTG      (0x08000000) Enable GBVTG type\n"
           "         NMEA_MASK_GQGSV      (0x10000000) Enable GQGSV type\n"
           "         NMEA_MASK_GIGSV      (0x20000000) Enable GIGSV type\n"
           "         NMEA_MASK_GNDTM      (0x40000000) Enable GNDTM type\n"
           "         NMEA_MASK_ALL        (0x7FFFFFFF) Enable ALL types \n" );

    printf("    -p:  Print NMEA strings, Defaults: %d\n", sOptions.printNmea);
    printf("    -a:  Alter End of NMEA Sentance, Defaults: %d\n", sOptions.alterEOS);
    printf("         -a 1 to remove \\r at End of NMEA Sentance \n");
    printf("         -a 0 for \\r\\n at End of NMEA Sentance \n");
...
int main(int argc, char** argv)
{
    ...
    while ((opt = getopt (argc, argv, "t:d:i:m:p:a:z")) != -1) {
        switch (opt) {
        case 't':
        ...
        case 'p':
            ...
            break;
        case 'a':
            sOptions.alterEOS = atoi(optarg);
            printf("Alter End of Strings :%d \n", sOptions.alterEOS);
            break;
        case 'h':
        default:
            printHelp(argv);
