...
Copyright (c) 2012, 2019, 2021, 2023 Qualcomm Technologies, Inc.
All Rights Reserved.
...
public:
  ...
  enum eResponseType
  {
    ...
    /** Response to LOWI_SNOOP_RTT_REG Request*/
    LOWI_SNOOP_RTT_REGISTER_RESPONSE
  };
...
public:
   ...
   */
  LOWIRangingScanResponse (uint32 requestId, bool isSnoopRTTRsp = false);
  /** Destructor*/
...
class LOWISnoopRTTRegisterResponse :
  public LOWIResponse
{
public:
    ...
    /** Type of Response
    */
    enum eSnoopRTTRegStatus {
      /* Snoop Client has been registered successfully with the server */
      SNOOP_CLIENT_REGISTERED = 0,
      /* Snoop Client Unregistered with the server on request */
      SNOOP_CLIENT_UNREGISTERED,
      /* Snoop Client could not be registered due to max capacity reached
         in low-server */
      MAX_SNOOP_CLIENTS_REACHED,
      /* Snoop Client Unregistered due to timeout expired for the Client */
      TIMEOUT_EXPIRED_FOR_CLIENT,
      /* Client Not registered for Snoop */
      CLIENT_NOT_REGISTERED,
      /* Unknown status/ MAX status value */
      STATUS_UNKNOWN
    };

    eSnoopRTTRegStatus status;
    /**
     * Constructor
     * @param uint32: Corresponding Request Id generated
     *               by the client for request
     * @param eSnoopRTTRegStatus: registration status (default: STATUS UNKNOWN)
     */
    LOWISnoopRTTRegisterResponse (uint32 requestId,
        eSnoopRTTRegStatus reg_status = eSnoopRTTRegStatus::STATUS_UNKNOWN);
    /** Destructor*/
    virtual ~LOWISnoopRTTRegisterResponse ();
