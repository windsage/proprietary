...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/10.0/coex/api/coexistence_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define COEX_V01_IDL_MINOR_VERS 0x2E
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define COEX_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define COEX_V01_MAX_MESSAGE_ID 0x005C
/**
    @}
  */
...
#define COEX_ANT_BLOCKING_MAX_CLIENTS_16_V01 16
...
#define COEX_DISABLE_SPMI_GPR0_MAX_ENTRIES_V01 16
#define COEX_NR5G_MAX_SERVING_CELL_V01 8
/**
    @}
  */
...
typedef struct {
  ...
  coex_nr5g_dl_ul_trans_periodicity_v01 dl_ul_trans_period;
 ...
 */
  ...
  the first full UL slot (as derived from nrofUplinkSlots).
  If the field is absent or released, there is no partial-uplink slot.
 */
}coex_nr5g_common_tdd_ul_dl_pattern_s_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t slot_valid;
  /**<   Identifies if the slot has valid DL-UL information. */

  uint8_t num_dl_sym_present;
  /**<   Identifies if there is a number for downlink symbols present. */
 ...
 */
  ...
  uint8_t num_ul_sym_present;
  /**<   Identifies if there is a number for uplink symbols present. */
 ...
 */
}coex_nr5g_common_tdd_ul_dl_cfg_dedicated_s_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t enable;
  /**<   Flag to enable or disable (i.e., setup/release). */

  coex_nr5g_subcarrier_spacing_v01 ref_scs;
  /**<   Reference SCS used to determine the time domain
   boundaries in the UL-DL pattern, which must be common 
   across all subcarrier specific virtual carriers.
  */

  coex_nr5g_common_tdd_ul_dl_pattern_s_v01 pattern1;
  /**<   TDD-UL DL pattern for common configuration. */

  uint8_t pattern2_enable;
  /**<   Identifies if pattern 2 is present. */

  coex_nr5g_common_tdd_ul_dl_pattern_s_v01 pattern2;
  /**<   TDD-UL DL pattern for common configuration. */
}coex_nr5g_as_tdd_ul_dl_cfg_common_s_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /*  -------------------------------------------------------------------- 
 BELOW FIELDS SHOULD BE READ BASED ONLY IF RESPECTIVE CFG_MASK IS SET 
 --------------------------------------------------------------------  */
  uint64_t tdd_ul_dl_cfg_active_bmask[3];
  /**<   UL DL dedicated configuration for SLOTS and SYMBOLS. */

  uint64_t tdd_ul_dl_cfg_add_mod_bmask[3];
  /**<   UL DL dedicated configuration for SLOTS and SYMBOLS. */

  coex_nr5g_common_tdd_ul_dl_cfg_dedicated_s_v01 tdd_ul_dl_cfg_add_mod[160];
  /**<   slotSpecificConfiguration allows overriding UL/DL allocations provided in tdd-UL-DL-configurationCommon.
  Array of uint64 to represent 160 bits. Position of the bit set corresponds to slot index.
  */

  uint64_t tdd_ul_dl_rel_list_bmask[3];
  /**<   Array of uint64 to represent 160 bits. Position of the bit set corresponds to slot index. */
}coex_nr5g_common_tdd_ul_dl_dedicated_cfg_s_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t tdd_common_ded_bitmask;
  /**<   - 0x1 -- Common is present \n
      - 0x10 -- DED is present \n
      - 0x11 -- Both are present \n
      */

  coex_nr5g_as_tdd_ul_dl_cfg_common_s_v01 tdd_common;
  /**<   Main structure that contains UL and DL TDD common configuration. */

  coex_nr5g_common_tdd_ul_dl_dedicated_cfg_s_v01 tdd_ded;
  /**<   Main structure that contains TDD UL and DL dedicated configuration. */
}coex_nr5g_tdd_config_data_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Indicates if CDRX started for FR2.
       ...
       This CDRX status could be sent independently of the 1.28 sec timer and
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates the usage of FR2 over a 1.28 second window. */
typedef struct {
...
typedef struct {
  ...
  /**<   \nClient antenna blocking information for up to 16 clients. The 
       Extended Client Antenna Block Information TLV should be used instead 
       if it is available.
  */

  /* Optional */
  /*  Extended Client Antenna Blocking Information */
  uint8_t client_info_16_valid;  /**< Must be set to true if client_info_16 is being passed */
  uint32_t client_info_16_len;  /**< Must be set to # of elements in client_info_16 */
  coex_client_ant_blocking_info_type_v01 client_info_16[COEX_ANT_BLOCKING_MAX_CLIENTS_16_V01];
  /**<   \nClient antenna blocking information for 16 specific clients. If available, 
       use this field instead of the client_info field in the Client Antenna Blocking
       Information TLV.
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables the host to request baseband to disable sending of
              certain SPMI messages. Host can use a request message of length
              "0" to reenable all SPMI messages. */
typedef struct {

  /* Mandatory */
  /*  SPMI Message IDs for Disabling */
  uint32_t spmi_msg_id_len;  /**< Must be set to # of elements in spmi_msg_id */
  uint8_t spmi_msg_id[COEX_DISABLE_SPMI_GPR0_MAX_ENTRIES_V01];
  /**<   \n SPMI messages that should be disabled.
  */
}coex_disable_spmi_msg_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables the host to request baseband to disable sending of
              certain SPMI messages. Host can use a request message of length
              "0" to reenable all SPMI messages. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_disable_spmi_msg_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
  ...
  */
/** Request Message; Enables the host to request baseband to disable sending of
              certain GPR0 events. Host can use a request message of length
              "0" to reenable all GPR0 events. */
typedef struct {

  /* Mandatory */
  /*  GPR0 Event IDs for Disabling */
  uint32_t gpr0_event_id_len;  /**< Must be set to # of elements in gpr0_event_id */
  uint8_t gpr0_event_id[COEX_DISABLE_SPMI_GPR0_MAX_ENTRIES_V01];
  /**<   \n GPR0 events that should be disabled.
  */
}coex_disable_gpr0_event_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_disable_gpr0_event_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Indication Message; Indicates NR5G TDD config. */
typedef struct {

  /* Optional */
  /*  NR5G TDD CONFIG */
  uint8_t coex_nr5g_tdd_data_valid;  /**< Must be set to true if coex_nr5g_tdd_data is being passed */
  uint32_t coex_nr5g_tdd_data_len;  /**< Must be set to # of elements in coex_nr5g_tdd_data */
  coex_nr5g_tdd_config_data_v01 coex_nr5g_tdd_data[COEX_NR5G_MAX_SERVING_CELL_V01];
  /**<  
       Indicates the TDD configuration data. 
  */
}coex_send_nr5g_tdd_config_data_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_COEX_DISABLE_GPR0_EVENT_V01
//#define REMOVE_QMI_COEX_DISABLE_SPMI_MSG_V01
...
//#define REMOVE_QMI_COEX_NR5G_TDD_CONFIG_IND_V01
...
#define QMI_COEX_DISABLE_SPMI_MSG_REQ_V01 0x005A
#define QMI_COEX_DISABLE_SPMI_MSG_RESP_V01 0x005A
#define QMI_COEX_DISABLE_GPR0_EVENT_REQ_V01 0x005B
#define QMI_COEX_DISABLE_GPR0_EVENT_RESP_V01 0x005B
#define QMI_COEX_NR5G_TDD_CONFIG_IND_V01 0x005C
/**
    @}
  */
