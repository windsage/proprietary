...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/voice/api/voice_service_v02.h#92 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define VOICE_V02_IDL_MINOR_VERS 0x99
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x0089
/**
    @}
  */
...
#define QMI_VOICE_CALL_REASON_MAX_LEN_V02 64
...
#define QMI_VOICE_CALL_REASON_ARRAY_MAX_V02 7
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  SRTP Status Info Event  */
  uint8_t srtp_status_info_event_valid;  /**< Must be set to true if srtp_status_info_event is being passed */
  uint8_t srtp_status_info_event;
  /**<   Values: \n
	   - 0x00 -- Disable (default) \n
	   - 0x01 -- Enable
  */
  ...
  /* Optional */
  /*  eCall Get Latest MSD Events */
  uint8_t ecall_get_latest_msd_event_valid;  /**< Must be set to true if ecall_get_latest_msd_event is being passed */
  uint8_t ecall_get_latest_msd_event;
  /**<   Values: \n
       - 0x00 -- Disable (default) \n
       - 0x01 -- Enable 
    */
...
typedef struct {
  ...
  */
  ...
  uint32_t call_reason_len;  /**< Must be set to # of elements in call_reason */
  uint16_t call_reason[QMI_VOICE_CALL_REASON_MAX_LEN_V02];
  /**<   Up to 64 UTF-16 characters indicating the call reason and is not guaranteed to be NULL-terminated.
  */
}voice_call_reason_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Call Reason */
  uint8_t call_reason_valid;  /**< Must be set to true if call_reason is being passed */
  uint32_t call_reason_len;  /**< Must be set to # of elements in call_reason */
  voice_call_reason_type_v02 call_reason[QMI_VOICE_CALL_REASON_ARRAY_MAX_V02];
 ...
 */
  ...
  */
  ...
  uint32_t call_reason_len;  /**< Must be set to # of elements in call_reason */
  uint16_t call_reason[QMI_VOICE_CALL_REASON_MAX_LEN_V02];
  /**<   Indicates the intention of the caller, can contain up to 64 UTF-16 characters and is not guaranteed
       to be NULL-terminated.
  */
...
typedef struct {
  ...
  */
}sip_vos_move_sequence_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  sip_vos_coordinate_type_v02 move_coordinates;
  /**<   Move coordinates for SIP VOS move event.
  */

  sip_vos_move_sequence_type_v02 move_sequence;
  /**<   Move sequence information for SIP VOS move event.
  */
}sip_vos_move_slide_info_type_v02;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Information for SIP VOS move event. \n
       Use SIP VOS Move Slide Info TLV instead.
  */
  ...
  */
  ...
  /* Optional */
  /*  SIP VOS Move Slide Info */
  uint8_t sip_vos_move_slide_info_valid;  /**< Must be set to true if sip_vos_move_slide_info is being passed */
  sip_vos_move_slide_info_type_v02 sip_vos_move_slide_info;
  /**<   Information for SIP VOS move event.
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t audio_srtp;
  /**<   Indicates whether the call has audio SRTP enabled.
  */

  uint8_t video_srtp;
  /**<   Indicates whether the call has video SRTP enabled.
  */

  uint8_t text_srtp;
  /**<   Indicates whether the call has text SRTP enabled.
  */
}voice_srtp_status_info_type_v02;  /* Type */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Indicates whether the Voice/VT/RTT call is established with 
    		 SRTP enabled for audio, video, and text.       */
typedef struct {

  /* Mandatory */
  /*  SRTP Status Information */
  voice_srtp_status_info_type_v02 srtp_status_info;
}voice_srtp_status_ind_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients to update the minimum set of data (MSD) to the latest MSD when an eCall is initiated. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}voice_ecall_get_latest_msd_ind_msg_v02;
...
//#define REMOVE_QMI_VOICE_ECALL_GET_LATEST_MSD_IND_V02
...
//#define REMOVE_QMI_VOICE_SRTP_STATUS_IND_V02
...
#define QMI_VOICE_SRTP_STATUS_IND_V02 0x0088
#define QMI_VOICE_ECALL_GET_LATEST_MSD_IND_V02 0x0089
/**
    @}
  */
