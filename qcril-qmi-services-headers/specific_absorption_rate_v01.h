...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.3/sar/api/specific_absorption_rate_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SAR_V01_IDL_MINOR_VERS 0x0F
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SAR_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SAR_V01_MAX_MESSAGE_ID 0x002A
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  uint8_t is_persistent_valid;  /**< Must be set to true if is_persistent is being passed */
  uint8_t is_persistent;
  /**<
     Flag to indicate whether this command is persistent
     through Connected <-> Idle transitions.
  */
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Request Message; Gets the disable transmission status from mmWave modules. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}sar_mmw_module_disable_status_req_msg_v01;
...
/** @addtogroup sar_qmi_messages
    @{
  */
/** Response Message; Gets the disable transmission status from mmWave modules. */
typedef struct {
  ...
  */
  ...
  uint32_t module_disable_bitmask;
  /**<
     Bitmask of mmWave modules that are disabled. Bits turned on denote
     modules whose emission is disabled.
  ...
  */
  ...
  uint8_t is_persistent;
  /**<
     Flag to indicate whether the persistent mode is currently set.
  */
}sar_mmw_module_disable_status_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_SAR_MMW_MODULE_DISABLE_STATUS_V01
...
#define QMI_SAR_MMW_MODULE_DISABLE_STATUS_REQ_V01 0x002A
#define QMI_SAR_MMW_MODULE_DISABLE_STATUS_RESP_V01 0x002A
/**
    @}
  */
