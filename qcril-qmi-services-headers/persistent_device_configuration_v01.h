...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/10.0/pdc/api/persistent_device_configuration_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define PDC_V01_IDL_MINOR_VERS 0x12
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define PDC_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define PDC_V01_MAX_MESSAGE_ID 0x0034
/**
    @}
  */
...
typedef enum {
  ...
  PDC_CONFIG_TYPE_MODEM_DB_V01 = 0x10, /**<  Modem database device configuration type            \n */
  PDC_CONFIG_TYPE_MODEM_DB_SUB_V01 = 0x11, /**<  Modem database subscription configuration type      \n */
  PDC_CONFIG_TYPE_SIGNED_MODEM_DB_V01 = 0x12, /**<  Signed modem database device configuration type     \n */
  PDC_CONFIG_TYPE_SIGNED_MODEM_DB_SUB_V01 = 0x13, /**<  Signed modem database subscription configuration type  */
...
typedef struct {
  ...
  /**<   Type of configuration. Values: \n
      ...
      - PDC_CONFIG_TYPE_MODEM_DB (0x10) --  Modem database device configuration type            \n
      - PDC_CONFIG_TYPE_MODEM_DB_SUB (0x11) --  Modem database subscription configuration type      \n
      - PDC_CONFIG_TYPE_SIGNED_MODEM_DB (0x12) --  Signed modem database device configuration type     \n
      - PDC_CONFIG_TYPE_SIGNED_MODEM_DB_SUB (0x13) --  Signed modem database subscription configuration type 
...
typedef struct {
  ...
  uint32_t total_backup_config_size;
  /**<   Total size of the backup xml configuration.
  */

  uint32_t config_frame_len;  /**< Must be set to # of elements in config_frame */
  uint8_t config_frame[PDC_CONFIG_FRAME_SIZE_MAX_V01];
  /**<   Next frame of the configuration data to store.
  */
}pdc_backup_config_info_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Error code. Values: \n
       ...
       - 0x0010 -- QMI_ERR_NOT_PROVISIONED   -- Specified configuration was 
                                                not found
   */
...
/** @addtogroup pdc_qmi_messages
    @{
  */
/** Request Message; Backs up the specified configuration to device memory. */
typedef struct {

  /* Mandatory */
  /*  Backup Configuration */
  pdc_backup_config_info_type_v01 backup_config_info;
  /**<   Total backup configuration Size. */
  ...
  /**<   Token used to identify the indication sent when the request is complete.
  */
}pdc_backup_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup pdc_qmi_messages
    @{
  */
/** Response Message; Backs up the specified configuration to device memory. */
typedef struct {
  ...
  */
   ...
   */
}pdc_backup_config_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup pdc_qmi_messages
    @{
  */
/** Indication Message; Indicates the backup configuration result.  */
typedef struct {
  ...
  */
  ...
  uint8_t ind_token_valid;  /**< Must be set to true if ind_token is being passed */
  uint32_t ind_token;
  /**<   Token passed in the generated request.
  */
  ...
  /**<   Total size of the received configuration data.
  */
  ...
  /**<   Total size of the remaining configuration data.
  */
  ...
  */
  ...
  /**<   Next frame of the configuration data to store.
  */
}pdc_backup_config_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_PDC_BACKUP_CONFIG_V01
//#define REMOVE_QMI_PDC_BACKUP_CONFIG_IND_V01
...
#define QMI_PDC_BACKUP_CONFIG_REQ_V01 0x0034
#define QMI_PDC_BACKUP_CONFIG_RESP_V01 0x0034
#define QMI_PDC_BACKUP_CONFIG_IND_V01 0x0034
/**
    @}
  */
