...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.2/ssctl/api/subsystem_control_v02.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Fri Jan  7 2022 (Spin 0)
...
#define SSCTL_V02_IDL_MINOR_VERS 0x0A
...
typedef enum {
  ...
  SSCTL_QMI_SERVICE_INSTANCE_CDSP1_V02 = 0x1A, /**<  CDSP1  */
  SSCTL_QMI_SERVICE_INSTANCE_GPDSP_V02 = 0x1B, /**<  GPDSP  */
  SSCTL_QMI_SERVICE_INSTANCE_GPDSP1_V02 = 0x1C, /**<  GPDSP1  */
...
typedef enum {
  ...
  SSCTL_DS_EVENT_BEFORE_ENTRY_V02 = 4, /**<  Before deep sleep entry  */
  SSCTL_DS_EVENT_AFTER_ENTRY_V02 = 5, /**<  After deep sleep entry  */
  SSCTL_DS_EVENT_BEFORE_EXIT_V02 = 6, /**<  Before deep sleep exit  */
  SSCTL_DS_EVENT_AFTER_EXIT_V02 = 7, /**<  After deep sleep exit  */
...
typedef enum {
  ...
  SSCTL_DS_EVENT_FORCED_V02 = 2, /**<  Deep sleep event is forced  */
  SSCTL_DS_EVENT_GRACEFUL_V02 = 3, /**<  Deep sleep event is graceful  */
...
/** @addtogroup ssctl_qmi_messages
    @{
  */
/** Request Message; Sends notification for deep sleep entry. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup ssctl_qmi_messages
    @{
  */
/** Response Message; Sends notification for deep sleep entry. */
typedef struct {
...
typedef struct {
  ...
  /**<   Event. Values: \n
      ...
      - SSCTL_DS_EVENT_BEFORE_ENTRY (4) --  Before deep sleep entry
      - SSCTL_DS_EVENT_AFTER_ENTRY (5) --  After deep sleep entry
      - SSCTL_DS_EVENT_BEFORE_EXIT (6) --  Before deep sleep exit
      - SSCTL_DS_EVENT_AFTER_EXIT (7) --  After deep sleep exit
 */
  ...
  /**<   How the event is driven. Values: \n
      ...
      - SSCTL_DS_EVENT_FORCED (2) --  Deep sleep event is forced
      - SSCTL_DS_EVENT_GRACEFUL (3) --  Deep sleep event is graceful
 */
