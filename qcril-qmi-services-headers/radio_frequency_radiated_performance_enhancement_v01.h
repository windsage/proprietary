...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.0/rfrpe/api/radio_frequency_radiated_performance_enhancement_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Thu Jun 25 2020 (Spin 0)
...
#define RFRPE_V01_IDL_MINOR_VERS 0x03
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define RFRPE_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define RFRPE_V01_MAX_MESSAGE_ID 0x0023
/**
    @}
  */
...
#define RFRPE_ASM_DEVICES_MAX_V01 5
/**
    @}
  */
...
/** @addtogroup rfrpe_qmi_messages
    @{
  */
/** Request Message; Queries the set of scenarios that are active in the modem. */
typedef struct {
...
/** @addtogroup rfrpe_qmi_messages
    @{
  */
/** Request Message; Queries the revision number of the characterization tables. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup rfrpe_qmi_messages
    @{
  */
/** Request Message; Set the external ASM devices to given port settings. */
typedef struct {

  /* Mandatory */
  uint32_t asm_instance_len;  /**< Must be set to # of elements in asm_instance */
  uint8_t asm_instance[RFRPE_ASM_DEVICES_MAX_V01];

  /* Mandatory */
  uint32_t port_len;  /**< Must be set to # of elements in port */
  uint8_t port[RFRPE_ASM_DEVICES_MAX_V01];
}rfrpe_set_port_req_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup rfrpe_qmi_messages
    @{
  */
/** Response Message; Set the external ASM devices to given port settings. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
   */
}rfrpe_set_port_resp_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup rfrpe_qmi_messages
    @{
  */
/** Indication Message; Indication with the set port result.  */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
   */
}rfrpe_set_port_ind_msg_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */
//#define REMOVE_QMI_RFRPE_GET_PROVISIONED_TABLE_REVISION_V01
//#define REMOVE_QMI_RFRPE_GET_RFM_SCENARIO_V01
//#define REMOVE_QMI_RFRPE_GET_SUPPORTED_FIELDS_V01
//#define REMOVE_QMI_RFRPE_GET_SUPPORTED_MSGS_V01
//#define REMOVE_QMI_RFRPE_SET_PORT_V01
//#define REMOVE_QMI_RFRPE_SET_PORT_IND_V01
//#define REMOVE_QMI_RFRPE_SET_RFM_SCENARIO_V01
...
#define QMI_RFRPE_SET_PORT_REQ_V01 0x0023
#define QMI_RFRPE_SET_PORT_RESP_V01 0x0023
#define QMI_RFRPE_SET_PORT_IND_V01 0x0023
/**
    @}
  */
