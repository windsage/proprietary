...
class MultipartGsmCmasCellbroadcast {
   ...
   public:
    ...
    /*
     * Generic method to process and reset the multipart_gsm_cmas_cellbroadcast
     */
    void process_reset_multipart_gsm_cmas_cellbroadcast(CallbackType &callback);

    /*
     * Member feild to track current serial number
     */
    uint current_msg_serial;
