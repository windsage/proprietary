...
-------------------------------------------------------------------------------*/
typedef enum { QCRIL_UIM_GID1, QCRIL_UIM_GID2 } qcril_uim_gid_type;
...
typedef struct {
  qcril_uim_prov_session_state_type
      session_state_gw_indexes[QCRIL_UIM_MAX_SESSION_PRIORITY_TYPES];
  qcril_uim_prov_session_state_type
      session_state_1x_indexes[QCRIL_UIM_MAX_SESSION_PRIORITY_TYPES];
...
typedef struct {
  ...
  qcril_uim_select_response_info_type
      select_response_info[QCRIL_UIM_MAX_SELECT_RESP_COUNT];
...
*/
/*=========================================================================*/
void qcril_uim_reset_state(void);
...
*/
/*=========================================================================*/
int qcril_uim_init_state(bool *uim_ready_state);
...
*/
/*=========================================================================*/
void qmi_uim_card_init_callback(qmi_uim_rsp_data_type *rsp_data_ptr);
...
*/
/*=========================================================================*/
int qcril_uim_send_qmi_sync_msg(uint32_t msg_id, const void *params,
...
int qcril_uim_send_qmi_async_msg(qcril_uim_request_type request_type,
                                 void *param_data_ptr,
                                 std::shared_ptr<Message> req_ptr);
...
*/
/*=========================================================================*/
void qmi_uim_async_cb(qmi_uim_rsp_data_type *rsp_data, void *user_data);
...
===========================================================================*/
boolean qcril_uim_lpa_user_request(std::shared_ptr<UimLpaReqMessage> req_ptr);
...
void qcril_uim_get_sim_type_resp(
    qcril_uim_callback_params_type *rsp_data_ptr,
    std::shared_ptr<UimGetSimTypeRequestMsg> req_ptr);

void qcril_uim_set_sim_type_resp(
    qcril_uim_callback_params_type *rsp_data_ptr,
    std::shared_ptr<UimSetSimTypeRequestMsg> req_ptr);
#endif /* QCRIL_UIM_H */
