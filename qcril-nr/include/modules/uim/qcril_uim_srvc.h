...
typedef enum
{
  ...
  QMI_UIM_SRVC_USER_CONSENT_IND_MSG
...
typedef enum
{
  ...
  QMI_UIM_SRVC_GET_SIM_TYPE_RSP_MSG,
  QMI_UIM_SRVC_SET_SIM_TYPE_RSP_MSG
} qmi_uim_rsp_id_type;
...
/* -----------------------------------------------------------------------------
   ENUM:    QMI_UIM_USER_CONSENT_TYPE
   DESCRIPTION:
     Profile type
-------------------------------------------------------------------------------*/
typedef enum
{
  QMI_UIM_NO_CONFIRMATION_REQD = 0x00,
  QMI_UIM_SIMPLE_CONFIRMATION_REQD = 0x01,
  QMI_UIM_STRONG_CONFIRMATION_REQD = 0x02
} qmi_uim_user_consent_type;

/* -----------------------------------------------------------------------------
   ENUM:    QMI_UIM_MEP_MODE
   DESCRIPTION:
     Describes the MEP_Mode
-------------------------------------------------------------------------------*/

typedef enum {
  QMI_UIM_MEP_MODE_UNKNOWN = 0x00,
  QMI_UIM_MEP_MODE_A1 = 0x01,
  QMI_UIM_MEP_MODE_A2 = 0x02,
  QMI_UIM_MEP_MODE_B = 0x03
} qmi_uim_mep_mode;

/* -----------------------------------------------------------------------------
   ENUM:    QMI_UIM_EUICC_PORT_STATE
   DESCRIPTION:
     Port_State Active or Not
-------------------------------------------------------------------------------*/

typedef enum {
  QMI_UIM_PORT_STATE_INACTIVE = 0x00,
  QMI_UIM_PORT_STATE_ACTIVE = 0x01
} qmi_uim_euicc_port_state;

/* -----------------------------------------------------------------------------
   ENUM:    QMI_UIM_CARD_PROTOCOL
   DESCRIPTION:
     Card_protocol
-------------------------------------------------------------------------------*/
typedef enum {
  QMI_UIM_PROTOCOL_UNKNOWN = 0x00,
  QMI_UIM_PROTOCOL_ICC = 0x01,
  QMI_UIM_PROTOCOL_UICC = 0x02
} qmi_uim_card_protocol_type;

/* -----------------------------------------------------------------------------
   ENUM:    QMI_UIM_PORT_ID
   DESCRIPTION:
     Card_protocol
-------------------------------------------------------------------------------*/

typedef enum {
  QMI_UIM_PORT_ID_0 = 0x00,
  QMI_UIM_PORT_ID_1 = 0x01,
  QMI_UIM_PORT_ID_2 = 0x02,
  QMI_UIM_PORT_ID_3 = 0x03
} qmi_uim_port_id_type;

/* -----------------------------------------------------------------------------
   ENUM:    QMI_UIM_UNLOCK_STATUS
   DESCRIPTION:
     Card_protocol
-------------------------------------------------------------------------------*/

typedef enum {
  QMI_UIM_UNLOCK_STATUS_UNKNOWN_V01            = 0x00, /**<  Unlock status unknown \n  */
  QMI_UIM_UNLOCK_STATUS_TEMPORARY_UNLOCKED_V01 = 0x01, /**<  Unlock status temporary unlocked \n  */
  QMI_UIM_UNLOCK_STATUS_PERMANENT_UNLOCKED_V01 = 0x02  /** < Unlock status permanent unlocked*/
} qmi_uim_unlock_status_type;
/*---------------------------------------------------------------------------
  COMMON STRUCTURES
---------------------------------------------------------------------------*/
/* -----------------------------------------------------------------------------
...
/* -----------------------------------------------------------------------------
   STRUCTURE:    qmi_uim_mep_info_type

   DESCRIPTION:   Structure to have MEP related information
-------------------------------------------------------------------------------*/
typedef struct {
  bool is_mep;
  uint8_t port_id;
  qmi_uim_mep_mode negotiated_mep_mode;
} qmi_uim_mep_info_type;
...
typedef struct
{
  ...
  struct
  {
    ...
    struct
    {
      ...
      qmi_uim_unlock_status_type          unlock_status_type;
    ...
    uint8_t card_mep_info_len;
    qmi_uim_mep_info_type card_mep_info;
...
typedef struct
{
  ...
  qmi_uim_port_id_type port_id[QMI_UIM_MAX_CARD_COUNT];
...
typedef enum
{
    QMI_UIM_SIM_TYPE_PHYSICAL = 1,
    QMI_UIM_SIM_TYPE_IUICC = 2,
    QMI_UIM_SIM_TYPE_EUICC = 3
}qmi_uim_sim_type;

typedef enum
{
    QMI_UIM_SUPPORTED_SIM_TYPE_PHYSICAL = 0,
    QMI_UIM_SUPPORTED_SIM_TYPE_IUICC = 1,
    QMI_UIM_SUPPORTED_SIM_TYPE_PHYSICAL_IUICC = 2,
    QMI_UIM_SUPPORTED_SIM_TYPE_EMBEDDED = 3,
    QMI_UIM_SUPPORTED_SIM_TYPE_PHYSICAL_EMBEDDED = 4,
    QMI_UIM_SUPPORTED_SIM_TYPE_INTEGRATED_EMBEDDED = 5,
    QMI_UIM_SUPPORTED_SIM_TYPE_PHYSICAL_INTEGRATED_EMBEDDED = 6
}qmi_uim_supported_sim_type;

typedef struct  {
    uint32_t sim_type_len;
    qmi_uim_sim_type sim_type[QMI_UIM_MAX_CARD_COUNT];
    uint32_t supported_sim_type_len;
    qmi_uim_supported_sim_type supported_sim_type[QMI_UIM_MAX_CARD_COUNT];
} qmi_uim_get_sim_type_resp;


typedef struct {
   uint32_t sim_type_len;
   qmi_uim_sim_type sim_type[QMI_UIM_MAX_CARD_COUNT];
} qmi_uim_set_sim_type_req;
...
typedef struct
{
  ...
  char                                    * profile_name;
  qmi_uim_bool_type                         user_consent_type_valid;
  qmi_uim_user_consent_type                 user_consent_type;
...
/* -----------------------------------------------------------------------------
   STRUCTURE:    QMI_UIM_EUICC_PORT_INFO_TYPE
   DESCRIPTION:   Structure used for euicc port information
-------------------------------------------------------------------------------*/

typedef struct {
  qmi_uim_euicc_port_state port_state;
  qmi_uim_card_protocol_type card_protocol;
  uint8_t num_app;
  qmi_uim_slot_type logical_slot;
  uint32_t iccid_len;
  uint8_t iccid[QMI_UIM_MAX_ICCID_LEN];
} qmi_uim_port_status_type;

/* -----------------------------------------------------------------------------
   STRUCTURE:    QMI_UIM_EUICC_PORT_INFO_TYPE
   DESCRIPTION:   Structure used for MEP euicc port information
-------------------------------------------------------------------------------*/
...
typedef struct {
  ...
  uint32_t uim_port_status_len;
  qmi_uim_port_status_type uim_port_status[QMI_UIM_MAX_PORT];
} qmi_uim_port_info_type;
...
{
  qmi_uim_slot_type         slot;
  qmi_uim_user_consent_type user_consent;
} qmi_uim_user_consent_ind_type;

/* -----------------------------------------------------------------------------
   STRUCTURE:    QMI_UIM_USER_CONSENT_TYPE
   DESCRIPTION:   Structure used for user_consent indication
-------------------------------------------------------------------------------*/
typedef struct
{
  uint32_t                    no_of_slots;
  qmi_uim_slot_status_type    slot_status[QMI_UIM_MAX_SLOT_COUNT];
  uint32_t port_information_len;
  qmi_uim_port_info_type port_information[QMI_UIM_MAX_SLOT_COUNT];
...
typedef union
{
  ...
  qmi_uim_user_consent_ind_type       user_consent_ind;
...
typedef struct
{
  ...
  union
  {
    ...
    qmi_uim_get_sim_type_resp               sim_type_resp;
    qmi_uim_change_provision_resp           change_provision_resp;
  }                                         rsp_data;
