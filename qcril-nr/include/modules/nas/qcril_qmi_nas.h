...
/*=========================================================================
  FUNCTION:  qcril_qmi_nas_get_usage_setting

===========================================================================*/
void qcril_qmi_nas_get_usage_setting
(
  std::shared_ptr<RilRequestGetUsageSettingMessage> msg
);


/*=========================================================================
  FUNCTION:  qcril_qmi_nas_set_usage_setting

===========================================================================*/
void qcril_qmi_nas_set_usage_setting
(
  std::shared_ptr<RilRequestSetUsageSettingMessage> msg
);
...
(
  std::shared_ptr<RilRequestSetVonrCapRequest> msg
);

RIL_Errno qcril_qmi_nas_get_vonr_cap_request
(
  std::shared_ptr<RilRequestGetVonrCapRequest> msg
);
...
/*=========================================================================
  FUNCTION:  qmi_ril_update_cached_nr5g_disable_mode
  Update the NAS cache with the provided nrg5_disable_mode
  This function will lock and unlock the NAS cache.
===========================================================================*/
void qcril_qmi_nas_update_cached_nr5g_disable_mode(const uint8_t valid,
  const nas_nr5g_disable_mode_enum_type_v01 disable_mode);
...
bool qcril_qmi_nas_get_sdrm_status();
...
uint32_t qmi_ril_nw_reg_get_roam_status_overview(void);
void qcril_qmi_dms_get_band_capab(std::shared_ptr<RilRequestGetBandCapabilityMessage> msg);
