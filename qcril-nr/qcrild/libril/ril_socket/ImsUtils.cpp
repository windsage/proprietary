...
qcril::interfaces::EctType convertEctType(const RIL_EctType& in)
{
  switch (in) {
    case RIL_ECT_TYPE_BLIND_TRANSFER:
      return qcril::interfaces::EctType::BLIND_TRANSFER;
    case RIL_ECT_TYPE_ASSURED_TRANSFER:
      return qcril::interfaces::EctType::ASSURED_TRANSFER;
    case RIL_ECT_TYPE_CONSULTATIVE_TRANSFER:
      return qcril::interfaces::EctType::CONSULTATIVE_TRANSFER;
    case RIL_ECT_TYPE_UNKNOWN:
    default:
      return qcril::interfaces::EctType::UNKNOWN;
  }
}
...
qcril::interfaces::ConfigItem convertConfigItem(const RIL_IMS_ConfigItem in) {
  switch(in) {
    ...
    case RIL_IMS_CONFIG_ITEM_DATA_CHANNEL_SETTING:
      return qcril::interfaces::ConfigItem::IMS_DATA_CHANNEL_SETTING;
    case RIL_IMS_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_HOME:
      return qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_HOME;
    case RIL_IMS_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_ROAMING:
      return qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_ROAMING;
