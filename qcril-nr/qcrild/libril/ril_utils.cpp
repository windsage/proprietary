...
void convertToSocket(RIL_CallType& out, const qcril::interfaces::CallType& in) {
  switch (in) {
    case qcril::interfaces::CallType::UNKNOWN:
      out = RIL_CALL_TYPE_UNKNOWN;
      break;
    case qcril::interfaces::CallType::VOICE:
      out = RIL_CALL_TYPE_VOICE;
      break;
    case qcril::interfaces::CallType::VT_TX:
      out = RIL_CALL_TYPE_VT_TX;
      break;
    case qcril::interfaces::CallType::VT_RX:
      out = RIL_CALL_TYPE_VT_RX;
      break;
    case qcril::interfaces::CallType::VT:
      out = RIL_CALL_TYPE_VT;
      break;
    case qcril::interfaces::CallType::VT_NODIR:
      out = RIL_CALL_TYPE_VT_NODIR;
      break;
    case qcril::interfaces::CallType::SMS:
      out = RIL_CALL_TYPE_SMS;
      break;
    case qcril::interfaces::CallType::UT:
      out = RIL_CALL_TYPE_UT;
      break;
    case qcril::interfaces::CallType::USSD:
      out = RIL_CALL_TYPE_USSD;
      break;
    case qcril::interfaces::CallType::CALLCOMPOSER:
      out = RIL_CALL_TYPE_CALLCOMPOSER;
      break;
    case qcril::interfaces::CallType::DC:
      out = RIL_CALL_TYPE_DC;
      break;
  }
}
...
template <>
void convertToSocket(RIL_CallState& out, const qcril::interfaces::CallState& in) {
  switch (in) {
    case qcril::interfaces::CallState::ACTIVE:
      out = RIL_CALL_ACTIVE;
      break;
    case qcril::interfaces::CallState::HOLDING:
      out = RIL_CALL_HOLDING;
      break;
    case qcril::interfaces::CallState::DIALING:
      out = RIL_CALL_DIALING;
      break;
    case qcril::interfaces::CallState::ALERTING:
      out = RIL_CALL_ALERTING;
      break;
    case qcril::interfaces::CallState::INCOMING:
      out = RIL_CALL_INCOMING;
      break;
    case qcril::interfaces::CallState::WAITING:
      out = RIL_CALL_WAITING;
      break;
    case qcril::interfaces::CallState::END:
    case qcril::interfaces::CallState::UNKNOWN:
      out = RIL_CALL_END;
...
void convertToSocket(RIL_CallDomain& out, const qcril::interfaces::CallDomain& in) {
  switch (in) {
    case qcril::interfaces::CallDomain::CS:
      out = RIL_CALLDOMAIN_CS;
      break;
    case qcril::interfaces::CallDomain::PS:
      out = RIL_CALLDOMAIN_PS;
      break;
    case qcril::interfaces::CallDomain::AUTOMATIC:
      out = RIL_CALLDOMAIN_AUTOMATIC;
      break;
    case qcril::interfaces::CallDomain::UNKNOWN:
    case qcril::interfaces::CallDomain::NOT_SET:
    default:
      out = RIL_CALLDOMAIN_UNKNOWN;
      break;
  }
}
...
template <>
void convertToSocket(RIL_CallModifiedCause& out,
                     const qcril::interfaces::CallModifiedCause& in) {
  switch (in) {
    case qcril::interfaces::CallModifiedCause::NONE:
      out = RIL_CMODCAUSE_NONE;
      break;
    case qcril::interfaces::CallModifiedCause::UPGRADE_DUE_TO_LOCAL_REQ:
      out = RIL_CMODCAUSE_UPGRADE_DUE_TO_LOCAL_REQ;
      break;
    case qcril::interfaces::CallModifiedCause::UPGRADE_DUE_TO_REMOTE_REQ:
      out = RIL_CMODCAUSE_UPGRADE_DUE_TO_REMOTE_REQ;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_LOCAL_REQ:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_LOCAL_REQ;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_REMOTE_REQ:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_REMOTE_REQ;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_RTP_TIMEOUT:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_RTP_TIMEOUT;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_QOS:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_QOS;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_PACKET_LOSS:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_PACKET_LOSS;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_LOW_THRPUT:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_LOW_THRPUT;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_THERM_MITIGATION:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_THERM_MITIGATION;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_LIPSYNC:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_LIPSYNC;
      break;
    case qcril::interfaces::CallModifiedCause::DOWNGRADE_DUE_TO_GENERIC_ERROR:
      out = RIL_CMODCAUSE_DOWNGRADE_DUE_TO_GENERIC_ERROR;
      break;
  }
}
...
void convertToSocket(RIL_IMS_CallFailCause& out, const qcril::interfaces::CallFailCause& in) {
  switch (in) {
    ...
    case qcril::interfaces::CallFailCause::EPSFB_FAILURE:
      out = RIL_IMS_FAILCAUSE_EPSFB_FAILURE;
      break;
    case qcril::interfaces::CallFailCause::TWAIT_EXPIRED:
      out = RIL_IMS_FAILCAUSE_TWAIT_EXPIRED;
      break;
    case qcril::interfaces::CallFailCause::TCP_CONNECTION_REQ:
      out = RIL_IMS_FAILCAUSE_TCP_CONNECTION_REQ;
      break;
...
template <>
void convertToSocket(RIL_CallFailCauseResponse& out,
                     const qcril::interfaces::CallFailCauseResponse& in) {
  convertToSocket(out.failCause, in.getFailCauseRef());
  convertToSocket(out.extendedFailCause, in.getExtendedFailCauseRef());
  convertToSocket(out.networkErrorString, in.getNetworkErrorStringRef());
...
template <>
void convertToSocket(RIL_VerificationStatus& out,
                     qcril::interfaces::VerificationStatus const& in) {
  switch (in) {
    case qcril::interfaces::VerificationStatus::UNKNOWN:
      out = RIL_VERSTAT_UNKNOWN;
      break;
    case qcril::interfaces::VerificationStatus::NONE:
      out = RIL_VERSTAT_NONE;
      break;
    case qcril::interfaces::VerificationStatus::PASS:
      out = RIL_VERSTAT_PASS;
      break;
    case qcril::interfaces::VerificationStatus::FAIL:
      out = RIL_VERSTAT_FAIL;
      break;
  }
}
...
template <>
void convertToSocket(RIL_VerstatInfo& out, const qcril::interfaces::VerstatInfo& in) {
  convertToSocket(out.canMarkUnwantedCall, in.getCanMarkUnwantedCallRef());
  convertToSocket(out.verificationStatus, in.getVerificationStatusRef());
}
...
template <>
void convertToSocket(RIL_CallProgressInfoType& out,
                     const qcril::interfaces::CallProgressInfoType& in) {
  switch (in) {
    case qcril::interfaces::CallProgressInfoType::UNKNOWN:
      out = RIL_CALL_PROGRESS_INFO_UNKNOWN;
      break;
    case qcril::interfaces::CallProgressInfoType::CALL_REJ_Q850:
      out = RIL_CALL_PROGRESS_INFO_CALL_REJ_Q850;
      break;
    case qcril::interfaces::CallProgressInfoType::CALL_WAITING:
      out = RIL_CALL_PROGRESS_INFO_CALL_WAITING;
      break;
    case qcril::interfaces::CallProgressInfoType::CALL_FORWARDING:
      out = RIL_CALL_PROGRESS_INFO_CALL_FORWARDING;
      break;
    case qcril::interfaces::CallProgressInfoType::REMOTE_AVAILABLE:
      out = RIL_CALL_PROGRESS_INFO_REMOTE_AVAILABLE;
      break;
  }
}
...
template <>
void convertToSocket(RIL_CallProgressInfo& out, const qcril::interfaces::CallProgressInfo& in) {
  out.type = RIL_CALL_PROGRESS_INFO_UNKNOWN;
  if (in.hasType()) {
    convertToSocket(out.type, in.getType());
  }
  out.reasonCode = INT16_MAX;
...
template <>
void convertToSocket(RIL_MsimAdditionalInfoCode& out,
                     const qcril::interfaces::MsimAdditionalInfoCode& in) {
  switch (in) {
    case qcril::interfaces::MsimAdditionalInfoCode::CONCURRENT_CALL_NOT_POSSIBLE:
      out = RIL_MSIM_ADDITIONAL_INFO_CONCURRENT_CALL_NOT_POSSIBLE;
      break;
    case qcril::interfaces::MsimAdditionalInfoCode::NONE:
    default:
      out = RIL_MSIM_ADDITIONAL_INFO_NONE;
      break;
  }
}
...
template <>
void convertToSocket(RIL_MsimAdditionalCallInfo& out,
                     const qcril::interfaces::MsimAdditionalCallInfo& in) {
  out.additionalCode = RIL_MSIM_ADDITIONAL_INFO_NONE;
  if (in.hasAdditionalCode()) {
    convertToSocket(out.additionalCode, in.getAdditionalCode());
  }
}
...
template <>
void convertToSocket(RIL_TirMode& out, const qcril::interfaces::TirMode& in) {
  switch (in) {
    case qcril::interfaces::TirMode::UNKNOWN:
      out = RIL_TIRMODE_UNKNOWN;
      break;
    case qcril::interfaces::TirMode::TEMPORARY:
      out = RIL_TIRMODE_TEMPORARY;
      break;
    case qcril::interfaces::TirMode::PERMANENT:
      out = RIL_TIRMODE_PERMANENT;
      break;
  }
}
...
void convertToSocket(RIL_CallModifyFailCause& out,
  ...
  switch (in) {
    case qcril::interfaces::CallModifyFailCause::UNKNOWN:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_UNKNOWN;
      break;
    case qcril::interfaces::CallModifyFailCause::SUCCESS:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_SUCCESS;
      break;
    case qcril::interfaces::CallModifyFailCause::RADIO_NOT_AVAILABLE:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_RADIO_NOT_AVAILABLE;
      break;
    case qcril::interfaces::CallModifyFailCause::GENERIC_FAILURE:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_GENERIC_FAILURE;
      break;
    case qcril::interfaces::CallModifyFailCause::REQUEST_NOT_SUPPORTED:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_REQUEST_NOT_SUPPORTED;
      break;
    case qcril::interfaces::CallModifyFailCause::CANCELLED:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_CANCELLED;
      break;
    case qcril::interfaces::CallModifyFailCause::UNUSED:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_UNUSED;
      break;
    case qcril::interfaces::CallModifyFailCause::INVALID_PARAMETER:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_INVALID_PARAMETER;
      break;
    case qcril::interfaces::CallModifyFailCause::REJECTED_BY_REMOTE:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_REJECTED_BY_REMOTE;
      break;
    case qcril::interfaces::CallModifyFailCause::IMS_DEREGISTERED:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_IMS_DEREGISTERED;
      break;
    case qcril::interfaces::CallModifyFailCause::NETWORK_NOT_SUPPORTED:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_NETWORK_NOT_SUPPORTED;
      break;
    case qcril::interfaces::CallModifyFailCause::HOLD_RESUME_FAILED:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_HOLD_RESUME_FAILED;
      break;
    case qcril::interfaces::CallModifyFailCause::HOLD_RESUME_CANCELED:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_HOLD_RESUME_CANCELED;
      break;
    case qcril::interfaces::CallModifyFailCause::REINVITE_COLLISION:
      out = RIL_CALL_MODIFY_FAIL_CAUSE_REINVITE_COLLISION;
      break;
  }
}
...
template <>
void convertToSocket(RIL_Codec& out, const qcril::interfaces::AudioCodec& in) {
  switch (in) {
    case qcril::interfaces::AudioCodec::QCELP13K:
      out = RIL_CODEC_QCELP13K;
      break;
    case qcril::interfaces::AudioCodec::EVRC:
      out = RIL_CODEC_EVRC;
      break;
    case qcril::interfaces::AudioCodec::EVRC_B:
      out = RIL_CODEC_EVRC_B;
      break;
    case qcril::interfaces::AudioCodec::EVRC_WB:
      out = RIL_CODEC_EVRC_WB;
      break;
    case qcril::interfaces::AudioCodec::EVRC_NW:
      out = RIL_CODEC_EVRC_NW;
      break;
    case qcril::interfaces::AudioCodec::AMR_NB:
      out = RIL_CODEC_AMR_NB;
      break;
    case qcril::interfaces::AudioCodec::AMR_WB:
      out = RIL_CODEC_AMR_WB;
      break;
    case qcril::interfaces::AudioCodec::GSM_EFR:
      out = RIL_CODEC_GSM_EFR;
      break;
    case qcril::interfaces::AudioCodec::GSM_FR:
      out = RIL_CODEC_GSM_FR;
      break;
    case qcril::interfaces::AudioCodec::GSM_HR:
      out = RIL_CODEC_GSM_HR;
      break;
    case qcril::interfaces::AudioCodec::G711U:
      out = RIL_CODEC_G711U;
      break;
    ...
    case qcril::interfaces::AudioCodec::G722:
      ...
      break;
    case qcril::interfaces::AudioCodec::G711AB:
      out = RIL_CODEC_G711AB;
      break;
    case qcril::interfaces::AudioCodec::G729:
      out = RIL_CODEC_G729;
      break;
    case qcril::interfaces::AudioCodec::EVS_NB:
      out = RIL_CODEC_EVS_NB;
      break;
    case qcril::interfaces::AudioCodec::EVS_WB:
      out = RIL_CODEC_EVS_WB;
      break;
    case qcril::interfaces::AudioCodec::EVS_SWB:
      out = RIL_CODEC_EVS_SWB;
      break;
    case qcril::interfaces::AudioCodec::EVS_FB:
      out = RIL_CODEC_EVS_FB;
      break;
    case qcril::interfaces::AudioCodec::NONE:
    default:
      out = RIL_CODEC_NONE;
...
template <>
void convertToSocket(RIL_ComputedAudioQuality& out,
                     const qcril::interfaces::ComputedAudioQuality& in) {
  switch (in) {
    case qcril::interfaces::ComputedAudioQuality::NO_HD:
      out = RIL_COMPUTED_AUDIO_QUALITY_NO_HD;
      break;
    case qcril::interfaces::ComputedAudioQuality::HD:
      out = RIL_COMPUTED_AUDIO_QUALITY_HD;
      break;
    case qcril::interfaces::ComputedAudioQuality::HD_PLUS:
      out = RIL_COMPUTED_AUDIO_QUALITY_HD_PLUS;
      break;
    case qcril::interfaces::ComputedAudioQuality::NONE:
    default:
      out = RIL_COMPUTED_AUDIO_QUALITY_NONE;
      break;
  }
}
...
void convertToSocket(RIL_IMS_CallInfo& out, const qcril::interfaces::CallInfo& in) {
  ...
  convertToSocket(out.modemCallId, in.getModemCallIdRef());
}
...
template <>
void convertToSocket(RIL_CallFwdTimerInfo& out, const qcril::interfaces::CallFwdTimerInfo& in) {
  if (in.hasYear()) {
    out.year = in.getYear();
  }
  if (in.hasMonth()) {
...
void convertToSocket(RIL_CallForwardParams& out, const qcril::interfaces::CallForwardInfo& in) {
  ...
  if (inCftStart) {
    convertToSocket(out.callFwdTimerStart, *inCftStart);
#if 0
    out.callFwdTimerStart = new RIL_CallFwdTimerInfo{};
    if (out.callFwdTimerStart) {
      convertToSocket(*out.callFwdTimerStart, *inCftStart);
    }
#endif
  }
  ...
  if (inCftStop) {
      convertToSocket(out.callFwdTimerEnd, *inCftStop);
#if 0
    out.callFwdTimerEnd = new RIL_CallFwdTimerInfo{};
    if (out.callFwdTimerEnd) {
      convertToSocket(*out.callFwdTimerEnd, *inCftStop);
    }
#endif
  }
...
template <>
void convertToSocket(RIL_SetCallForwardStatus& out,
                     const qcril::interfaces::SetCallForwardStatus& in) {
  if (in.hasReason()) {
    out.reason = in.getReason();
  }
...
template <>
void convertToSocket(RIL_SetCallForwardStatusInfo& out,
                     const qcril::interfaces::SetCallForwardRespData& in) {
  const auto inCfStatusList = in.getSetCallForwardStatusRef();
  if (inCfStatusList.size()) {
    convertToSocket(out.setCallForwardStatus, out.setCallForwardStatusLen, inCfStatusList);
...
void convertToSocket(RIL_IMS_ConfigItem& out, const qcril::interfaces::ConfigItem& in) {
  switch (in) {
    ...
    case qcril::interfaces::ConfigItem::IMS_DATA_CHANNEL_SETTING:
      out = RIL_IMS_CONFIG_ITEM_DATA_CHANNEL_SETTING;
      break;
    case qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_HOME:
      out = RIL_IMS_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_HOME;
      break;
    case qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_ROAMING:
      out = RIL_IMS_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_ROAMING;
      break;
...
template <>
void convertToSocket(RIL_ClipStatus& out, const qcril::interfaces::ClipStatus& in)
{
  switch (in) {
    case qcril::interfaces::ClipStatus::NOT_PROVISIONED:
      out = RIL_CLIP_UNPROVISIONED;
      break;
    case qcril::interfaces::ClipStatus::PROVISIONED:
      out = RIL_CLIP_PROVISIONED;
      break;
    case qcril::interfaces::ClipStatus::STATUS_UNKNOWN:
    case qcril::interfaces::ClipStatus::UNKNOWN:
    default:
      out = RIL_CLIP_UNKNOWN;
      break;
  }
}
...
void convertToSocket(RIL_ConfParticipantOperation& out,
  ...
  switch (in) {
    case qcril::interfaces::ConfParticipantOperation::ADD:
      out = RIL_CONF_PARTICIPANT_OP_ADD;
      break;
    case qcril::interfaces::ConfParticipantOperation::REMOVE:
      out = RIL_CONF_PARTICIPANT_OP_REMOVE;
      break;
    case qcril::interfaces::ConfParticipantOperation::UNKNOWN:
    default:
      out = RIL_CONF_PARTICIPANT_OP_UNKNOWN;
      break;
  }
}
...
void convertToSocket(RIL_VoiceInfoType& out, const qcril::interfaces::VoiceInfo& in) {
  switch (in) {
    case qcril::interfaces::VoiceInfo::SILENT:
      out = RIL_VOICE_INFO_SILENT;
      break;
    case qcril::interfaces::VoiceInfo::SPEECH:
      out = RIL_VOICE_INFO_SPEECH;
      break;
    case qcril::interfaces::VoiceInfo::UNKNOWN:
    default:
      out = RIL_VOICE_INFO_SILENT;
...
template <>
void convertToSocket(RIL_ServiceClassStatus& out,
                     const qcril::interfaces::ServiceClassStatus& in) {
  switch (in) {
    case qcril::interfaces::ServiceClassStatus::DISABLED:
      out = RIL_SERVICE_CLASS_STATUS_DISABLED;
      break;
    case qcril::interfaces::ServiceClassStatus::ENABLED:
      out = RIL_SERVICE_CLASS_STATUS_ENABLED;
      break;
    case qcril::interfaces::ServiceClassStatus::UNKNOWN:
    default:
      out = RIL_SERVICE_CLASS_STATUS_DISABLED;
...
template <>
void convertToSocket(RIL_ServiceClassProvisionStatus& out,
                     const qcril::interfaces::ServiceClassProvisionStatus& in) {
  switch (in) {
    case qcril::interfaces::ServiceClassProvisionStatus::NOT_PROVISIONED:
      out = RIL_SERVICE_CLASS_PROVISION_STATUS_NOT_PROVISIONED;
      break;
    case qcril::interfaces::ServiceClassProvisionStatus::PROVISIONED:
      out = RIL_SERVICE_CLASS_PROVISION_STATUS_PROVISIONED;
      break;
    case qcril::interfaces::ServiceClassProvisionStatus::UNKNOWN:
    default:
      out = RIL_SERVICE_CLASS_PROVISION_STATUS_NOT_PROVISIONED;
...
void convertToSocket(RIL_IMS_SubConfigInfo& out, const qcril::interfaces::ImsSubConfigInfo& in) {
  ...
  size_t outlen = 0;
  convertToSocket(out.imsStackEnabled, outlen, in.getImsStackEnabled());
  out.imsStackEnabledLen = static_cast<uint32_t>(outlen);
}
...
void convertToSocket(RIL_IMS_SuppSvcResponse& out,
  ...
  if (in.hasIsPasswordRequired()) {
    out.isPasswordRequired = in.getIsPasswordRequired();
  }
}

template <>
void convertToSocket(RIL_FacilityType& out, const qcril::interfaces::FacilityType& in) {
  switch (in) {
    case qcril::interfaces::FacilityType::CLIP:
      out = RIL_FACILITY_CLIP;
      break;
    case qcril::interfaces::FacilityType::COLP:
      out = RIL_FACILITY_COLP;
      break;
    case qcril::interfaces::FacilityType::BAOC:
      out = RIL_FACILITY_BAOC;
      break;
    case qcril::interfaces::FacilityType::BAOIC:
      out = RIL_FACILITY_BAOIC;
      break;
    case qcril::interfaces::FacilityType::BAOICxH:
      out = RIL_FACILITY_BAOICxH;
      break;
    case qcril::interfaces::FacilityType::BAIC:
      out = RIL_FACILITY_BAIC;
      break;
    case qcril::interfaces::FacilityType::BAICr:
      out = RIL_FACILITY_BAICr;
      break;
    case qcril::interfaces::FacilityType::BA_ALL:
      out = RIL_FACILITY_BA_ALL;
      break;
    case qcril::interfaces::FacilityType::BA_MO:
      out = RIL_FACILITY_BA_MO;
      break;
    case qcril::interfaces::FacilityType::BA_MT:
      out = RIL_FACILITY_BA_MT;
      break;
    case qcril::interfaces::FacilityType::BS_MT:
      out = RIL_FACILITY_BS_MT;
      break;
    case qcril::interfaces::FacilityType::BAICa:
      out = RIL_FACILITY_BAICa;
      break;
    case qcril::interfaces::FacilityType::UNKNOWN:
    default:
      out = RIL_FACILITY_CLIP;
...
template <>
void convertToSocket(RIL_CallBarringNumbersInfo& out,
                     const qcril::interfaces::CallBarringNumbersInfo& in)
{
  if (in.hasStatus()) {
    convertToSocket(out.status, in.getStatus());
...
template <>
void convertToSocket(RIL_CallBarringNumbersListInfo& out,
                     const qcril::interfaces::CallBarringNumbersListInfo& in)
{
  if (in.hasServiceClass()) {
    out.serviceClass = in.getServiceClass();
...
template <>
void convertToSocket(RIL_SuppSvcResponse& out, const qcril::interfaces::SuppServiceStatusInfo& in)
{
  if (in.hasStatus()) {
    convertToSocket(out.status, in.getStatus());
  }
  ...
  if (cbNumListInfo.size()) {
    convertToSocket(
        out.callBarringNumbersListInfo, out.callBarringNumbersListInfoLen, cbNumListInfo);
  }
  if (in.hasErrorDetails()) {
    convertToSocket(out.errorDetails, in.getErrorDetails());
  }
...
template <>
void convertToSocket(RIL_IpPresentation& out, const qcril::interfaces::Presentation& in) {
  switch (in) {
  case qcril::interfaces::Presentation::ALLOWED:
    out = RIL_IP_PRESENTATION_NUM_ALLOWED;
    break;
  case qcril::interfaces::Presentation::RESTRICTED:
    out = RIL_IP_PRESENTATION_NUM_RESTRICTED;
    break;
  case qcril::interfaces::Presentation::DEFAULT:
    out = RIL_IP_PRESENTATION_NUM_DEFAULT;
    break;
  default:
    out = RIL_IP_PRESENTATION_INVALID;
    break;
  }
}
...
RIL_TtyModeType convertCallTtyMode(const qcril::interfaces::TtyMode& ttyMode) {
    switch (ttyMode) {
        case qcril::interfaces::TtyMode::MODE_OFF:
            return RIL_TtyModeType::RIL_TTY_MODE_OFF;
        case qcril::interfaces::TtyMode::FULL:
            return RIL_TtyModeType::RIL_TTY_MODE_FULL;
        case qcril::interfaces::TtyMode::HCO:
            return RIL_TtyModeType::RIL_TTY_MODE_HCO;
        case qcril::interfaces::TtyMode::VCO:
            return RIL_TtyModeType::RIL_TTY_MODE_VCO;
        case qcril::interfaces::TtyMode::UNKNOWN:
        default:
            return RIL_TtyModeType::RIL_TTY_MODE_INVALID;
    }
}
...
void convertToSocket(RIL_HandoverType& type, const qcril::interfaces::HandoverType&& handoverType)
{
  type = RIL_HO_UNKNOWN;
  ...
  switch (handoverType) {
    ...
    case HandoverType::START:
      ...
      break;
    case HandoverType::COMPLETE_SUCCESS:
      type = RIL_HO_COMPLETE_SUCCESS;
      break;
    case HandoverType::COMPLETE_FAIL:
      type = RIL_HO_COMPLETE_FAIL;
      break;
    case HandoverType::CANCEL:
      type = RIL_HO_CANCEL;
      break;
    case HandoverType::NOT_TRIGGERED:
      type = RIL_HO_NOT_TRIGGERED;
      break;
    case HandoverType::NOT_TRIGGERED_MOBILE_DATA_OFF:
      type = RIL_HO_NOT_TRIGGERED_MOBILE_DATA_OFF;
      break;
    default:
      type = RIL_HO_INVALID;
      break;
                     ...
                     std::shared_ptr<QcRilUnsolImsHandoverMessage> msg)
{
  convertToSocket(
      handoverInfo.type,
      msg->hasHandoverType() ? msg->getHandoverType() : qcril::interfaces::HandoverType::UNKNOWN);
  handoverInfo.srcTech = msg->hasSourceTech() ? msg->getSourceTech() : RADIO_TECH_UNKNOWN;
  handoverInfo.targetTech = msg->hasTargetTech() ? msg->getTargetTech() : RADIO_TECH_UNKNOWN;
  if (msg->hasErrorCode()) {
    convertToSocket(handoverInfo.errorCode, msg->getErrorMsg());
  }
  if (msg->hasErrorMsg()) {
  ...
  handoverInfo.hoExtra = new RIL_HoExtra{};
  if (!msg->hasErrorCode() && !msg->hasErrorMsg() && msg->hasCauseCode() &&
      !msg->getCauseCode().empty()) {
    handoverInfo.hoExtra->type = RIL_HO_XT_TYPE_LTE_TO_IWLAN_HO_FAIL;
    convertToSocket(handoverInfo.hoExtra->extraInfo, msg->getCauseCode());
  } else {
    handoverInfo.hoExtra->type = RIL_HO_XT_TYPE_INVALID;
  }
}
...
void convertToSocket(RIL_ConferenceCallState &callState, qcril::interfaces::ConferenceCallState src) {
    switch(src) {
        case qcril::interfaces::ConferenceCallState::FOREGROUND:
            callState = RIL_CONF_CALL_STATE_FOREGROUND;
            break;
        case qcril::interfaces::ConferenceCallState::BACKGROUND:
            callState = RIL_CONF_CALL_STATE_BACKGROUND;
            break;
        case qcril::interfaces::ConferenceCallState::RINGING:
            callState = RIL_CONF_CALL_STATE_RINGING;
            break;
        default:
            callState = RIL_CONF_CALL_STATE_UNKNOWN;
            break;
    }
}
...
void convertToSocket(RIL_IMS_RefreshConferenceInfo &conferenceInfo,
    ...
    if (msg->hasConferenceInfoUri() && msg->getConferenceInfoUri().size() != 0) {
        conferenceInfo.confInfoUriLength = msg->getConferenceInfoUri().size();
        conferenceInfo.confInfoUri = new uint8_t[conferenceInfo.confInfoUriLength]{};
        if(conferenceInfo.confInfoUri) {
          std::copy(msg->getConferenceInfoUri().begin(),
                    msg->getConferenceInfoUri().end(), conferenceInfo.confInfoUri);
        }
    }
}
...
void convertToSocket(RIL_RefreshConferenceInfo &conferenceInfo,
        std::shared_ptr<QcRilUnsolImsConferenceInfoMessage> msg) {
    conferenceInfo.conferenceCallState = RIL_CONF_CALL_STATE_UNKNOWN;
    if(msg->hasConferenceCallState()) {
        convertToSocket(conferenceInfo.conferenceCallState, msg->getConferenceCallState());
    }
    conferenceInfo.confInfoUri = nullptr;
...
void convertAddressesToSocket(RIL_Data_Call_Response_v11& dataCall, const rildata::DataCallResult_t& entry) {
  dataCall.linkAddressesLength = std::min(entry.linkAddresses.size(), static_cast<size_t>(MAX_LINK_ADDRESSES));
...
void convertToSocket(RIL_SliceInfo &out, rildata::SliceInfo_t &in){
  out.sst = static_cast<RIL_SliceServiceType>(in.sliceServiceType);
  out.sliceDifferentiator = in.sliceDifferentiator;
  out.mappedHplmnSst = static_cast<RIL_SliceServiceType>(in.mappedHplmnSst);
  out.mappedHplmnSD = in.mappedHplmnSd;
  out.status = static_cast<RIL_SliceStatus>(in.status);
}

void convertToSocket(rilRouteSelectorDescriptor &out, rildata::RouteSelectionDescriptor_t &in) {
  out.precedence = in.precedence;
  out.ipType = static_cast<rilPdpProtocolType>(in.sessionType);
  out.sscMode = in.sscMode;
  out.sliceInfoSize = std::min((int)in.sliceInfo.size(), MAX_SLICE_INFO);
  if (out.sliceInfoSize) {
    for (int i = 0; i < out.sliceInfoSize; i++) {
      convertToSocket(out.sliceInfos[i], in.sliceInfo[i]);
    }
  }
  out.dnnSize = std::min((int)in.dnn.size(), MAX_DNN_LISTS);
  if (out.dnnSize) {
    for (int i = 0; i < out.dnnSize; i++) {
      convertToSocket(out.dnnList[i].dnn, in.dnn[i]);
    }
  }
}
...
void convertToSocket(rilUrspRule &out, rildata::UrspRule_t &in) {
  out.precedence = in.precedence;
  out.tdSize = std::min((int)in.trafficDescriptors.size(), MAX_TRAFFIC_DESCRIPTORS);
  if (out.tdSize) {
    for (int i = 0; i < out.tdSize; i++) {
      convertToSocket(out.tdList[i], in.trafficDescriptors[i]);
    }
  }
  out.routeSelectorSize = std::min((int)in.routeSelectionDescriptors.size(), MAX_ROUTE_SELECTORS);
  if (out.routeSelectorSize) {
    for (int i = 0; i < out.routeSelectorSize; i++) {
      convertToSocket(out.routeSelectors[i], in.routeSelectionDescriptors[i]);
    }
  }
}

void convertToSocket(rilSlicingConfig &out, rildata::SlicingConfig_t &in) {
  out.UsrpRuleSize = std::min((int)in.urspRules.size(), MAX_URSP_RULES);
  if (out.UsrpRuleSize) {
    for (int i = 0; i < out.UsrpRuleSize ; i++) {
      convertToSocket(out.ursprules[i], in.urspRules[i]);
    }
  }
  out.sliceInfoSize = std::min((int)in.sliceInfos.size(), MAX_SLICE_INFO);
  if (out.sliceInfoSize) {
    for (int i = 0; i < out.sliceInfoSize; i++) {
      convertToSocket(out.sliceInfos[i], in.sliceInfos[i]);
    }
  }
}

void convertToSocket(RIL_DataProfileInfo &out, rildata::DataProfileInfo_t &in) {
    out.profileId = static_cast<int>(in.profileId);
    out.apn = const_cast<char*>(in.apn.c_str());
    out.protocol = const_cast<char*>(in.protocol.c_str());
    out.roamingProtocol = const_cast<char*>(in.roamingProtocol.c_str());
    out.authType = static_cast<int>(in.authType);
    out.user = const_cast<char*>(in.username.c_str());
    out.password = const_cast<char*>(in.password.c_str());
    out.type = static_cast<int>(in.dataProfileInfoType);
    out.maxConnsTime = in.maxConnsTime;
    out.maxConns = in.maxConns;
    out.waitTime = in.waitTime;
    out.enabled = in.enableProfile;
    out.supportedTypesBitmask = static_cast<int>(in.supportedApnTypesBitmap);
    out.bearerBitmask = static_cast<int>(in.bearerBitmap);
    out.mtuV4 = in.mtuV4;
    out.mtuV6 = in.mtuV6;
    out.mtu = in.mtu;
    out.preferred = in.preferred;
    out.persistent = in.persistent;
    if (in.trafficDescriptor != std::nullopt) {
        out.trafficDescriptorValid = true;
        rildata::TrafficDescriptor_t td = *(in.trafficDescriptor);
        convertToSocket(out.trafficDescriptor, td);
    }
}
...
void convertToSocket(RIL_CallInfo& out, const qcril::interfaces::CallInfo& in) {
  ...
  out.audioQuality =
      new RIL_CallAudioQuality{ .codec = RIL_CODEC_NONE,
                                .computedAudioQuality = RIL_COMPUTED_AUDIO_QUALITY_NONE };
  if (in.hasCodec()) {
    convertToSocket(out.audioQuality->codec, in.getCodec());
  }
  if (in.hasComputedAudioQuality()) {
    convertToSocket(out.audioQuality->computedAudioQuality, in.getComputedAudioQuality());
  }
  convertToSocket(out.modemCallId, in.getModemCallIdRef());
}
...
void release(RIL_CallFailCauseResponse &arg) {
  //failCause
  //extendedFailCause
  delete []arg.networkErrorString;
  arg.networkErrorString = nullptr;
...
void release(RIL_CallProgressInfo &arg) {
  //type
  //reasonCode
  delete []arg.reasonText;
  arg.reasonText = nullptr;
...
void release(RIL_CallInfo &arg) {
  ...
  arg.uusInfo = nullptr;
  delete []arg.displayText;
  arg.displayText = nullptr;
  delete []arg.additionalCallInfo;
  arg.additionalCallInfo = nullptr;
  delete []arg.childNumber;
  arg.childNumber = nullptr;
  if (arg.callProgInfo) {
    release(*arg.callProgInfo);
  }
  delete arg.callProgInfo;
...
void convertToSocket(RIL_VerstatVerificationStatus& verStatus,
  ...
  switch (entry) {
    case qcril::interfaces::VerificationStatus::PASS:
      verStatus = RIL_VERSTAT_VERIFICATION_STATUS_PASS;
      break;
    case qcril::interfaces::VerificationStatus::FAIL:
      verStatus = RIL_VERSTAT_VERIFICATION_STATUS_FAIL;
      break;
    default:
      verStatus = RIL_VERSTAT_VERIFICATION_STATUS_NONE;
      break;
  }
}

void convertToSocket(RIL_CallComposerPriority& priority,
                     const qcril::interfaces::Priority& entry) {
  switch (entry) {
    case qcril::interfaces::Priority::NORMAL:
      priority = RIL_CALL_COMPOSER_PRIORITY_NORMAL;
      break;
    case qcril::interfaces::Priority::URGENT:
      priority = RIL_CALL_COMPOSER_PRIORITY_URGENT;
      break;
    case qcril::interfaces::Priority::UNKNOWN:
    default:
      priority = RIL_CALL_COMPOSER_PRIORITY_INVALID;
      break;
  }
}

void convertToSocket(RIL_CallComposerLocation& location,
                     const qcril::interfaces::Location& entry) {
  location.radius = entry.getRadius();
  location.latitude = entry.getLatitude();
  location.longitude = entry.getLongitude();
...
{
  switch (in.getImeiType()) {
    case qcril::interfaces::ImeiType::IMEI_TYPE_PRIMARY:
      out.imeiType = IMEI_TYPE_PRIMARY;
      break;
    case qcril::interfaces::ImeiType::IMEI_TYPE_SECONDARY:
      out.imeiType = IMEI_TYPE_SECONDARY;
      break;
    case qcril::interfaces::ImeiType::IMEI_TYPE_INVALID:
    default:
      out.imeiType = IMEI_TYPE_INVALID;
      break;
  }
  out.imeiLen = in.getImei().size();
  strlcpy(out.imei, in.getImei().c_str(), MIN(IMEI_MAX_BUFFER_LEN, out.imeiLen + 1));
}
...
void release(RIL_CallBarringNumbersInfo callBarringNumbersInfo) {
  // status
  delete[] callBarringNumbersInfo.number;
  callBarringNumbersInfo.number = nullptr;
}

void release(RIL_CallBarringNumbersListInfo& cbNumbersListInfo) {
  // serviceClass
  if (cbNumbersListInfo.callBarringNumbersInfoLen && cbNumbersListInfo.callBarringNumbersInfo) {
    for (int i = 0; i < cbNumbersListInfo.callBarringNumbersInfoLen; i++) {
      release(cbNumbersListInfo.callBarringNumbersInfo[i]);
    }
    delete [] cbNumbersListInfo.callBarringNumbersInfo;
    cbNumbersListInfo.callBarringNumbersInfo = nullptr;
  }
}
...
void release(RIL_SuppSvcResponse& sppSvcResp) {
  ...
  // provisionStatus
  // facilityType
  if (sppSvcResp.callBarringNumbersListInfoLen && sppSvcResp.callBarringNumbersListInfo) {
    for (int i = 0; i < sppSvcResp.callBarringNumbersListInfoLen; i++) {
      release(sppSvcResp.callBarringNumbersListInfo[i]);
    }
    delete [] sppSvcResp.callBarringNumbersListInfo;
    sppSvcResp.callBarringNumbersListInfo = nullptr;
  }
  if (sppSvcResp.errorDetails) {
    release(*sppSvcResp.errorDetails);
    delete sppSvcResp.errorDetails;
    sppSvcResp.errorDetails = nullptr;
  }
}
...
RIL_IMS_SrtpEncryptionStatus convertToSocket(const QcRilUnsolImsSrtpEncryptionStatus& in) {
  ...
  uint32_t categories = RIL_IMS_SRTP_CATEGORIES_UNENCRYPTED;
  if (in.getVoiceEnable()) {
    categories |= RIL_IMS_SRTP_CATEGORIES_VOICE;
  }
  if (in.getVideoEnable()) {
    categories |= RIL_IMS_SRTP_CATEGORIES_VIDEO;
  }
  if (in.getTextEnable()) {
    categories |= RIL_IMS_SRTP_CATEGORIES_TEXT;
  }
