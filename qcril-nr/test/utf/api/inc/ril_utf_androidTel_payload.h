...
enum ril_utf_expectation_t verify_ril_is_vonr_enabled(void *exp_node, void *data);
...
*/
ril_utf_expectation_t verify_ril_get_phone_capability(void *exp_node, int exp_len, void *data,
                                                      int data_len);
#endif
