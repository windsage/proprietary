...
RIL_SMS_Response* update_default_ril_request_send_sms_resp(RIL_Errno err);
...
*/
char** update_default_ril_qti_radio_request_query_facility_lock();
void update_default_ril_qti_radio_request_query_facility_lock_resp(int service_class);
char** malloc_ril_qti_radio_request_query_facility_lock();
void free_ril_qti_radio_request_query_facility_lock();
...
*/
ril_request_set_indication_filter_t* update_default_ril_request_set_indication_filter();
void update_default_ril_request_set_indication_filter_resp();
...
*/
ril_request_send_device_state_t* update_default_ril_request_send_device_state();
void update_default_ril_request_send_device_state_resp();
...
*/
ril_request_set_vo_nr_enabled_t* update_default_ril_request_enable_vo_nr_req();
void update_default_ril_request_enable_vo_nr_resp();

/*
  RIL_REQUEST_IS_VONR_ENABLED
*/
void update_default_ril_request_is_vo_nr_enabled_req();
ril_request_set_vo_nr_enabled_t* update_default_ril_request_is_vo_nr_enabled_resp();
...
*/
void update_default_ril_request_get_phone_capability_req();
RIL_PhoneCapability* update_default_ril_request_get_phone_capability_resp();
...
RIL_SignalStrength* update_default_ril_request_signal_strength_resp();
RIL_SignalStrength* malloc_ril_request_signal_strength_resp();
...
void update_default_ril_request_set_location_updates_resp_with_err(RIL_Errno e);
...
*/
// TODO: determine if there is a RIL version, and use it here instead of int.
void update_default_ril_request_nv_reset_config_with_type(uint32_t resetType);
...
*/
void update_default_ril_request_get_data_nr_icon_type();
void update_default_ril_request_get_data_nr_icon_type_resp(five_g_icon_type val);
...
*/
void update_default_ril_request_get_imei();
void update_default_ril_request_get_imei_resp(uint8_t imei[],
                                              uint8_t imei_len,
...
*/
void update_default_ril_request_get_usage_setting();
void update_default_ril_resp_get_usage_setting(RIL_UsageSettingMode mode);

/*
    RIL_REQUEST_SET_USAGE_SETTING
*/
void update_default_ril_request_set_usage_setting(RIL_UsageSettingMode mode);
void update_default_ril_resp_set_usage_setting();

// RIL_REQUEST_SET_MSIM_PREFERENCE
void update_ril_request_set_msim_pref(Msim_Preference pref);
void update_ril_request_set_msim_pref_resp();

/*
    RIL_REQUEST_CDMA_SUBSCRIPTION
*/
void update_default_ril_request_get_cdma_sub();
qcril::interfaces::RilGetCdmaSubscriptionResult_t*
    update_default_ril_request_get_cdma_sub_resp(RIL_Errno err);

/*
    RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT
*/
void update_default_ril_request_get_uicc_applications_enablement();
void update_default_ril_request_get_uicc_applications_enablement_resp(
    bool enabled, RIL_Errno err);

/*
    RIL_REQUEST_QUERY_NR_DISABLE_MODE / RIL_REQUEST_SET_NR_DISABLE_MODE
*/
void update_default_ril_request_set_nr_disable_mode(RIL_NR_DISABLE_MODE);
void update_default_ril_request_set_nr_disable_mode_resp(uint32_t);
void update_default_ril_request_query_nr_disable_mode();
void update_default_ril_request_query_nr_disable_mode_resp(RIL_NR_DISABLE_MODE);

/**
 *  RIL_REQUEST_ENABLE_ENDC & RIL_REQUEST_QUERY_ENDC_STATUS
 */
void update_ril_request_enable_endc(bool);
void update_ril_request_enable_endc_resp(RIL_Errno e = RIL_E_SUCCESS);

void update_ril_request_query_endc();
void update_ril_request_query_endc_resp(endc_status status, RIL_Errno e = RIL_E_SUCCESS);

/*
    RIL_REQUEST_GET_RADIO_CAPABILITY & RIL_REQUEST_SET_RADIO_CAPABILITY_
*/
void update_ril_request_get_radio_capability();
RIL_RadioCapability* update_ril_request_set_radio_capability_resp();
void update_ril_request_get_radio_capability_resp();

/**
 *  RIL_REQUEST_GET_ENHANCED_RADIO_CAPABILITY
 */
void update_default_ril_request_get_enhanced_radio_cap();
void update_default_ril_request_get_enhanced_radio_cap_resp(EnhancedRadioAccessFamily);

/*
    RIL_QTI_RADIO_REQUEST_START_NETWORK_SCAN
*/
RIL_NetworkScanRequest* update_default_ril_qti_radio_request_start_network_scan(
    RIL_NetworkScanRequest* req = nullptr);
void update_default_ril_qti_radio_request_start_network_scan_resp();

/*
    RIL_QTI_RADIO_UNSOL_NETWORK_SCAN_RESULT
*/
RIL_NetworkScanResult* update_default_ril_qti_radio_unsol_network_scan_result();

/**
 *  RIL_REQUEST_GET_CELL_BARRING_INFO
 */
void update_get_cell_barring_info();
void update_get_cell_barring_info_resp(RIL_CellBarringInfo barring_info);

/**
 *  RIL_REQUEST_IS_FEATURE_SUPPORTED
 */
void update_ril_request_is_feature_supported(int feature);
void update_ril_request_is_feature_supported_resp(bool featureSupported);
} AndroidTelTestnode;
