 ...
 */
  ...
  */
  dms_get_imei_info_req_msg_v01* update_default_qmi_dms_get_imei_info();
  void update_default_qmi_dms_get_imei_info_resp(qmi_result_type_v01 result,
                                                 qmi_error_type_v01 error);
  dms_imei_info_ind_msg_v01* update_default_qmi_dms_imei_info_ind(uint8_t imei[],
                                                                  uint32_t imei_len,
...
//  void set_qmi_nas_set_event_report_req_report_error_rate(uint8_t report_error_rate);
  ...
  */
  ...
  void set_qmi_nas_set_indication_register_req_reg_lte_cphy_ca(uint8_t reg_lte_cphy_ca);
  void set_qmi_nas_set_indication_register_req_reg_ssac_change_info(uint8_t reg_ssac_change_info);
  void set_qmi_nas_set_indication_register_req_reg_cell_barring_info(uint8_t reg_cell_barring_info);
  void set_qmi_nas_set_indication_register_req_reg_access_barring_status(uint8_t eg_access_barring_status);
  void set_qmi_nas_set_indication_register_req_reg_acb_info_change(uint8_t reg_acb_info_change);
  ...
  */
  void update_default_qmi_nas_set_nr5g_full_voice_support_req_msg(void);
  void set_qmi_nas_set_nr5g_full_voice_support_req_nr5g_full_voice_support(
          nas_nr5g_full_voice_support_enum_type_v01 nr5g_full_voice_support);
  void update_default_qmi_nas_set_nr5g_full_voice_support_resp_msg(void);
  void set_qmi_nas_set_nr5g_full_voice_support_resp_msg_result(
          qmi_result_type_v01 result, qmi_error_type_v01 error);

  /*
    QMI_NAS_GET_NR5G_FULL_VOICE_SUPPORT_REQ_MSG_V01
  */
  void update_default_qmi_nas_get_nr5g_full_voice_support_req_msg(void);
  void update_default_qmi_nas_get_nr5g_full_voice_support_resp_msg(void);
  void set_qmi_nas_get_nr5g_full_voice_support_resp_msg_result(
          qmi_result_type_v01 result, qmi_error_type_v01 error);
  void set_qmi_nas_get_nr5g_full_voice_support_resp_nas_nr5g_full_voice_support(
          nas_nr5g_full_voice_support_enum_type_v01 nr5g_full_voice_support);
...
*/
  ...
  void set_qmi_voice_ind_req_srtp_status_info_event(uint8_t srtp_status_info_event);
/*
...
*/
  ...
  void set_voice_get_call_barring_resp_additional_msg_is_pwd_req(uint8_t);
/*
...
*/
  ...
  voice_dc_call_info_type_v02* set_qmi_voice_all_call_status_ind_data_channel_type(uint32_t len);
  ...
  voice_call_reason_type_v02* set_qmi_voice_all_call_status_ind_call_reason(uint32_t call_reason_len);
/*
...
*/
  ...
  update_default_qmi_nas_set_system_selection_preference_req_msg();
...
nas_3gpp_srv_status_info_type_v01* set_qmi_nas_get_sys_info_resp_nr5g_srv_status_info();
...
nas_nr5g_sys_info_type_v01* set_qmi_nas_get_sys_info_resp_nr5g_sys_info();
...
nas_indication_register_req_msg_v01* update_default_qmi_nas_indication_register_req_msg_v();
...
void set_qmi_nas_sys_info_ind_wcdma_signalling_bar_status();
...
void set_qmi_nas_lte_sib16_network_time_ind_universal_time(nas_lte_sib16_julian_time_type_v01 universal_time);
void set_qmi_nas_lte_sib16_network_time_ind_time_zone(int8_t val);
void set_qmi_nas_lte_sib16_network_time_ind_daylight_saving_time(int8_t val);
...
void set_qmi_dms_get_band_capability_resp_supported_lte_bands();
...
*/
void update_default_qmi_dms_get_band_capability_ex_req_msg();

/*
  QMI_DMS_GET_BAND_CAPABILITY_EX_RESP_V01
*/
void update_default_qmi_dms_get_band_capability_ex_resp_msg(qmi_result_type_v01 result,qmi_error_type_v01 error);
void set_qmi_dms_get_band_capability_resp_result(qmi_result_type_v01 result, qmi_error_type_v01 error);

/*
QMI_DMS_BAND_CAPABILITY_EX_IND
*/
void update_default_qmi_dms_band_capability_ex_ind();
void set_qmi_dms_band_capability_ex_ind();
...
*/
void update_default_qmi_imss_get_c_iwlan_status_req(void);

/*
  QMI_IMS_SETTINGS_GET_C_IWLAN_STATUS_RESP_V01
*/
void update_default_qmi_imss_get_c_iwlan_status_rsp(void);
void set_qmi_imss_get_c_iwlan_status_rsp_v01(qmi_result_type_v01 result, qmi_error_type_v01 error);
void set_qmi_imss_get_c_iwlan_status_rsp_c_iwlan_mode_home(ims_settings_c_iwlan_mode_enum_v01 val);
void set_qmi_imss_get_c_iwlan_status_rsp_c_iwlan_mode_roam(ims_settings_c_iwlan_mode_enum_v01 val);
...
========================================================*/
void update_default_qmi_sar_rf_set_state_req(qmi_sar_rf_state_enum_type_v01 state);
void set_qmi_sar_rf_set_state_req_compatibility_key(uint32_t val);

/*========================================================
  QMI_SAR_RF_SET_STATE_RESP_MSG_V01
========================================================*/
void update_default_qmi_sar_rf_set_state_resp(qmi_result_type_v01 result,qmi_error_type_v01 error);

/*========================================================
  QMI_SAR_GET_COMPATIBILITY_KEY_REQ_MSG_V01
========================================================*/
void update_default_qmi_sar_rf_get_compatibility_key_req();

/*========================================================
  QMI_SAR_GET_COMPATIBILITY_KEY_RESP_MSG_V01
========================================================*/
void update_default_qmi_sar_rf_get_compatibility_key_resp(qmi_result_type_v01 result,qmi_error_type_v01 error);
void set_qmi_sar_rf_get_compatibility_key_resp_compatibility_key(uint32_t val);
...
set_qmi_nas_perform_incremental_network_scan_ind_nas_network_scan_info_cag_info(uint32_t len);
void set_qmi_nas_perform_incremental_network_scan_req_search_type(nas_nw_search_type_enum_v01 val);
uint8_t* set_qmi_nas_perform_incremental_network_scan_ind_cag_only_access(uint32_t len);
...
nas_network_time_type_v01* set_qmi_nas_get_network_time_resp_nas_3gpp2_time();

/*========================================================
   QMI_VOICE_SRTP_STATUS_IND_V02
========================================================*/
void update_default_qmi_voice_srtp_encryption_status_msg(void);
void set_qmi_voice_srtp_encryption_call_id(uint8_t call_id);
void set_qmi_voice_srtp_encryption_category_voice(boolean enable);
void set_qmi_voice_srtp_encryption_category_video(boolean enable);
void set_qmi_voice_srtp_encryption_category_text(boolean enable);
...
// QMI_NAS_SET_MSIM_PREFERENCE_REQ_MSG_V01 | QMI_NAS_SET_MSIM_PREFERENCE_RESP_MSG_V01
void update_default_qmi_nas_set_msim_preference_req(nas_msim_preference_enum_type_v01 pref);
void update_default_qmi_nas_set_msim_preference_resp(qmi_result_type_v01 res, qmi_error_type_v01 err);

// QMI_NAS_SET_ENDC_CONFIG_REQ_MSG_V01
void update_default_qmi_nas_req_set_endc_config(uint8_t);
void update_default_qmi_nas_req_set_endc_config_resp(
...
void update_default_qmi_nas_req_get_endc_config();
void update_default_qmi_nas_req_get_endc_config_resp(
    uint8_t enable,
    qmi_result_type_v01 result = QMI_RESULT_SUCCESS_V01,
    qmi_error_type_v01 error = QMI_ERR_NONE_V01);

// QMI_PBM_GET_ALL_PB_CAPABILITIES_REQ_V01
void update_default_qmi_pbm_get_all_pb_capabilities_req(void);
void update_default_qmi_pbm_get_all_pb_capabilities_resp(qmi_result_type_v01 res, qmi_error_type_v01 err);
void update_default_qmi_pbm_read_records_ext_req(int adn_count, int session_type);
void update_default_qmi_pbm_read_records_ext_resp(qmi_result_type_v01 res, qmi_error_type_v01 err);

// QMI_NAS_ACCESS_BARRING_STATUS_IND_MSG_V01
nas_cell_barring_info_ind_msg_v01* update_cell_barring_info_ind_msg();
nas_access_barring_status_ind_msg_v01* update_access_barring_status_ind_msg();
nas_acb_info_ind_msg_v01* update_acb_info_ind_msg();
nas_ssac_change_info_ind_msg_v01* update_ssac_change_info_ind_msg();
} QMIRILTestnode;
