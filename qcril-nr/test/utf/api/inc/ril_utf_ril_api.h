...
typedef struct  PACKED_STRUCT
{
  ...
  bool mValue;
}ril_request_send_device_state_t;
...
{
  bool mEnable;
}ril_request_set_vo_nr_enabled_t;
...
typedef struct PACKED_STRUCT
{
  uint32_t indicationFilter;
}ril_request_set_indication_filter_t;
...
typedef struct PACKED_STRUCT
{
  ...
  char *AID_value;
  bool expectMore;
}ril_qti_radio_request_query_facility_lock_t;
