...
struct utf_ims_sms_status_report_t {
  RIL_RadioTechnologyFamily tech;
  uint8_t* pdu;
  size_t size;
  //qcril::interfaces::VerificationStatus ver_status;
...
void set_ims_request_set_supp_svc_response_resp_pwd_req(bool req);
...
void set_ims_request_set_supp_svc_response_resp_provisionStatus(ims_ServiceClassProvisionStatus status);
  ...
  */
  ...
  utf_ims_sms_status_report_t* update_default_ims_sms_status_report();
  ...
  */
  void update_default_ims_unsol_srtp_encryption_status(void);
  void set_ims_unsol_srtp_encryption_call_id(uint32_t call_id);
  void set_ims_unsol_srtp_encryption_categories(uint32_t categories);
