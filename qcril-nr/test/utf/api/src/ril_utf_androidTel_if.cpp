...
RIL_SMS_Response* ril_utf_androidTel_if::update_default_ril_request_send_sms_resp(RIL_Errno err)
{
...
ril_request_get_smsc_address_resp_t* ril_utf_androidTel_if::malloc_ril_request_get_smsc_address_resp()
{
  ...
  memset(ptr, 0x0, sizeof(ril_request_get_smsc_address_resp_t));
  return ptr;
}
...
RIL_CDMA_BroadcastSmsConfigInfo** ril_utf_androidTel_if::update_default_ril_request_cdma_get_broadcast_sms_config_resp(int num)
{
  ...
  for(int i=0; i<num; i++) {
    ...
    memset(ptr[i], 0x0, sizeof(RIL_CDMA_BroadcastSmsConfigInfo));
  }
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_CDMA_GET_BROADCAST_SMS_CONFIG;
...
RIL_CDMA_BroadcastSmsConfigInfo** ril_utf_androidTel_if::malloc_ril_request_cdma_get_broadcast_sms_config_resp(int num)
{
  ...
  memset(dptr, 0x0, num * sizeof(RIL_CDMA_BroadcastSmsConfigInfo*));
  return dptr;
}
...
/*========================================================
  RIL_QTI_RADIO_REQUEST_QUERY_FACILITY_LOCK
========================================================*/
char** ril_utf_androidTel_if::update_default_ril_qti_radio_request_query_facility_lock()
{
  payload = malloc_ril_qti_radio_request_query_facility_lock();
  payload_len = sizeof(char*)*5;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_QTI_RADIO_REQUEST_QUERY_FACILITY_LOCK;

  char **ptr = (char**) payload;
  return ptr;
}

void ril_utf_androidTel_if::update_default_ril_qti_radio_request_query_facility_lock_resp(int service_class)
{
  payload = malloc(sizeof(int));
  payload_len = sizeof(int);
  payload_type = ril_utf_ril_response;
...
char** ril_utf_androidTel_if::malloc_ril_qti_radio_request_query_facility_lock()
{
  ...
  ptr[2] = (char *)malloc(40);
  ptr[3] = NULL;
  ptr[4] = (char *)malloc(10);
  return ptr;
}
void ril_utf_androidTel_if::free_ril_qti_radio_request_query_facility_lock()
{
  ril_qti_radio_request_query_facility_lock_t **dptr = (ril_qti_radio_request_query_facility_lock_t **) payload;
  free((*dptr)->facility_string_code);
  free((*dptr)->password);
  free((*dptr)->service_class_bit_vector);
  free((*dptr)->AID_value);
...
=========================================================*/
ril_request_set_vo_nr_enabled_t* ril_utf_androidTel_if::update_default_ril_request_enable_vo_nr_req()
{
  payload = malloc(sizeof(ril_request_set_vo_nr_enabled_t));
  payload_len = sizeof(ril_request_set_vo_nr_enabled_t);
  memset(payload, 0, payload_len);
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_ENABLE_VONR;
  return (ril_request_set_vo_nr_enabled_t*)payload;
}
void ril_utf_androidTel_if::update_default_ril_request_enable_vo_nr_resp()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_response;
...
=========================================================*/
void ril_utf_androidTel_if::update_default_ril_request_is_vo_nr_enabled_req()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_IS_VONR_ENABLED;
}
ril_request_set_vo_nr_enabled_t* ril_utf_androidTel_if::update_default_ril_request_is_vo_nr_enabled_resp()
{
  payload = malloc(sizeof(ril_request_set_vo_nr_enabled_t));
  payload_len = sizeof(ril_request_set_vo_nr_enabled_t);
  memset(payload, 0, payload_len);
...
========================================================*/
ril_request_send_device_state_t* ril_utf_androidTel_if::update_default_ril_request_send_device_state()
{
  payload = malloc(sizeof(ril_request_send_device_state_t));
  payload_len = sizeof(ril_request_send_device_state_t);
  memset(payload, 0, payload_len);
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_SEND_DEVICE_STATE;
  return (ril_request_send_device_state_t*) payload;
}
void ril_utf_androidTel_if::update_default_ril_request_send_device_state_resp()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_response;
...
========================================================*/
ril_request_set_indication_filter_t* ril_utf_androidTel_if::update_default_ril_request_set_indication_filter()
{
  payload = malloc(sizeof(ril_request_set_indication_filter_t));
  payload_len = sizeof(ril_request_set_indication_filter_t);
  memset(payload, 0, payload_len);
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_SET_UNSOLICITED_RESPONSE_FILTER;
  ril_request_set_indication_filter_t* ptr = (ril_request_set_indication_filter_t*) payload;
  return ptr;
}
void ril_utf_androidTel_if::update_default_ril_request_set_indication_filter_resp()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_response;
...
/*========================================================
RIL_REQUEST_CONFIG_GET_PHONE_CAPABILITY
========================================================*/
void ril_utf_androidTel_if::update_default_ril_request_get_phone_capability_req()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_CONFIG_GET_PHONE_CAPABILITY;
}
RIL_PhoneCapability* ril_utf_androidTel_if::update_default_ril_request_get_phone_capability_resp()
{
  payload = malloc(sizeof(RIL_PhoneCapability));
  payload_len = sizeof(RIL_PhoneCapability);
  memset(payload, 0, payload_len);
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_CONFIG_GET_PHONE_CAPABILITY;
  return static_cast<RIL_PhoneCapability*>(payload);
}
...
RIL_SignalStrength* ril_utf_androidTel_if::update_default_ril_request_signal_strength_resp()
{
  payload = malloc_ril_request_signal_strength_resp();
  payload_len = sizeof(RIL_SignalStrength);
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_SIGNAL_STRENGTH;

  RIL_SignalStrength* ptr = (RIL_SignalStrength*)payload;
  return ptr;
}
RIL_SignalStrength* ril_utf_androidTel_if::malloc_ril_request_signal_strength_resp()
{
  RIL_SignalStrength* ptr = (RIL_SignalStrength*)malloc(sizeof(RIL_SignalStrength));
  memset(ptr, 0x0, sizeof(RIL_SignalStrength));
  return ptr;
}
...
ril_utf_androidTel_if::update_default_ril_request_set_location_updates()
{
...
void ril_utf_androidTel_if::update_default_ril_request_set_location_updates_resp_with_err(RIL_Errno e)
{
  error = e;
  update_default_ril_request_set_location_updates_resp();
}

ril_request_set_location_updates_t* ril_utf_androidTel_if::malloc_ril_request_set_location_updates()
{
  ril_request_set_location_updates_t* ptr =
      (ril_request_set_location_updates_t*)malloc(sizeof(ril_request_set_location_updates_t));
  return ptr;
}
...
int ril_utf_androidTel_if::compare_ril_request_set_location_updates(
    ril_request_set_location_updates_t* ptr1, ril_request_set_location_updates_t* ptr2)
{
...
void ril_utf_androidTel_if::update_default_ril_request_nv_reset_config_with_type(uint32_t resetType)
{
  payload_len = sizeof(uint32_t);
  payload = malloc(payload_len);
  *((uint32_t*)payload) = resetType;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_NV_RESET_CONFIG;
}
...
*/
void ril_utf_androidTel_if::update_default_ril_request_get_data_nr_icon_type()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_GET_DATA_NR_ICON_TYPE;
}
void ril_utf_androidTel_if::update_default_ril_request_get_data_nr_icon_type_resp(five_g_icon_type val)
{
  payload_len = sizeof(five_g_icon_type);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_GET_DATA_NR_ICON_TYPE;

  five_g_icon_type *ptr = (five_g_icon_type *)payload;
  *ptr = val;
}
...
/*
    RIL_QTI_RADIO_REQUEST_START_NETWORK_SCAN
*/
RIL_NetworkScanRequest* ril_utf_androidTel_if::update_default_ril_qti_radio_request_start_network_scan(
    RIL_NetworkScanRequest* req)
{
  ...
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_request;
  msg_id = RIL_QTI_RADIO_REQUEST_START_NETWORK_SCAN;
  if (req) {
    memcpy(payload, req, payload_len);
  }
  RIL_NetworkScanRequest* ptr = (RIL_NetworkScanRequest*)payload;
...
void ril_utf_androidTel_if::update_default_ril_qti_radio_request_start_network_scan_resp()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_response;
...
/*
    RIL_QTI_RADIO_UNSOL_NETWORK_SCAN_RESULT
*/
RIL_NetworkScanResult* ril_utf_androidTel_if::update_default_ril_qti_radio_unsol_network_scan_result()
{
  payload = qcril_malloc(sizeof(RIL_NetworkScanResult) * 1);
  payload_len = sizeof(RIL_NetworkScanResult);
  payload_type = ril_utf_ril_unsol_response;
  msg_id = RIL_QTI_RADIO_UNSOL_NETWORK_SCAN_RESULT;
...
void ril_utf_androidTel_if::update_ril_request_enable_endc(bool enable)
{
  payload_len = sizeof(bool);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_ENABLE_ENDC;

  *((bool*)payload) = enable;
}

void ril_utf_androidTel_if::update_ril_request_enable_endc_resp(RIL_Errno e)
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_response;
...
void ril_utf_androidTel_if::update_ril_request_query_endc()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_QUERY_ENDC_STATUS;
}

void ril_utf_androidTel_if::update_ril_request_query_endc_resp(endc_status status, RIL_Errno e)
{
  payload_len = sizeof(endc_status);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_response;
  *((endc_status*)payload) = status;
...
*/
void ril_utf_androidTel_if::update_default_ril_request_get_imei()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_GET_IMEI;
}
void ril_utf_androidTel_if::update_default_ril_request_get_imei_resp(uint8_t imei[],
                                                                     uint8_t imei_len,
                                                                     RIL_ImeiType imei_type)
{
  ...
  RIL_ImeiInfo* resp = (RIL_ImeiInfo*)payload;
  strlcpy(reinterpret_cast<char*>(&(resp->imei[0])), reinterpret_cast<char*>(&imei[0]), imei_len);
  resp->imeiLen = imei_len;
  resp->imeiType = imei_type;
}

/*
  RIL_REQUEST_GET_USAGE_SETTING
*/
void ril_utf_androidTel_if::update_default_ril_request_get_usage_setting()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_GET_USAGE_SETTING;
}
void ril_utf_androidTel_if::update_default_ril_resp_get_usage_setting(RIL_UsageSettingMode mode)
{
  payload_len = sizeof(RIL_UsageSettingMode);
  payload = malloc(payload_len);
  *((RIL_UsageSettingMode*)payload) = mode;
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_GET_USAGE_SETTING;
}
...
*/
void ril_utf_androidTel_if::update_default_ril_request_set_usage_setting(RIL_UsageSettingMode mode)
{
  payload_len = sizeof(RIL_UsageSettingMode);
  payload = malloc(payload_len);
  *((RIL_UsageSettingMode*)payload) = mode;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_SET_USAGE_SETTING;
}
void ril_utf_androidTel_if::update_default_ril_resp_set_usage_setting()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_response;
...
/*
    RIL_REQUEST_SET_MSIM_PREFERENCE
*/
void ril_utf_androidTel_if::update_ril_request_set_msim_pref(Msim_Preference pref)
{
  payload_len = sizeof(Msim_Preference);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_request;
  *((Msim_Preference*)payload) = pref;
  msg_id = RIL_REQUEST_SET_MSIM_PREFERENCE;
}

void ril_utf_androidTel_if::update_ril_request_set_msim_pref_resp()
{
  payload_len = 0;
  payload = NULL;
  payload_type = ril_utf_ril_response;
...
*/
void ril_utf_androidTel_if::update_default_ril_request_get_cdma_sub()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_CDMA_SUBSCRIPTION;
}

qcril::interfaces::RilGetCdmaSubscriptionResult_t*
ril_utf_androidTel_if::update_default_ril_request_get_cdma_sub_resp(RIL_Errno err)
{
  error = err;
  payload_len = sizeof(qcril::interfaces::RilGetCdmaSubscriptionResult_t);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_CDMA_SUBSCRIPTION;

  return (qcril::interfaces::RilGetCdmaSubscriptionResult_t*)payload;
}

/*
  RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT
*/
void ril_utf_androidTel_if::update_default_ril_request_get_uicc_applications_enablement()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT;
}
void ril_utf_androidTel_if::update_default_ril_request_get_uicc_applications_enablement_resp(
    bool enabled, RIL_Errno err)
{
  error = err;
  payload_len = sizeof(qcril::interfaces::RilGetUiccAppStatusResult_t);
  payload = malloc(payload_len);
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT;

  qcril::interfaces::RilGetUiccAppStatusResult_t* ptr =
 ...
 */
void ril_utf_androidTel_if::update_default_ril_request_query_nr_disable_mode()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_QUERY_NR_DISABLE_MODE;
}

void ril_utf_androidTel_if::update_default_ril_request_query_nr_disable_mode_resp(
    RIL_NR_DISABLE_MODE mode)
{
  payload_len = sizeof(RIL_NR_DISABLE_MODE);
  payload = malloc(payload_len);
  RIL_NR_DISABLE_MODE* ptr = (RIL_NR_DISABLE_MODE*)payload;
  *ptr = mode;
 ...
 * RIL_REQUEST_QUERY_NR_DISABLE_MODE
 */
void ril_utf_androidTel_if::update_default_ril_request_set_nr_disable_mode(RIL_NR_DISABLE_MODE mode)
{
  payload_len = sizeof(RIL_NR_DISABLE_MODE);
  payload = malloc(payload_len);
  RIL_NR_DISABLE_MODE* ptr = (RIL_NR_DISABLE_MODE*)payload;
  *ptr = mode;
  ...
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_SET_NR_DISABLE_MODE;
}

void ril_utf_androidTel_if::update_default_ril_request_set_nr_disable_mode_resp(uint32_t status)
{
  payload_len = sizeof(uint32_t);
  payload = malloc(payload_len);
...
/*
    ...
    RIL_REQUEST_SET_RADIO_CAPABILITY
*/
void ril_utf_androidTel_if::update_ril_request_get_radio_capability()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
...
void ril_utf_androidTel_if::update_ril_request_get_radio_capability_resp()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_response;
...
RIL_RadioCapability* ril_utf_androidTel_if::update_ril_request_set_radio_capability_resp()
{
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_SET_RADIO_CAPABILITY;
  payload = malloc(sizeof(RIL_RadioCapability));
  ...
  return (RIL_RadioCapability*)payload;
}

/**
 *  RIL_REQUEST_GET_ENHANCED_RADIO_CAPABILITY
 */
void ril_utf_androidTel_if::update_default_ril_request_get_enhanced_radio_cap()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_GET_ENHANCED_RADIO_CAPABILITY;
}
void ril_utf_androidTel_if::update_default_ril_request_get_enhanced_radio_cap_resp(
    EnhancedRadioAccessFamily in_raf)
{
  payload_len = sizeof(EnhancedRadioAccessFamily);
  payload = malloc(payload_len);
  *((EnhancedRadioAccessFamily*)payload) = in_raf;
 ...
 */
void ril_utf_androidTel_if::update_get_cell_barring_info()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_ril_request;
  msg_id = RIL_REQUEST_GET_CELL_BARRING_INFO;
}
void ril_utf_androidTel_if::update_get_cell_barring_info_resp(
    RIL_CellBarringInfo barring_info)
{
  payload_len = sizeof(RIL_CellBarringInfo);
  payload = malloc(payload_len);
  *((RIL_CellBarringInfo*)payload) = barring_info;
...
/**
 *  RIL_REQUEST_IS_FEATURE_SUPPORTED
 */
void ril_utf_androidTel_if::update_ril_request_is_feature_supported(int feature)
{
  payload_len = sizeof(int);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_request;
  *((int*)payload) = feature;
  msg_id = RIL_REQUEST_IS_FEATURE_SUPPORTED;
}

void ril_utf_androidTel_if::update_ril_request_is_feature_supported_resp(bool featureSupported)
{
  payload_len = sizeof(bool);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_ril_response;
  *((bool*)payload) = featureSupported;
  msg_id = RIL_REQUEST_IS_FEATURE_SUPPORTED;
}
