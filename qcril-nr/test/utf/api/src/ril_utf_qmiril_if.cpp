...
/*========================================================
  QMI_DMS_GET_BAND_CAPABILITY_EX_REQ_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_dms_get_band_capability_ex_req_msg(void)
{
  payload = nullptr ;//req msg is empty
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_DMS;
  msg_id = QMI_DMS_GET_BAND_CAPABILITY_EX_REQ_V01;
}

/*========================================================
  QMI_DMS_GET_BAND_CAPABILITY_EX_RESP_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_dms_get_band_capability_ex_resp_msg(qmi_result_type_v01 result,qmi_error_type_v01 error)
{
  payload = (void *) malloc(sizeof(dms_get_band_capability_ex_resp_msg_v01));
  payload_len = sizeof(dms_get_band_capability_ex_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  msg_id = QMI_DMS_GET_BAND_CAPABILITY_EX_RESP_V01;
  service_id = QMI_DMS;

  dms_get_band_capability_ex_resp_msg_v01 *ptr = (dms_get_band_capability_ex_resp_msg_v01 *) payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}

void ril_utf_qmiril_if::set_qmi_dms_get_band_capability_resp_result
  (qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  dms_get_band_capability_ex_resp_msg_v01 *ptr =
    (dms_get_band_capability_ex_resp_msg_v01 *)payload;
  ptr->resp.result = result;
  ptr->resp.error = error;
}

/*========================================================
  QMI_DMS_BAND_CAPABILITY_EX_IND_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_dms_band_capability_ex_ind()
{
  payload = (void *) malloc(sizeof(dms_band_capability_ex_ind_msg_v01));
  payload_len = sizeof(dms_band_capability_ex_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_DMS;
  msg_id = QMI_DMS_BAND_CAPABILITY_EX_IND_V01;
}

void ril_utf_qmiril_if::set_qmi_dms_band_capability_ex_ind()
{
  dms_band_capability_ex_ind_msg_v01 *ptr =
    (dms_band_capability_ex_ind_msg_v01 *) payload;
  ptr->supported_lte_bands_valid = TRUE;
  ptr->supported_lte_bands_len = 3;
  ptr->supported_lte_bands[0] = 1;
  ptr->supported_lte_bands[1] = 65;
  ptr->supported_lte_bands[2] = 129;
}
/*========================================================
...
/*========================================================
  QMI_DMS_GET_IMEI_INFO_REQ_V01 / QMI_DMS_GET_IMEI_INFO_RESP_V01 / QMI_DMS_IMEI_INFO_IND_V01
========================================================*/
dms_get_imei_info_req_msg_v01* ril_utf_qmiril_if::update_default_qmi_dms_get_imei_info()
{
  payload_len = sizeof(dms_get_imei_info_req_msg_v01);
  payload = malloc(payload_len);
  assert(payload != nullptr);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_DMS;
  msg_id = QMI_DMS_GET_IMEI_INFO_REQ_V01;

  dms_get_imei_info_req_msg_v01* ret = (dms_get_imei_info_req_msg_v01*)payload;
  ret->exempt_encrypt_valid = TRUE;
  ret->exempt_encrypt = 1;

  return ret;
}
void ril_utf_qmiril_if::update_default_qmi_dms_get_imei_info_resp(qmi_result_type_v01 result,
                                                                  qmi_error_type_v01 error)
{
  payload_len = sizeof(dms_get_imei_info_resp_msg_v01);
  payload = malloc(payload_len);
  assert(payload != nullptr);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_DMS;
  msg_id = QMI_DMS_GET_IMEI_INFO_RESP_V01;

  dms_get_imei_info_resp_msg_v01* resp = (dms_get_imei_info_resp_msg_v01*)payload;
  resp->resp.result = result;
  resp->resp.error = error;
}
dms_imei_info_ind_msg_v01* ril_utf_qmiril_if::update_default_qmi_dms_imei_info_ind(
    uint8_t imei[], uint32_t imei_len, dms_imei_type_enum_v01 imei_type)
{
  payload_len = sizeof(dms_imei_info_ind_msg_v01);
  payload = malloc(payload_len);
  assert(payload != nullptr);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_DMS;  // QMI_NAS?
  msg_id = QMI_DMS_IMEI_INFO_IND_V01;

  dms_imei_info_ind_msg_v01* ind = (dms_imei_info_ind_msg_v01*)payload;
  ind->imei_len = imei_len;
  ind->imei_type = imei_type;
  ind->imei_nonencrypted_valid = TRUE;
  strlcpy(reinterpret_cast<char*>(&(ind->imei[0])),
          reinterpret_cast<char*>(&imei[0]),
          MIN(QMI_DMS_ENCRYPTED_IMEI_MAX_V01, imei_len + 1));
  strlcpy(reinterpret_cast<char*>(&(ind->imei_nonencrypted[0])),
          reinterpret_cast<char*>(&imei[0]),
          MIN(QMI_DMS_IMEI_MAX_V01, imei_len + 1));
  return ind;
}
...
void ril_utf_qmiril_if::set_qmi_nas_set_indication_register_req_reg_lte_cphy_ca
  (uint8_t reg_lte_cphy_ca)
{
  nas_indication_register_req_msg_v01 *ptr =
    (nas_indication_register_req_msg_v01 *) payload;
  ptr->reg_lte_cphy_ca_valid = TRUE;
  ptr->reg_lte_cphy_ca = reg_lte_cphy_ca;
}
...
/*
  QMI_NAS_SET_NR5G_FULL_VOICE_SUPPORT_REQ_MSG_V01
*/
void ril_utf_qmiril_if::update_default_qmi_nas_set_nr5g_full_voice_support_req_msg(void)
{
  payload = (void *) malloc(sizeof(nas_set_nr5g_full_voice_support_req_msg_v01));
  payload_len = sizeof(nas_set_nr5g_full_voice_support_req_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  verify_payload = false;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_NR5G_FULL_VOICE_SUPPORT_REQ_MSG_V01;
  status = not_met;
}
void ril_utf_qmiril_if::set_qmi_nas_set_nr5g_full_voice_support_req_nr5g_full_voice_support
  (nas_nr5g_full_voice_support_enum_type_v01 nr5g_full_voice_support)
{
  nas_set_nr5g_full_voice_support_req_msg_v01* ptr =
    (nas_set_nr5g_full_voice_support_req_msg_v01 *) payload;
  ptr->nr5g_full_voice_support = nr5g_full_voice_support;
}
void ril_utf_qmiril_if::update_default_qmi_nas_set_nr5g_full_voice_support_resp_msg(void)
{
  payload = (void *) malloc(sizeof(nas_set_nr5g_full_voice_support_resp_msg_v01));
  payload_len = sizeof(nas_set_nr5g_full_voice_support_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_NR5G_FULL_VOICE_SUPPORT_REQ_MSG_V01;
}
void ril_utf_qmiril_if::set_qmi_nas_set_nr5g_full_voice_support_resp_msg_result
  (qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  nas_set_nr5g_full_voice_support_resp_msg_v01 *ptr =
    (nas_set_nr5g_full_voice_support_resp_msg_v01 *) payload;
  ptr->resp.result = result;
  ptr->resp.error = error;
}

/*
  QMI_NAS_GET_NR5G_FULL_VOICE_SUPPORT_REQ_MSG_V01
*/
void ril_utf_qmiril_if::update_default_qmi_nas_get_nr5g_full_voice_support_req_msg(void)
{
  payload = (void *) malloc(sizeof(nas_get_nr5g_full_voice_support_req_msg_v01));
  payload_len = sizeof(nas_get_nr5g_full_voice_support_req_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  verify_payload = false;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_NR5G_FULL_VOICE_SUPPORT_REQ_MSG_V01;
  status = not_met;
}
void ril_utf_qmiril_if::update_default_qmi_nas_get_nr5g_full_voice_support_resp_msg(void)
{
  payload = (void *) malloc(sizeof(nas_get_nr5g_full_voice_support_resp_msg_v01));
  payload_len = sizeof(nas_get_nr5g_full_voice_support_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_NR5G_FULL_VOICE_SUPPORT_REQ_MSG_V01;
}
void ril_utf_qmiril_if::set_qmi_nas_get_nr5g_full_voice_support_resp_msg_result
  (qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  nas_get_nr5g_full_voice_support_resp_msg_v01 *ptr =
    (nas_get_nr5g_full_voice_support_resp_msg_v01 *) payload;
  ptr->resp.result = result;
  ptr->resp.error = error;
}
void ril_utf_qmiril_if::set_qmi_nas_get_nr5g_full_voice_support_resp_nas_nr5g_full_voice_support
  (nas_nr5g_full_voice_support_enum_type_v01 nr5g_full_voice_support)
{
  nas_get_nr5g_full_voice_support_resp_msg_v01 *ptr =
    (nas_get_nr5g_full_voice_support_resp_msg_v01 *) payload;
  ptr->nr5g_full_voice_support_valid = TRUE;
  ptr->nr5g_full_voice_support = nr5g_full_voice_support;
}
...
void ril_utf_qmiril_if::set_qmi_voice_ind_req_srtp_status_info_event(uint8_t srtp_status_info_event)
{
  voice_indication_register_req_msg_v02 *ptr = (voice_indication_register_req_msg_v02 *) payload;
  ptr->srtp_status_info_event_valid = TRUE;
  ptr->srtp_status_info_event = srtp_status_info_event;
}
#endif
...
void ril_utf_qmiril_if::set_voice_get_call_barring_resp_additional_msg_is_pwd_req(uint8_t isReq)
{
  voice_get_call_barring_resp_msg_v02* ptr = (voice_get_call_barring_resp_msg_v02 *)payload;
  ptr->is_cb_password_required_valid = TRUE;
  ptr->is_cb_password_required = isReq;
}
...
voice_dc_call_info_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_data_channel_type(uint32_t len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->dc_call_info_valid = TRUE;
  ptr->dc_call_info_len= len;
  return (ptr->dc_call_info);
}
...
voice_call_reason_type_v02*
ril_utf_qmiril_if::set_qmi_voice_all_call_status_ind_call_reason(uint32_t call_reason_len)
{
  voice_all_call_status_ind_msg_v02 *ptr = (voice_all_call_status_ind_msg_v02 *) payload;
  ptr->call_reason_valid = TRUE;
  ptr->call_reason_len = call_reason_len;
  return (ptr->call_reason);
}
...
nas_set_system_selection_preference_req_msg_v01*
ril_utf_qmiril_if::update_default_qmi_nas_set_system_selection_preference_req_msg()
{
  ...
  return (nas_set_system_selection_preference_req_msg_v01*)payload;
}
...
nas_3gpp_srv_status_info_type_v01*
ril_utf_qmiril_if::set_qmi_nas_get_sys_info_resp_nr5g_srv_status_info()
{
  nas_get_sys_info_resp_msg_v01* ptr = (nas_get_sys_info_resp_msg_v01*)payload;
  ptr->nr5g_srv_status_info_valid = TRUE;
  return &(ptr->nr5g_srv_status_info);
}
...
nas_nr5g_sys_info_type_v01* ril_utf_qmiril_if::set_qmi_nas_get_sys_info_resp_nr5g_sys_info()
{
  nas_get_sys_info_resp_msg_v01* ptr = (nas_get_sys_info_resp_msg_v01*)payload;
  ptr->nr5g_sys_info_valid = TRUE;
  return &(ptr->nr5g_sys_info);
}
...
nas_indication_register_req_msg_v01* ril_utf_qmiril_if::update_default_qmi_nas_indication_register_req_msg_v()
{
  payload = (void *) malloc(sizeof(nas_indication_register_req_msg_v01));
  payload_len = sizeof(nas_indication_register_req_msg_v01);
  memset(payload, 0x00, payload_len);
...
void ril_utf_qmiril_if::set_qmi_nas_set_indication_register_req_reg_ssac_change_info(uint8_t reg_ssac_change_info)
{
  nas_indication_register_req_msg_v01 *ptr = (nas_indication_register_req_msg_v01 *) payload;
  ptr->reg_ssac_change_info_valid = TRUE;
  ptr->reg_ssac_change_info = reg_ssac_change_info;
}

void ril_utf_qmiril_if::set_qmi_nas_set_indication_register_req_reg_cell_barring_info(uint8_t reg_cell_barring_info)
{
  nas_indication_register_req_msg_v01 *ptr = (nas_indication_register_req_msg_v01 *) payload;
  ptr->reg_cell_barring_info_valid = TRUE;
  ptr->reg_cell_barring_info = reg_cell_barring_info;
}

void ril_utf_qmiril_if::set_qmi_nas_set_indication_register_req_reg_access_barring_status(uint8_t eg_access_barring_status)
{
  nas_indication_register_req_msg_v01 *ptr = (nas_indication_register_req_msg_v01 *) payload;
  ptr->reg_access_barring_status_valid = TRUE;
  ptr->reg_access_barring_status = eg_access_barring_status;
}

void ril_utf_qmiril_if::set_qmi_nas_set_indication_register_req_reg_acb_info_change(uint8_t reg_acb_info_change)
{
  nas_indication_register_req_msg_v01 *ptr = (nas_indication_register_req_msg_v01 *) payload;
  ptr->reg_acb_info_change_valid = TRUE;
  ptr->reg_acb_info_change = reg_acb_info_change;
}
...
void ril_utf_qmiril_if::set_qmi_nas_sys_info_ind_wcdma_signalling_bar_status()
{
  nas_sys_info_ind_msg_v01 *ptr = (nas_sys_info_ind_msg_v01 *) payload;
  ptr->wcdma_cs_signalling_bar_status_valid = TRUE;
  ptr->wcdma_cs_signalling_bar_status = TRUE;
  ptr->wcdma_ps_signalling_bar_status_valid = TRUE;
  ptr->wcdma_ps_signalling_bar_status = TRUE;
}
...
nas_network_time_type_v01* ril_utf_qmiril_if::set_qmi_nas_get_network_time_resp_nas_3gpp2_time()
{
  nas_get_network_time_resp_msg_v01 *ptr = (nas_get_network_time_resp_msg_v01*) payload;
  ptr->nas_3gpp2_time_valid = TRUE;
  return &(ptr->nas_3gpp2_time);
}
...
void ril_utf_qmiril_if::set_qmi_nas_lte_sib16_network_time_ind_universal_time
  (nas_lte_sib16_julian_time_type_v01 universal_time)
{
  nas_lte_sib16_network_time_ind_msg_v01 *ptr =
    (nas_lte_sib16_network_time_ind_msg_v01*) payload;
...
void ril_utf_qmiril_if::set_qmi_nas_lte_sib16_network_time_ind_time_zone(int8_t val)
{
  nas_lte_sib16_network_time_ind_msg_v01 *ptr = (nas_lte_sib16_network_time_ind_msg_v01 *) payload;
  ptr->time_zone_valid = TRUE;
  ptr->time_zone = val;
}

void ril_utf_qmiril_if::set_qmi_nas_lte_sib16_network_time_ind_daylight_saving_time(int8_t val)
{
  nas_lte_sib16_network_time_ind_msg_v01 *ptr = (nas_lte_sib16_network_time_ind_msg_v01 *) payload;
  ptr->daylt_sav_adj_valid = TRUE;
  ptr->daylt_sav_adj = val;
...
void ril_utf_qmiril_if::set_qmi_dms_get_band_capability_resp_supported_lte_bands()
{
  dms_get_band_capability_resp_msg_v01 *ptr = (dms_get_band_capability_resp_msg_v01 *) payload;
  ptr->supported_lte_bands_valid = TRUE;
  ptr->supported_lte_bands_len = 3;
...
char* ril_utf_qmiril_if::update_default_qmi_dms_get_msisdn_resp_msg(qmi_result_type_v01 result,qmi_error_type_v01 error)
{
  ...
  payload_type = ril_utf_qmi_response;
  service_id = QMI_DMS;
  msg_id = QMI_DMS_GET_MSISDN_RESP_V01;
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imss_get_c_iwlan_status_req(void)
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_IMSS;
  msg_id = QMI_IMS_SETTINGS_GET_C_IWLAN_STATUS_REQ_V01;
}

/*========================================================
  QMI_IMS_SETTINGS_GET_C_IWLAN_STATUS_RSP_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_imss_get_c_iwlan_status_rsp(void)
{
  payload = (void *) malloc(sizeof(ims_settings_get_c_iwlan_status_rsp_msg_v01));
  payload_len = sizeof(ims_settings_get_c_iwlan_status_rsp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_IMSS;
  msg_id = QMI_IMS_SETTINGS_GET_C_IWLAN_STATUS_RSP_V01;
}

void ril_utf_qmiril_if::set_qmi_imss_get_c_iwlan_status_rsp_v01
  (qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  ims_settings_get_c_iwlan_status_rsp_msg_v01 *ptr = (ims_settings_get_c_iwlan_status_rsp_msg_v01*) payload;
  ptr->resp.result = result;
  ptr->resp.error = error;
}

void ril_utf_qmiril_if::set_qmi_imss_get_c_iwlan_status_rsp_c_iwlan_mode_home(ims_settings_c_iwlan_mode_enum_v01 val)
{
  ims_settings_get_c_iwlan_status_rsp_msg_v01 *ptr = (ims_settings_get_c_iwlan_status_rsp_msg_v01*) payload;
  ptr->c_iwlan_mode_in_home_valid = TRUE;
  ptr->c_iwlan_mode_in_home = val;
}

void ril_utf_qmiril_if::set_qmi_imss_get_c_iwlan_status_rsp_c_iwlan_mode_roam(ims_settings_c_iwlan_mode_enum_v01 val)
{
  ims_settings_get_c_iwlan_status_rsp_msg_v01 *ptr = (ims_settings_get_c_iwlan_status_rsp_msg_v01*) payload;
  ptr->c_iwlan_mode_in_roam_valid = TRUE;
  ptr->c_iwlan_mode_in_roam = val;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_sar_rf_set_state_req(qmi_sar_rf_state_enum_type_v01 state)
{
  payload = (sar_rf_set_state_req_msg_v01 *)qcril_malloc(sizeof(sar_rf_set_state_req_msg_v01));
  payload_len = sizeof(sar_rf_set_state_req_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_RF_SAR;
  msg_id = QMI_SAR_RF_SET_STATE_REQ_MSG_V01;
  sar_rf_set_state_req_msg_v01 *ptr = (sar_rf_set_state_req_msg_v01 *) payload;
  ptr->sar_rf_state = state;
}
void ril_utf_qmiril_if::set_qmi_sar_rf_set_state_req_compatibility_key(uint32_t val)
{
  sar_rf_set_state_req_msg_v01 *ptr = (sar_rf_set_state_req_msg_v01*) payload;
  ptr->compatibility_key_valid = TRUE;
  ptr->compatibility_key = val;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_sar_rf_set_state_resp(qmi_result_type_v01 result,qmi_error_type_v01 error)
{
  payload = (sar_rf_set_state_resp_msg_v01 *)qcril_malloc(sizeof(sar_rf_set_state_resp_msg_v01));
  payload_len = sizeof(sar_rf_set_state_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_RF_SAR;
  msg_id = QMI_SAR_RF_SET_STATE_RESP_MSG_V01;

  sar_rf_set_state_resp_msg_v01 *ptr = (sar_rf_set_state_resp_msg_v01 *) payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}
...
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_sar_rf_get_compatibility_key_req()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_RF_SAR;
  msg_id = QMI_SAR_GET_COMPATIBILITY_KEY_REQ_MSG_V01;
}

/*========================================================
  QMI_SAR_GET_COMPATIBILITY_KEY_RESP_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_sar_rf_get_compatibility_key_resp(qmi_result_type_v01 result,qmi_error_type_v01 error)
{
  payload = (sar_rf_get_compatibility_key_resp_msg_v01 *)qcril_malloc(sizeof(sar_rf_get_compatibility_key_resp_msg_v01));
  payload_len = sizeof(sar_rf_get_compatibility_key_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_RF_SAR;
  msg_id = QMI_SAR_GET_COMPATIBILITY_KEY_RESP_MSG_V01;

  sar_rf_get_compatibility_key_resp_msg_v01 *ptr = (sar_rf_get_compatibility_key_resp_msg_v01 *) payload;
  ptr->resp.error = error;
  ptr->resp.result= result;
}
void ril_utf_qmiril_if::set_qmi_sar_rf_get_compatibility_key_resp_compatibility_key(uint32_t val)
{
  sar_rf_get_compatibility_key_resp_msg_v01 *ptr = (sar_rf_get_compatibility_key_resp_msg_v01*) payload;
  ptr->compatibility_key_valid = TRUE;
  ptr->compatibility_key = val;
...
/*========================================================
  QMI_NAS_SET_MSIM_PREFERENCE_REQ_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_set_msim_preference_req(nas_msim_preference_enum_type_v01 pref) {
  payload_len = sizeof(nas_set_msim_preference_req_msg_v01);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_qmi_request;
  ((nas_set_msim_preference_req_msg_v01*)payload)->msim_preference = pref;

  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_MSIM_PREFERENCE_REQ_MSG_V01;
}
/*========================================================
  QMI_NAS_SET_MSIM_PREFERENCE_RESP_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_set_msim_preference_resp(qmi_result_type_v01 res, qmi_error_type_v01 err) {
  payload_len = sizeof(nas_set_msim_preference_resp_msg_v01);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);

  nas_set_msim_preference_resp_msg_v01* ptr = (nas_set_msim_preference_resp_msg_v01*)payload;
  ptr->resp.result = res;
  ptr->resp.error = err;

  payload_type = ril_utf_qmi_response;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_MSIM_PREFERENCE_RESP_MSG_V01;
}

/*========================================================
  QMI_NAS_SET_ENDC_CONFIG_REQ_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_req_set_endc_config(uint8_t enable)
{
  payload_len = sizeof(nas_set_endc_config_req_msg_v01);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_qmi_request;
  ((nas_set_endc_config_req_msg_v01*)payload)->enable_endc = enable;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_ENDC_CONFIG_REQ_MSG_V01;
}
void ril_utf_qmiril_if::update_default_qmi_nas_req_set_endc_config_resp(qmi_result_type_v01 result,
                                                                        qmi_error_type_v01 error)
{
  payload_len = sizeof(nas_set_endc_config_resp_msg_v01);
  payload = malloc(payload_len);
  memset(payload, 0x0, payload_len);
  payload_type = ril_utf_qmi_response;
  nas_set_endc_config_resp_msg_v01* ptr = (nas_set_endc_config_resp_msg_v01*)payload;
  ptr->resp.result = result;
  ptr->resp.error = error;

  service_id = QMI_NAS;
  msg_id = QMI_NAS_SET_ENDC_CONFIG_RESP_MSG_V01;
}

/*========================================================
  QMI_NAS_GET_ENDC_CONFIG_REQ_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_req_get_endc_config()
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_ENDC_CONFIG_REQ_MSG_V01;
}
/*========================================================
  QMI_NAS_GET_ENDC_CONFIG_RESP_MSG_V01
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_nas_req_get_endc_config_resp(uint8_t enable,
                                                                        qmi_result_type_v01 result,
                                                                        qmi_error_type_v01 error)
{
  payload_len = sizeof(nas_get_endc_config_resp_msg_v01);
  payload = malloc(payload_len);
  payload_type = ril_utf_qmi_response;
  memset(payload, 0x0, payload_len);
  nas_get_endc_config_resp_msg_v01* ptr = ((nas_get_endc_config_resp_msg_v01*)payload);
  ptr->enable_endc = enable;
  ptr->enable_endc_valid = TRUE;
  ptr->resp.result = result;
  ptr->resp.error = error;

  service_id = QMI_NAS;
  msg_id = QMI_NAS_GET_ENDC_CONFIG_RESP_MSG_V01;
}

nas_cag_nw_info_type_v01*
ril_utf_qmiril_if::set_qmi_nas_perform_incremental_network_scan_ind_nas_network_scan_info_cag_info(
    uint32_t len)
{
  nas_perform_incremental_network_scan_ind_msg_v01* ptr =
      (nas_perform_incremental_network_scan_ind_msg_v01*)payload;
  ptr->cag_info_valid = TRUE;
  ptr->cag_info_len = len;
  return ptr->cag_info;
}
void ril_utf_qmiril_if::set_qmi_nas_perform_incremental_network_scan_req_search_type(
    nas_nw_search_type_enum_v01 val)
{
  nas_perform_incremental_network_scan_req_msg_v01* ptr =
      (nas_perform_incremental_network_scan_req_msg_v01*)payload;
  ptr->search_type_valid = TRUE;
  ptr->search_type = val;
}
uint8_t* ril_utf_qmiril_if::set_qmi_nas_perform_incremental_network_scan_ind_cag_only_access(
    uint32_t len)
{
  nas_perform_incremental_network_scan_ind_msg_v01* ptr =
      (nas_perform_incremental_network_scan_ind_msg_v01*)payload;
  ptr->cag_only_access_valid = TRUE;
  ptr->cag_only_access_len = len;
  return ptr->cag_only_access;
}
...
/*========================================================
  QMI_VOICE_SRTP_STATUS_IND_V02
========================================================*/
void ril_utf_qmiril_if::update_default_qmi_voice_srtp_encryption_status_msg(void)
{
  payload = (voice_srtp_status_ind_msg_v02 *) malloc(sizeof(voice_srtp_status_ind_msg_v02));
  payload_len = sizeof(voice_srtp_status_ind_msg_v02);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_VOICE;
  msg_id = QMI_VOICE_SRTP_STATUS_IND_V02;
}

void ril_utf_qmiril_if::set_qmi_voice_srtp_encryption_call_id(uint8_t call_id)
{
  voice_srtp_status_ind_msg_v02 *ptr = (voice_srtp_status_ind_msg_v02*) payload;
  ptr->srtp_status_info.call_id = call_id;
}

void ril_utf_qmiril_if::set_qmi_voice_srtp_encryption_category_voice(boolean enable)
{
  voice_srtp_status_ind_msg_v02 *ptr = (voice_srtp_status_ind_msg_v02*) payload;
  if (enable) {
    ptr->srtp_status_info.audio_srtp = 1;
  }else {
    ptr->srtp_status_info.audio_srtp = 0;
  }
}

void ril_utf_qmiril_if::set_qmi_voice_srtp_encryption_category_video(boolean enable)
{
  voice_srtp_status_ind_msg_v02 *ptr = (voice_srtp_status_ind_msg_v02*) payload;
  if (enable) {
    ptr->srtp_status_info.video_srtp = 1;
  }else {
    ptr->srtp_status_info.video_srtp = 0;
  }
}

void ril_utf_qmiril_if::set_qmi_voice_srtp_encryption_category_text(boolean enable)
{
  voice_srtp_status_ind_msg_v02 *ptr = (voice_srtp_status_ind_msg_v02*) payload;
  if (enable) {
    ptr->srtp_status_info.text_srtp = 1;
  }else {
    ptr->srtp_status_info.text_srtp = 0;
  }
}
...
void ril_utf_qmiril_if::update_default_qmi_pbm_get_all_pb_capabilities_req(void)
{
  payload = NULL;
  payload_len = 0;
  payload_type = ril_utf_qmi_request;
  service_id = QMI_PBM;
  msg_id = QMI_PBM_GET_ALL_PB_CAPABILITIES_REQ_V01;
}

void ril_utf_qmiril_if::update_default_qmi_pbm_get_all_pb_capabilities_resp(qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  payload = (void*)malloc(sizeof(pbm_get_all_pb_capabilities_resp_msg_v01));
  assert(payload != nullptr);
  payload_len = sizeof(pbm_get_all_pb_capabilities_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_PBM;
  msg_id = QMI_PBM_GET_ALL_PB_CAPABILITIES_RESP_V01;

  pbm_get_all_pb_capabilities_resp_msg_v01 *ptr = (pbm_get_all_pb_capabilities_resp_msg_v01 *) payload;
  ptr->resp.error = error;
  ptr->resp.result = result;

  ptr->pb_set_info_array_valid = 1;
  ptr->pb_set_info_array_len = 1;
  ptr->pb_set_info_array[0].pb_set_info.num_of_pb_sets = 1;
  ptr->pb_set_info_array[0].pb_set_info.pbset_caps[0].adn_caps.max_adn_records = 1;
  ptr->pb_set_info_array[0].session_type = (pbm_session_type_enum_v01) 0;
}

void ril_utf_qmiril_if::update_default_qmi_pbm_read_records_ext_req(int adn_count, int session_type)
{
  payload = (void*)malloc(sizeof(pbm_read_records_ext_req_msg_v01));
  assert(payload != nullptr);
  payload_len = sizeof(pbm_read_records_ext_req_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_request;
  service_id = QMI_PBM;
  msg_id = QMI_PBM_READ_RECORDS_EXT_REQ_V01;

  pbm_read_records_ext_req_msg_v01 * ptr = (pbm_read_records_ext_req_msg_v01 *) payload;
  ptr->record_info.pb_type = PBM_PB_TYPE_ADN_V01;
  ptr->record_info.session_type = (pbm_session_type_enum_v01) session_type;
  ptr->record_info.record_start_id = 1;
  ptr->record_info.record_end_id = adn_count;
}

void ril_utf_qmiril_if::update_default_qmi_pbm_read_records_ext_resp(qmi_result_type_v01 result, qmi_error_type_v01 error)
{
  payload = (void*)malloc(sizeof(pbm_read_records_ext_resp_msg_v01));
  assert(payload != nullptr);
  payload_len = sizeof(pbm_read_records_ext_resp_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_response;
  service_id = QMI_PBM;
  msg_id = QMI_PBM_READ_RECORDS_EXT_RESP_V01;

  pbm_read_records_ext_resp_msg_v01 *ptr = (pbm_read_records_ext_resp_msg_v01 *) payload;
  ptr->resp.error = error;
  ptr->resp.result = result;

  ptr->num_of_recs_valid = 1;
}

/*========================================================
  QMI_NAS_CELL_BARRING_INFO_IND_MSG_V01
========================================================*/
nas_cell_barring_info_ind_msg_v01* ril_utf_qmiril_if::update_cell_barring_info_ind_msg()
{
  payload = (nas_cell_barring_info_ind_msg_v01 *) malloc(sizeof(nas_cell_barring_info_ind_msg_v01));
  payload_len = sizeof(nas_cell_barring_info_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_CELL_BARRING_INFO_IND_MSG_V01;

  return (nas_cell_barring_info_ind_msg_v01 *)payload;
}

/*========================================================
  QMI_NAS_ACCESS_BARRING_STATUS_IND_MSG_V01
========================================================*/
nas_access_barring_status_ind_msg_v01* ril_utf_qmiril_if::update_access_barring_status_ind_msg()
{
  payload = (nas_access_barring_status_ind_msg_v01 *) malloc(sizeof(nas_access_barring_status_ind_msg_v01));
  payload_len = sizeof(nas_access_barring_status_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_ACCESS_BARRING_STATUS_IND_MSG_V01;

  return (nas_access_barring_status_ind_msg_v01 *)payload;
}

/*========================================================
  QMI_NAS_ACB_INFO_IND_V01
========================================================*/
nas_acb_info_ind_msg_v01* ril_utf_qmiril_if::update_acb_info_ind_msg()
{
  payload = (nas_acb_info_ind_msg_v01*)malloc(sizeof(nas_acb_info_ind_msg_v01));
  payload_len = sizeof(nas_acb_info_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_ACB_INFO_IND_V01;

  return (nas_acb_info_ind_msg_v01*)payload;
}

/*========================================================
  QMI_NAS_SSAC_CHANGE_INFO_IND_V01
========================================================*/
nas_ssac_change_info_ind_msg_v01* ril_utf_qmiril_if::update_ssac_change_info_ind_msg()
{
  payload = (nas_ssac_change_info_ind_msg_v01*)malloc(sizeof(nas_ssac_change_info_ind_msg_v01));
  payload_len = sizeof(nas_ssac_change_info_ind_msg_v01);
  memset(payload, 0x00, payload_len);
  payload_type = ril_utf_qmi_indication;
  service_id = QMI_NAS;
  msg_id = QMI_NAS_SSAC_CHANGE_INFO_IND_V01;

  return (nas_ssac_change_info_ind_msg_v01*)payload;
}
