...
test_result ril_utf_ims_config_ims_service_enable_config_001(user_specified_attrib_t attr)
{
  ...
  std::vector<ImsConfigRequest> testReqVector {
     ...
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
        req.item = ims_ConfigItem_CONFIG_ITEM_DATA_CHANNEL_ID;
        req.has_intValue = TRUE;
        req.intValue = 1;  //ENABLED
      },
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.data_channel_config_enabled_valid = TRUE;
        req.data_channel_config_enabled = TRUE;
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.data_channel_config_enabled_valid = TRUE;
        resp.data_channel_config_enabled = TRUE;
      }),
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
      ...
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.data_channel_config_enabled_valid = TRUE;
        req.data_channel_config_enabled = FALSE;
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.data_channel_config_enabled_valid = TRUE;
        resp.data_channel_config_enabled = FALSE;
      }),
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
        req.item = ims_ConfigItem_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_HOME;
        req.has_intValue = TRUE;
        req.intValue = 1;
      },
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.service_mask_by_network_enabled_valid = TRUE;
        req.service_mask_by_network_enabled =
          IMS_SETTINGS_OMADM_SERVICES_VOLTE_RESTRICT_BIT_MASK_V01;
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.service_mask_by_network_enabled_valid = TRUE;
        resp.service_mask_by_network_enabled =
     ...
     ImsConfigRequest(
      ...
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.service_mask_by_network_enabled_valid = TRUE;
        req.service_mask_by_network_enabled =
          IMS_SETTINGS_OMADM_SERVICES_BIT_MASK_NONE_V01; // previous service_mask_by_network_enabled & ~(IMS_SETTINGS_OMADM_SERVICES_VOLTE_RESTRICT_BIT_MASK_V01)
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.service_mask_by_network_enabled_valid = TRUE;
        resp.service_mask_by_network_enabled =
     ...
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
        req.item = ims_ConfigItem_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_ROAMING;
        req.has_intValue = TRUE;
        req.intValue = 1;
      },
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.service_mask_by_network_enabled_valid = TRUE;
        req.service_mask_by_network_enabled =
          IMS_SETTINGS_OMADM_SERVICES_VOLTE_RESTRICT_ROAMING_BIT_MASK_V01;
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.service_mask_by_network_enabled_valid = TRUE;
        resp.service_mask_by_network_enabled =
     ...
     ImsConfigRequest(
      ...
      [](ims_settings_set_ims_service_enable_config_req_msg_v01 &req) -> void {
        req.service_mask_by_network_enabled_valid = TRUE;
        req.service_mask_by_network_enabled =
          IMS_SETTINGS_OMADM_SERVICES_BIT_MASK_NONE_V01; // previous service_mask_by_network_enabled & ~(IMS_SETTINGS_OMADM_SERVICES_VOLTE_RESTRICT_ROAMING_BIT_MASK_V01)
      },
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.service_mask_by_network_enabled_valid = TRUE;
        resp.service_mask_by_network_enabled =
...
test_result ril_utf_ims_config_ims_service_enable_config_002(user_specified_attrib_t attr)
{
  ...
  std::vector<ImsConfigRequest> testReqVector {
     ...
     ImsConfigRequest(
      ...
      [](ims_settings_get_ims_service_enable_config_rsp_msg_v01 &resp) -> void {
        resp.service_mask_by_network_enabled_valid = FALSE;
      }),
     ImsConfigRequest(
      [](ims_ConfigMsg &req) -> void {
        req.has_item = TRUE;
...
test_result ril_utf_ims_query_multi_sim_voice_capability(user_specified_attrib_t attr) {
  ...
  // Expect: ims_MsgId_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
  IMS_node.update_default_ims_unsol_multi_sim_voice_capability_changed(ims_Voice_Capability_NONE);
  t.expect(IMS_node);
  ...
  // Expect: ims_MsgId_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
  IMS_node.update_default_ims_unsol_multi_sim_voice_capability_changed(ims_Voice_Capability_DSSS);
  t.expect(IMS_node);
  ...
  // Expect: ims_MsgId_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
  IMS_node.update_default_ims_unsol_multi_sim_voice_capability_changed(ims_Voice_Capability_DSDS);
  t.expect(IMS_node);
  ...
  // Expect: ims_MsgId_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
  IMS_node.update_default_ims_unsol_multi_sim_voice_capability_changed(
                                    ims_Voice_Capability_PSEUDO_DSDA);
  t.expect(IMS_node);
  ...
  // Expect: ims_MsgId_UNSOL_MULTI_SIM_VOICE_CAPABILITY_CHANGED
  IMS_node.update_default_ims_unsol_multi_sim_voice_capability_changed(ims_Voice_Capability_DSDA);
  t.expect(IMS_node);
