...
test_result ril_utf_ims_srv_status_update_001(user_specified_attrib_t attr)
{
  ...
  IMS_node.set_ims_unsol_srv_status_update_sms_service(0, IMSA_FULL_SERVICE_V01, TRUE,
      IMSA_WWAN_V01);
  IMS_node.set_ims_unsol_srv_status_update_voip_service(1, IMSA_NO_SERVICE_V01, FALSE, 0);
  IMS_node.set_ims_unsol_srv_status_update_vt_service(2, IMSA_NO_SERVICE_V01, FALSE, 0);
  IMS_node.set_ims_unsol_srv_status_update_ut_service(5, IMSA_NO_SERVICE_V01, FALSE, 0);
  t.expect(IMS_node);
...
test_result ril_utf_ims_srv_status_update_003(user_specified_attrib_t attr)
{
  ...
  // Expect: ims_MsgId_UNSOL_SRV_STATUS_UPDATE
  IMS_node.update_default_ims_unsol_srv_status_update(6);
  IMS_node.set_ims_unsol_srv_status_update_sms_service(0, IMSA_LIMITED_SERVICE_V01, TRUE,
      IMSA_IWLAN_V01);
  IMS_node.set_ims_unsol_srv_status_update_voip_service(1, IMSA_NO_SERVICE_V01, FALSE, 0);
  IMS_node.set_ims_unsol_srv_status_update_vt_service(2, IMSA_NO_SERVICE_V01, FALSE, 0);
  IMS_node.set_ims_unsol_srv_status_update_ut_service(5, IMSA_NO_SERVICE_V01, FALSE, 0);
...
test_result ril_utf_ims_srv_status_update_004(user_specified_attrib_t attr)
{
  ...
  // Expect: ims_MsgId_UNSOL_SRV_STATUS_UPDATE
  IMS_node.update_default_ims_unsol_srv_status_update(6);
  IMS_node.set_ims_unsol_srv_status_update_sms_service(0, IMSA_NO_SERVICE_V01, FALSE, 0);
  IMS_node.set_ims_unsol_srv_status_update_voip_service(1, IMSA_NO_SERVICE_V01, FALSE, 0);
  IMS_node.set_ims_unsol_srv_status_update_vt_service(2, IMSA_NO_SERVICE_V01, FALSE, 0);
  IMS_node.set_ims_unsol_srv_status_update_ut_service(5, IMSA_NO_SERVICE_V01, FALSE, 0);
  t.expect(IMS_node);
...
test_result ril_utf_test_ims_sub_config_001(user_specified_attrib_t attr)
{
  ...
  uint64_t ims_stack_1[2] = {1, 0};
  IMS_node.set_ims_unsol_ims_sub_config_changed_imsStackEnabled(ims_stack_1, 1);
  t.expect(IMS_node);
...
test_result ril_utf_test_ims_sub_config_002(user_specified_attrib_t attr)
{
  ...
  IMS_node.update_default_ims_unsol_ims_sub_config_changed();
  IMS_node.set_ims_unsol_ims_sub_config_changed_simultStackCount(1);
  IMS_node.set_ims_unsol_ims_sub_config_changed_imsStackEnabled(ims_stack, 2);
  t.expect(IMS_node);
