...
void ril_utf_bootup_helper(Testcase &t, int boot_config)
{
  ...
  // Clear ICCID CLIR PREF Table
  DB_node.utf_db_clear_iccid_clir_pref_table(0);
  t.inject(DB_node);
  ...
  */
  ...
  // Expect: QMI_VOICE_INDICATION_REGISTER_REQ
  QMI_node.update_default_qmi_voice_ind_reg_req_msg();
  QMI_node.set_qmi_voice_ind_req_srtp_status_info_event(0x01);
  t.expect(QMI_node);
  ...
  uim_get_label_req_msg_v01* label_req0;
  uint8_t aid_value_0[16] = {0xA0,0x00,0x00,0x00,0x87,0x10,0x02,0xF3,
                             0x10,0xFF,0xFF,0x89,0x08,0x00,0x00,0xFF};
  label_req0 = QMI_node.update_default_qmi_uim_get_label_req();
  label_req0->application_information.slot = (uim_slot_enum_v01)0x01;
  label_req0->application_information.aid_len = 0x10;
  memcpy(label_req0->application_information.aid, aid_value_0, 16);
  t.expect(QMI_node);

  // Inject: QMI_UIM_GET_LABEL_RESP
  uim_get_label_resp_msg_v01* label_resp0;
  label_resp0 = QMI_node.update_default_qmi_uim_get_label_resp();
  label_resp0->resp.result = QMI_RESULT_SUCCESS_V01;
  strlcpy(label_resp0->label, "USIM", 5);
  label_resp0->label_len = 4;
  label_resp0->label_valid = TRUE;
  t.inject(QMI_node);

  // Expect: QMI_UIM_GET_LABEL_REQ
  uim_get_label_req_msg_v01* label_req1;
  uint8_t aid_value_1[16] = {0xA0,0x00,0x00,0x00,0x87,0x10,0x04,0xF3,
                             0x10,0xFF,0xFF,0x89,0x08,0x00,0x00,0xFF};
  ...
  // Inject: QMI_UIM_GET_LABEL_RESP
  uim_get_label_resp_msg_v01* label_response1;
  label_response1 = QMI_node.update_default_qmi_uim_get_label_resp();
  label_response1->resp.result = QMI_RESULT_SUCCESS_V01;
  strlcpy(label_response1->label, "USIM", 5);
  label_response1->label_len = 4;
  label_response1->label_valid = TRUE;
  t.inject(QMI_node);

  // Expect: QMI_UIM_GET_LABEL_REQ
  uim_get_label_req_msg_v01* label_req2;
  uint8_t aid_value_2[16] = {0xA0,0x00,0x00,0x03,0x43,0x10,0x02,0xF3,
                             0x10,0xFF,0xFF,0x89,0x02,0x00,0x00,0xFF};
  ...
  memcpy(label_req2->application_information.aid, aid_value_2, 16);
  t.expect(QMI_node);

  // Inject: QMI_UIM_GET_LABEL_RESP
  uim_get_label_resp_msg_v01* label_resp2;
  label_resp2 = QMI_node.update_default_qmi_uim_get_label_resp();
  label_resp2->resp.result = QMI_RESULT_SUCCESS_V01;
  strlcpy(label_resp2->label, "USIM", 5);
  label_resp2->label_len = 4;
  label_resp2->label_valid = TRUE;
  t.inject(QMI_node);

  // Expect: QMI_UIM_GET_LABEL_REQ
  uim_get_label_req_msg_v01* label_req3;
  uint8_t aid_value_3[12] = {0xA0,0x00,0x00,0x00,0x63,0x50,
  ...
  label_req3->application_information.aid_len = 0xC;
  memcpy(label_req3->application_information.aid, aid_value_3, 12);
  t.expect(QMI_node);

  // Inject: QMI_UIM_GET_LABEL_RESP
  uim_get_label_resp_msg_v01* label_resp3;
  label_resp3 = QMI_node.update_default_qmi_uim_get_label_resp();
  label_resp3->resp.result = QMI_RESULT_SUCCESS_V01;
  strlcpy(label_resp3->label, "USIM", 5);
  label_resp3->label_len = 4;
  label_resp3->label_valid = TRUE;
  t.inject(QMI_node);
...
void ril_utf_bootup_radio_power_fail_helper(Testcase &t)
{
  ...
  // Expect QMI_UIM_GET_LABEL_REQ
  uim_get_label_req_msg_v01* label_req0;
  uint8_t aid_value_0[16] = {0xA0,0x00,0x00,0x00,0x87,0x10,0x02,0xF3,0x10,0xFF,0xFF,0x89,0x08,0x00,0x00,0xFF};
  label_req0 = QMI_node.update_default_qmi_uim_get_label_req();
  label_req0->application_information.slot = (uim_slot_enum_v01)0x01;
  label_req0->application_information.aid_len = 0x10;
  memcpy(label_req0->application_information.aid, aid_value_0, 16);
  ...
  // Expect: QMI_UIM_GET_LABEL_REQ
  uim_get_label_req_msg_v01* label_req1;
  uint8_t aid_value_1[16] = {0xA0,0x00,0x00,0x00,0x87,0x10,0x04,0xF3,0x10,0xFF,0xFF,0x89,0x08,0x00,0x00,0xFF};
  label_req1 = QMI_node.update_default_qmi_uim_get_label_req();
  label_req1->application_information.slot = (uim_slot_enum_v01)0x01;
  label_req1->application_information.aid_len = 0x10;
  memcpy(label_req1->application_information.aid, aid_value_1, 16);
  ...
  // Expect: QMI_UIM_GET_LABEL_REQ
  uim_get_label_req_msg_v01* label_req2;
  uint8_t aid_value_2[16] = {0xA0,0x00,0x00,0x03,0x43,0x10,0x02,0xF3,0x10,0xFF,0xFF,0x89,0x02,0x00,0x00,0xFF};
  label_req2 = QMI_node.update_default_qmi_uim_get_label_req();
  label_req2->application_information.slot = (uim_slot_enum_v01)0x01;
  label_req2->application_information.aid_len = 0x10;
  memcpy(label_req2->application_information.aid, aid_value_2, 16);
  ...
  // Expect: QMI_UIM_GET_LABEL_REQ
  uim_get_label_req_msg_v01* label_req3;
  uint8_t aid_value_3[12] = {0xA0,0x00,0x00,0x00,0x63,0x50,0x4B,0x43,0x53,0x2D,0x31,0x35};
  label_req3 = QMI_node.update_default_qmi_uim_get_label_req();
  label_req3->application_information.slot = (uim_slot_enum_v01)0x01;
  label_req3->application_information.aid_len = 0xC;
  memcpy(label_req3->application_information.aid, aid_value_3, 12);
