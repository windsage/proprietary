...
test_result ril_utf_test_add_iccid_clir_pref_001(user_specified_attrib_t attr);
test_result ril_utf_test_remove_iccid_clir_pref_001(user_specified_attrib_t attr);
test_result ril_utf_test_update_iccid_clir_pref(user_specified_attrib_t attr);
test_result ril_utf_test_query_oldest_iccid_clir_pref_001(user_specified_attrib_t attr);
//test_result ril_utf_test_update_iccid_clir_pref_sim_swap(user_specified_attrib_t attr);
...
test_result ril_utf_ims_mt_call_019(user_specified_attrib_t attr);
test_result ril_utf_ims_mt_call_020(user_specified_attrib_t attr);
...
test_result ril_utf_ims_auto_rejected_incoming_call_with_call_composer_b2c_ec_001(
    user_specified_attrib_t attr);
test_result ril_utf_ims_auto_rejected_incoming_call_with_data_channel_001(
    user_specified_attrib_t attr);
test_result ril_utf_ims_auto_rejected_incoming_call_with_call_reason(
    user_specified_attrib_t attr);
...
test_result ril_utf_ims_supp_service_status_pwd_req(user_specified_attrib_t attr);
...
test_result ril_utf_sms_mo_c_iwlan_001(user_specified_attrib_t attr);
test_result ril_utf_sms_mo_c_iwlan_002(user_specified_attrib_t attr);
...
test_result ril_utf_ims_3gpp_sms_status_report_001(user_specified_attrib_t attr);
...
test_result ril_utf_facility_lock_testcase_008(user_specified_attrib_t attr);
test_result ril_utf_facility_lock_testcase_009(user_specified_attrib_t attr);
...
test_result ril_utf_ims_registration_state_003(user_specified_attrib_t attr);
...
test_result ril_utf_test_qcril_req_hook_set_transmit_power_001(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_set_transmit_power_002(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_set_transmit_power_003(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_get_sar_rev_key_001(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_get_sar_rev_key_002(user_specified_attrib_t attr);
test_result ril_utf_test_qcril_req_hook_get_adn_record_001(user_specified_attrib_t attr);
...
test_result ril_utf_test_phone_capability_001(user_specified_attrib_t attr);
test_result ril_utf_test_phone_capability_002(user_specified_attrib_t attr);
test_result ril_utf_test_nr_sib9_testcase(user_specified_attrib_t attr);

test_result ril_utf_test_nr_sib9_testcase_001(user_specified_attrib_t attr);
test_result ril_utf_test_nr_sib9_testcase_002(user_specified_attrib_t attr);
test_result ril_utf_test_nr_sib9_testcase_003(user_specified_attrib_t attr);
test_result ril_utf_test_lte_sib16_testcase_001(user_specified_attrib_t attr);
test_result ril_utf_test_lte_sib16_testcase_002(user_specified_attrib_t attr);
test_result ril_utf_test_lte_sib16_testcase_003(user_specified_attrib_t attr);
test_result ril_utf_test_lte_sib16_testcase_004(user_specified_attrib_t attr);
test_result ril_utf_test_legacy_network_time_testcase_001(user_specified_attrib_t attr);
...
void util_test_enable_endc(Testcase& t,
...
void util_test_query_endc(Testcase& t,
                          AndroidTelTestnode& RIL_node,
                          QMIRILTestnode& QMI_node,
                          uint8_t qmi_endc,
                          endc_status ril_endc,
                          RIL_Errno err = RIL_E_SUCCESS,
                          qmi_result_type_v01 result = QMI_RESULT_SUCCESS_V01,
                          qmi_error_type_v01 error = QMI_ERR_NONE_V01);

// Simple endc to test enabling endc and test getting enabled endc
test_result ril_utf_test_enable_and_query_endc_001(user_specified_attrib_t attr);
// Simple endc to test disabling endc and test getting disabled endc
test_result ril_utf_test_enable_and_query_endc_002(user_specified_attrib_t attr);
// Simple endc to test disabling endc and test an incorrect response from modem
test_result ril_utf_test_enable_and_query_endc_003(user_specified_attrib_t attr);

test_result ril_utf_test_send_device_state_001(user_specified_attrib_t attr);
test_result ril_utf_test_send_device_state_002(user_specified_attrib_t attr);
test_result ril_utf_test_send_device_state_003(user_specified_attrib_t attr);
test_result ril_utf_test_set_location_updates_001(user_specified_attrib_t attr);
test_result ril_utf_test_set_location_updates_002(user_specified_attrib_t attr);
test_result ril_utf_test_set_indication_filter_001(user_specified_attrib_t attr);
test_result ril_utf_test_set_indication_filter_002(user_specified_attrib_t attr);
test_result ril_utf_test_set_indication_filter_003(user_specified_attrib_t attr);

void util_test_set_then_get_usage_settings(Testcase& t,
                                           QMIRILTestnode& QMI_node,
                                           AndroidTelTestnode& RIL_node,
                                           bool voiceCentric);
test_result ril_utf_test_usage_setting_001(user_specified_attrib_t attr);
test_result ril_utf_test_usage_setting_002(user_specified_attrib_t attr);
test_result ril_utf_test_usage_setting_003(user_specified_attrib_t attr);

test_result ril_utf_test_set_msim_pref_dsds(user_specified_attrib_t attr);
test_result ril_utf_test_set_msim_pref_dsda(user_specified_attrib_t attr);
test_result ril_utf_test_set_msim_pref_invalid(user_specified_attrib_t attr);

test_result ril_utf_test_nas_get_signal_strength(user_specified_attrib_t attr);
...
test_result ril_utf_test_get_radio_capability_001(user_specified_attrib_t attr);
test_result ril_utf_test_get_radio_capability_002(user_specified_attrib_t attr);
test_result ril_utf_test_set_vo_nr_enabled_001(user_specified_attrib_t attr);
test_result ril_utf_test_set_vo_nr_enabled_002(user_specified_attrib_t attr);
test_result ril_utf_test_set_vo_nr_enabled_003(user_specified_attrib_t attr);
test_result ril_utf_test_is_vo_nr_enabled_001(user_specified_attrib_t attr);
test_result ril_utf_test_is_vo_nr_enabled_002(user_specified_attrib_t attr);
test_result ril_utf_test_is_vo_nr_enabled_003(user_specified_attrib_t attr);
test_result ril_utf_test_get_data_nr_icon_type_001(user_specified_attrib_t attr);
test_result ril_utf_test_is_feature_supported(user_specified_attrib_t attr);
