...
test_result ril_utf_ims_srtp_encryption_info_001(user_specified_attrib_t attr);
test_result ril_utf_ims_srtp_encryption_info_002(user_specified_attrib_t attr);
test_result ril_utf_ims_srtp_encryption_info_003(user_specified_attrib_t attr);
