...
class IRadioIndicationClientImpl : public V1_6::IRadioIndication {
public:
    ...
    virtual Return<void> unthrottleApn(const hidl_string& apn) {
        return Void();
    }

    virtual Return<void> dataCallListChanged_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::SetupDataCallResult>& dcList) override {
        return Void();
    }

    virtual Return<void> unthrottleApn(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_string& apn) override {
        return Void();
    }

    virtual Return<void> currentLinkCapacityEstimate_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_6::LinkCapacityEstimate& lce) {
        return Void();
    }

    virtual Return<void> currentSignalStrength_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_6::SignalStrength& signalStrength);

    virtual Return<void> cellInfoList_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::CellInfo>& records) {
        return Void();
    }

    virtual Return<void> networkScanResult_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_6::NetworkScanResult& result);

    virtual Return<void> currentPhysicalChannelConfigs_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::PhysicalChannelConfig>& configs) {
        return Void();
    }
    ...
    virtual ::android::hardware::Return<void> simPhonebookRecordsReceived(::android::hardware::radio::V1_0::RadioIndicationType type,
            ::android::hardware::radio::V1_6::PbReceivedStatus status,
            const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::PhonebookRecordInfo>& records) {
        return Void();
	}
};
