...
struct token_msg_pair token_msg_list[MAX_MSG_PAIRS] = {};
...
{
  RIL_UTF_DEBUG("\n QMI_RIL_UTL: Ril instance %p", callbacks);
...
void RIL_onUnsolicitedResponse(int unsolResponse, const void *data, size_t datalen)
{
  ...
  enqueue_ril_expect(data_local, len_local, unsolResponse, -1, RIL_E_SUCCESS, ril_utf_ril_unsol_response);
