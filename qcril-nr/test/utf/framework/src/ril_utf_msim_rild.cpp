                      ...
                      int* msim_recv_byte_num_ptr)
{
  ...
  socklen_t source_addr_len = sizeof(tmp_remote_addr);
  ...
  ril_utf_print_hex((uint8_t *)msim_recv_buffer_ptr, (*msim_recv_byte_num_ptr));
...
int send_ril_utf_msim_request( struct ril_utf_msg_t *test_step )
{
  ...
  msim_send_buffer.rild_instance_id = (qcril_instance_id_e_type) test_step->rild_instance_id;
  msim_send_buffer.message_id = (ipc_message_id_type)test_step->msg_id;
