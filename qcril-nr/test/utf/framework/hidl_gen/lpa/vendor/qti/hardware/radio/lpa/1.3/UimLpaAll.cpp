#define LOG_TAG "vendor.qti.hardware.radio.lpa@1.3::UimLpa"

#include <log/log.h>
#include <cutils/trace.h>
#include <vendor/qti/hardware/radio/lpa/1.3/IUimLpa.h>
...
const char* IUimLpa::descriptor("vendor.qti.hardware.radio.lpa@1.3::IUimLpa");
...
// Methods from ::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa follow.
// no default implementation for: ::android::hardware::Return<void> IUimLpa::UimLpaUserRequest_1_3(int32_t token, const ::vendor::qti::hardware::radio::lpa::V1_3::UimLpaUserReq& userReq)
...
::android::hardware::Return<void> IUimLpa::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IUimLpa::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){236,134,23,164,244,6,117,119,125,248,97,68,101,188,172,99,255,132,250,199,14,81,49,68,188,217,86,129,74,117,228,42} /* ec8617a4f40675777df8614465bcac63ff84fac70e513144bcd956814a75e42a */,
...
::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa>> IUimLpa::castFrom(const ::android::sp<::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa>> IUimLpa::castFrom(const ::android::sp<::vendor::qti::hardware::radio::lpa::V1_2::IUimLpa>& parent, bool emitError) {
    return nullptr;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa>> IUimLpa::castFrom(const ::android::sp<::vendor::qti::hardware::radio::lpa::V1_1::IUimLpa>& parent, bool emitError) {
    return nullptr;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa>> IUimLpa::castFrom(const ::android::sp<::vendor::qti::hardware::radio::lpa::V1_0::IUimLpa>& parent, bool emitError) {
    return nullptr;
}

::android::hardware::Return<::android::sp<::vendor::qti::hardware::radio::lpa::V1_3::IUimLpa>> IUimLpa::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return nullptr;
}
