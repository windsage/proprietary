#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_6_IRADIOINDICATION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_6_IRADIOINDICATION_H
 ...
 */
struct IRadioIndication : public ::android::hardware::radio::V1_5::IRadioIndication {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.6::IRadioIndication"
     */
     ...
     */
    virtual ::android::hardware::Return<void> simPhonebookChanged(::android::hardware::radio::V1_0::RadioIndicationType type) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> simPhonebookRecordsReceived(::android::hardware::radio::V1_0::RadioIndicationType type, ::android::hardware::radio::V1_6::PbReceivedStatus status, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::PhonebookRecordInfo>& records) = 0;
     ...
     *        3. Unsolicited disconnect from either modem or network side.
     */
    virtual ::android::hardware::Return<void> dataCallListChanged_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::SetupDataCallResult>& dcList) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> unthrottleApn(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_string& apn) = 0;
     ...
     * @param lce LinkCapacityEstimate
     */
    virtual ::android::hardware::Return<void> currentLinkCapacityEstimate_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_6::LinkCapacityEstimate& lce) = 0;
     ...
     * @param signalStrength SignalStrength information
     */
    virtual ::android::hardware::Return<void> currentSignalStrength_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_6::SignalStrength& signalStrength) = 0;
     ...
     * @param records Current cell information
     */
    virtual ::android::hardware::Return<void> cellInfoList_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::CellInfo>& records) = 0;
     ...
     * CellInfo.
     */
    virtual ::android::hardware::Return<void> networkScanResult_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_6::NetworkScanResult& result) = 0;
     ...
     * @param configs Vector of PhysicalChannelConfigs
     */
    virtual ::android::hardware::Return<void> currentPhysicalChannelConfigs_1_6(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_6::PhysicalChannelConfig>& configs) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_6::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_5::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_4::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
     ...
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadioIndication>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_6::IRadioIndication>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_6::IRadioIndication>& o) {
    ...
    os += ::android::hardware::radio::V1_6::IRadioIndication::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_6_IRADIOINDICATION_H
