#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_6_IRADIO_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_6_IRADIO_H
 ...
 */
struct IRadio : public ::android::hardware::radio::V1_5::IRadio {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.6::IRadio"
     */
     ...
     */
    virtual ::android::hardware::Return<void> setRadioPower_1_6(int32_t serial, bool powerOn, bool forEmergencyCall, bool preferredForEmergencyCall) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getDataCallList_1_6(int32_t serial) = 0;
     ...
     * and RadioError:GENERIC_FAILURE means no retry (i.e. error cause is 500)
     */
    virtual ::android::hardware::Return<void> sendSms_1_6(int32_t serial, const ::android::hardware::radio::V1_0::GsmSmsMessage& message) = 0;
     ...
     * and RadioError:GENERIC_FAILURE means no retry (i.e. error cause is 500)
     */
    virtual ::android::hardware::Return<void> sendSmsExpectMore_1_6(int32_t serial, const ::android::hardware::radio::V1_0::GsmSmsMessage& message) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> sendCdmaSms_1_6(int32_t serial, const ::android::hardware::radio::V1_0::CdmaSmsMessage& sms) = 0;
     ...
     *
     */
    virtual ::android::hardware::Return<void> sendCdmaSmsExpectMore_1_6(int32_t serial, const ::android::hardware::radio::V1_0::CdmaSmsMessage& sms) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setSimCardPower_1_6(int32_t serial, ::android::hardware::radio::V1_1::CardPowerState powerUp) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setNrDualConnectivityState(int32_t serial, ::android::hardware::radio::V1_6::NrDualConnectivityState nrDualConnectivityState) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> isNrDualConnectivityEnabled(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> allocatePduSessionId(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> releasePduSessionId(int32_t serial, int32_t id) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> startHandover(int32_t serial, int32_t callId) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> cancelHandover(int32_t serial, int32_t callId) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setAllowedNetworkTypesBitmap(uint32_t serial, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::RadioAccessFamily> networkTypeBitmap) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getAllowedNetworkTypesBitmap(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setDataThrottling(int32_t serial, ::android::hardware::radio::V1_6::DataThrottlingAction dataThrottlingAction, int64_t completionDurationMillis) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getSystemSelectionChannels(int32_t serial) = 0;
     ...
     * Response callback is IRadioResponse.getCellInfoListResponse()
     */
    virtual ::android::hardware::Return<void> getCellInfoList_1_6(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getVoiceRegistrationState_1_6(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getSignalStrength_1_6(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getDataRegistrationState_1_6(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getCurrentCalls_1_6(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getSlicingConfig(int32_t serial) = 0;
     ...
     * as the input param.
     */
    virtual ::android::hardware::Return<void> setCarrierInfoForImsiEncryption_1_6(int32_t serial, const ::android::hardware::radio::V1_6::ImsiEncryptionInfo& imsiEncryptionInfo) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getSimPhonebookRecords(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getSimPhonebookCapacity(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> updateSimPhonebookRecords(int32_t serial, const ::android::hardware::radio::V1_6::PhonebookRecordInfo& recordInfo) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_6::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_5::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_4::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_6::IRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_6::IRadio>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_6::IRadio>& o) {
    ...
    os += ::android::hardware::radio::V1_6::IRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_6_IRADIO_H
