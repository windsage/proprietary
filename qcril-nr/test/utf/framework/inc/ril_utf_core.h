...
#define EXPECT_TIMEOUT 30000 // In microseconds
...
enum ril_utf_db_action_t {
  ...
  UTF_DB_QUERY_CLIR_PREF,
  UTF_DB_QUERY_CLIR_PREF_ENTRY_COUNT,
  UTF_DB_QUERY_OLDEST_CLIR_PREF,
  UTF_DB_INSERT_CLIR_PREF,
  UTF_DB_UPDATE_CLIR_PREF,
  UTF_DB_DELETE_CLIR_PREF,
  UTF_DB_CLEAR_ICCID_CLIR_PREF_TABLE,
  UTF_DB_ADD,
  UTF_DB_REMOVE,
  UTF_DB_QUERY
};
