...
static bool compareRilColrInfo(const RIL_ColrInfo& info1,
        const RIL_ColrInfo& info2) {
...
TEST(Marshalling, ColrInfo) {
    ...
    RIL_ColrInfo colr = {
        .status = RIL_SERVICE_CLASS_STATUS_ENABLED,
        .provisionStatus = RIL_SERVICE_CLASS_PROVISION_STATUS_PROVISIONED,
