...
TEST(Marshalling, SuppService_marshall_001)
{
  Marshal marshal;

  RIL_CallBarringNumbersInfo callBarringNumbersInfo[1]{
    {
        .status = RIL_SERVICE_CLASS_STATUS_ENABLED,  // = 1
        .number = "12345",
    },
  };
  ...
  RIL_CallBarringNumbersListInfo callBarringNumbersListInfo{
    ...
    .callBarringNumbersInfo = (RIL_CallBarringNumbersInfo*)&callBarringNumbersInfo,
  };
  ...
  RIL_SuppSvcRequest request{
    .operationType = RIL_SUPP_OPERATION_DEACTIVATE,  // = 1
    .facilityType = RIL_FACILITY_BA_MT,              // = 9
  ...
  RIL_CallBarringNumbersListInfo r_callBarringNumbersListInfo =
  ...
  RIL_CallBarringNumbersInfo* r_callBarringNumbersInfo =
...
TEST(Marshalling, SuppService_marshall_002)
{
  Marshal marshal;
  ...
  RIL_CallBarringNumbersListInfo callBarringNumbersListInfo[2]{
    {
        .serviceClass = 2,
        .callBarringNumbersInfoLen = 1,
        .callBarringNumbersInfo = (RIL_CallBarringNumbersInfo*)&callBarringNumbersInfo,
  ...
  RIL_SuppSvcResponse request{
    .status = RIL_SERVICE_CLASS_STATUS_ENABLED,                         // = 1
    .provisionStatus = RIL_SERVICE_CLASS_PROVISION_STATUS_PROVISIONED,  // = 1
    .facilityType = RIL_FACILITY_BA_MT,                                 // = 9
    .callBarringNumbersListInfoLen = 2,
    .callBarringNumbersListInfo = (RIL_CallBarringNumbersListInfo*)&callBarringNumbersListInfo,
  ...
  ASSERT_EQ(request.isPasswordRequired, request_r.isPasswordRequired);
