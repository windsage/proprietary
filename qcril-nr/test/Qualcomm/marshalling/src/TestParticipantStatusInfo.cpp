...
TEST(Marshalling, ParticipantStatusInfo_marshall_001)
{
  Marshal marshal;
  RIL_ParticipantStatusInfo request{
    .callId = 1,
    .operation = RIL_CONF_PARTICIPANT_OP_ADD,  // = 1
    .sipStatus = 404,
  ...
  RIL_ParticipantStatusInfo request_r = {};
