...
TEST(Marshalling, AutoCallRejectionInfo_marshall_001) {
  Marshal marshal;
  ...
  RIL_AutoCallRejectionInfo request{
    .callType = RIL_CALL_TYPE_VT,                         // = 4,
    .cause = RIL_IMS_FAILCAUSE_SIP_REQUEST_ENTITY_TOO_LARGE,  // = 0x440
    .sipErrorCode = 404,
    .number = "123456",
    .verificationStatus = RIL_VERSTAT_VERIFICATION_STATUS_PASS,  // = 1,
    .ccInfo = &ccInfo,
    .ecnamInfo = &ecnamInfo,
  };
  ...
  std::string s =
      ...
      "00000440"      // .cause = RIL_FAILCAUSE_SIP_REQUEST_ENTITY_TOO_LARGE, // = 0x440
      "0194"          // .sipErrorCode = 404,
      "00000006"      // .number length = 6,
      "313233343536"  // .number ("123456")
      "00000001"      // .verificationStatus = RIL_VERSTAT_VERIFICATION_STATUS_PASS, // = 1,
  ...
  RIL_AutoCallRejectionInfo request_r = {};
