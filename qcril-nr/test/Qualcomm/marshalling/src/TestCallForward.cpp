...
TEST(Marshalling, CallForward_marshall_001)
{
  Marshal marshal;
  ...
  RIL_CallForwardParams request{
    ...
    .number = "12345",
    .timeSeconds = 1,
    .callFwdTimerStart = &callFwdTimerStart,
    .callFwdTimerEnd = &callFwdTimerEnd,
  };
  ...
  std::string s =
      ...
      "00000001"    // CallFwdTimerStart len 1
      "000007E4"    //  .year = 2020,
      "00000001"    //  .month = 1,
      "00000002"    //  .day = 2,
      "00000001"    //  .hour = 1,
      ...
      "00000000"    //  .second = 0,
      "00000000"    //  .timezone = 0,
      "00000001"    // CallFwdTimerEnd len 1
      "000007E4"    //  .year = 2020,
      "00000003"    //  .month = 3,
      "00000015"    //  .day = 21,
      "00000001"    //  .hour = 1,
  ...
  RIL_CallForwardParams request_r = {};
...
TEST(Marshalling, QueryCallForwardStatusInfo_marshall_001) {
  Marshal marshal;
  RIL_CallFwdTimerInfo callFwdTimerStart{
    .year = 2020,
    .month = 1,
  ...
  RIL_CallForwardParams callForwardInfo[2]{
    {
      .status = 1,
      .reason = 1,
      .serviceClass = 0,
    ...
    },
    {
      ...
      .number = "12345",
      .timeSeconds = 60,
      .callFwdTimerStart = nullptr,
      .callFwdTimerEnd = nullptr,
    }
  };
  ...
  std::string s_callForwardInfo =
    ...
    // callForwardInfo[1]
      ...
      "FFFFFFFF"    // callFwdTimerStart len 0
      "FFFFFFFF"    // callFwdTimerEnd len 0
      ;
  ...
  RIL_QueryCallForwardStatusInfo request {
    .callForwardInfoLen = 2,
    .callForwardInfo = (RIL_CallForwardParams*)callForwardInfo,
  ...
  ASSERT_EQ(callForwardInfo[1].callFwdTimerStart, r_callForwardInfo[1].callFwdTimerStart); // Expected to be null
  ASSERT_EQ(callForwardInfo[1].callFwdTimerEnd, r_callForwardInfo[1].callFwdTimerEnd); // Expected to be null
...
TEST(Marshalling, SetCallForwardStatusInfo_marshall_001) {
  Marshal marshal;
  ...
  RIL_SetCallForwardStatus setCallForwardStatus[2] {
    { .reason = 1,
      .status = 1,
  ...
  RIL_SetCallForwardStatusInfo request {
    .setCallForwardStatusLen = 2,
    .setCallForwardStatus = (RIL_SetCallForwardStatus*)setCallForwardStatus,
    .errorDetails = &errorDetails,
  };
  ...
  RIL_SetCallForwardStatusInfo readData{};
  marshal.setDataPosition(0);
  ASSERT_NE(marshal.read(readData), Marshal::Result::FAILURE);

  ASSERT_EQ(request.setCallForwardStatusLen, readData.setCallForwardStatusLen);

  RIL_SetCallForwardStatus *r_setCallForwardStatus = readData.setCallForwardStatus;
