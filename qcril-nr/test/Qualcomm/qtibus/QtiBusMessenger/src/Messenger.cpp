...
message_id_p remoteRegistered = nullptr;
...
TEST(Messenger, Initialization) {
    ...
    msgr.setOnRemoteRegistrationCb([](pid_t sender, message_id_p msgId) {
    ...
    if (!receiver) {
        ...
        ASSERT_TRUE(*remoteRegistered == TestMessage::get_class_message_id());
        ...
        ASSERT_TRUE(*remoteRegistered == TestMessage2::get_class_message_id());
