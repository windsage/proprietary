    ...
    case QCRIL_UIM_REQUEST_GET_EUICC_INFO2:
      ret = qcril_qmi_uim_get_euicc_info2(mQmiSvcClient,
                                          (const qmi_uim_get_euicc_info2_req_type*)param_data_ptr,
                                           ...
                                           rsp_data_ptr);
      break;
    case QCRIL_UIM_REQUEST_GET_SIM_TYPE:
       ret = qcril_qmi_uim_get_sim_type(mQmiSvcClient,
                                        callback_function_ptr,
                                        user_data,
                                        rsp_data_ptr);
      break;
    case QCRIL_UIM_REQUEST_SET_SIM_TYPE:
       ret = qcril_qmi_uim_set_sim_type(mQmiSvcClient,
                                        (const qmi_uim_set_sim_type_req *)param_data_ptr,
                                        callback_function_ptr,
                                        user_data,
                                        rsp_data_ptr);
      break;
