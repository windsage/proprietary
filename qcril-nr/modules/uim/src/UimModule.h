...
private:
    ...
    void handleSIMCloseChannelSessionRequestMsg(
    ...
    void handleGetSimTypeReqMsg(std::shared_ptr<UimGetSimTypeRequestMsg>msgPtr);
    void handleSetSimTypeReqMsg(std::shared_ptr<UimSetSimTypeRequestMsg>msgPtr);
    void handleSwitchSlotPortRequestMsg(
        std::shared_ptr<UimSwitchSlotPortRequestMsg> req_ptr);
    void handlePersoLockStatusRequestMsg(
        std::shared_ptr<UimGetPersoLockStatusRequestMsg> msgPtr);
};
