...
UimModule::UimModule():uim_req_list("UimModule")
{
  ...
  mMessageHandler = {
      ...
      HANDLER(UimGetFacilityLockRequestMsg,
              UimModule::UimProcessGetFacilityLockStatusReq),
      HANDLER(UimSetFacilityLockRequestMsg,
              UimModule::UimProcessSetFacilityLockReq),
      ...
      HANDLER(UimChangeSubscriptionReqMsg,
              UimModule::UimProcessChangeSubscription),
      HANDLER(UimGetImsiRequestSyncMsg, UimModule::UimProcessGetImsiReq),
      HANDLER(UimGetCardStatusRequestSyncMsg,
              UimModule::UimProcessGetCardStatusReq),
      HANDLER(UimGetIccIdRequestSyncMsg, UimModule::UimProcessGetIccIdSycnReq),
      HANDLER(UimGetCardStatusRequestMsg,
      ...
      HANDLER(UimChangeSimPinRequestMsg,
              UimModule::handleChangeSimPinRequestMsg),
      HANDLER(UimEnterDePersoRequestMsg,
              UimModule::handleEnterDePersoRequestMsg),
      HANDLER(UimISIMAuthenticationRequestMsg,
              UimModule::handleISIMAuthenticationRequestMsg),
      HANDLER(UimSIMAuthenticationRequestMsg,
              UimModule::handleSIMAuthenticationRequestMsg),
      HANDLER(UimGetImsiRequestMsg, UimModule::handleGetImsiRequestMsg),
      HANDLER(UimSIMIORequestMsg, UimModule::handleSIMIORequestMsg),
      HANDLER(UimTransmitAPDURequestMsg,
              UimModule::handleTransmitAPDURequestMsg),
      HANDLER(UimSIMOpenChannelRequestMsg,
              UimModule::handleSIMOpenChannelRequestMsg),
      HANDLER(UimSIMCloseChannelRequestMsg,
              UimModule::handleSIMCloseChannelRequestMsg),
      HANDLER(UimCardPowerReqMsg, UimModule::handleUimCardPowerReqMsg),
      HANDLER(UimVoltageStatusRequestMsg,
              UimModule::handleUimVoltageStatusRequestMsg),
      HANDLER(UimPersoRequestMsg, UimModule::handleUimPersoRequestMsg),
      HANDLER(UimGetPersoStatusRequestMsg,
              UimModule::handleUimGetPersoStatusRequestMsg),
      HANDLER(UimGetLPATermialCapabilitesRequestMsg,
              UimModule::handleUimGetLPATermialCapabilitesRequestMsg),
      HANDLER(UimSetLPATermialCapabilitesRequestMsg,
              UimModule::handleUimSetLPATermialCapabilitesRequestMsg),
      HANDLER(UimSetAPDUBehaviorRequestMsg,
              UimModule::handleUimSetAPDUBehaviorRequestMsg),
      HANDLER(UimGBAGetIMPIRequestMsg,
              UimModule::handleUimGBAGetIMPIRequestMsg),
      ...
      HANDLER(UimSAPConnectionRequestMsg,
              UimModule::handleUimSAPConnectionRequestMsg),
      HANDLER(UimSAPRequestMsg, UimModule::handleUimSAPRequestMsg),
      HANDLER(UimRemoteSimlockRequestMsg,
              UimModule::handleUimRemoteSimlockRequestMsg),
      HANDLER(UimGetPhysicalSlotMappingRequestMsg,
              UimModule::handleUimGetPhysicalSlotMappingRequestMsg),
      HANDLER(UimSwitchSlotRequestMsg,
              UimModule::handleUimSwitchSlotRequestMsg),
      HANDLER(UimGetSlotStatusRequestMsg,
              UimModule::handleUimGetSlotStatusRequestMsg),
      HANDLER(ClientDisconnectedMessage,
              UimModule::handleClientDisconnectedMsg),
      HANDLER(UimDeepSleepNotifyMsg, UimModule::handleNotifyDeepSleepMsg),
      HANDLER(UimGetSimTypeRequestMsg, UimModule::handleGetSimTypeReqMsg),
      HANDLER(UimSetSimTypeRequestMsg, UimModule::handleSetSimTypeReqMsg),
      HANDLER(UimSIMCloseChannelSessionReqMsg,
              UimModule::handleSIMCloseChannelSessionRequestMsg),
      HANDLER(UimSwitchSlotPortRequestMsg,
              UimModule::handleSwitchSlotPortRequestMsg),
      HANDLER(UimGetPersoLockStatusRequestMsg,
              UimModule::handlePersoLockStatusRequestMsg),
  };
} /* UimModule::UimModule */
...
void UimModule::UimProcessRilInit(std::shared_ptr<Message> msg_ptr)
{
  ...
  else
  {
    ...
    qcril_uim_hlos_prov_pref_auto = true;
    QCRIL_LOG_INFO("RIL_FOR_MDM_LE - Force set hlos_prov_pref_auto set to true (Auto) ");
#endif
...
===========================================================================*/
void UimModule::handleGetSimTypeReqMsg(std::shared_ptr<UimGetSimTypeRequestMsg> req_ptr)
{
  if (req_ptr == nullptr)
  {
    return;
  ...
  if (mReady)
  {
      QCRIL_LOG_INFO("Calling qcril_uim_get_sim_type_req");
      qcril_uim_request_get_sim_type(req_ptr);
  }
  else
  {
    auto rsp_ptr = std::make_shared<RIL_UIM_GetSimTypeResp>();
    if (rsp_ptr != NULL)
    {
...
===========================================================================*/
void UimModule::handleSetSimTypeReqMsg(std::shared_ptr<UimSetSimTypeRequestMsg> req_ptr)
{
  ...
  if (mReady)
  {
      qcril_uim_request_set_sim_type(req_ptr);
  }
  else
  {
...
/*=========================================================================
  ...
  Function:  UimModule::handleSIMCloseChannelSessionRequestMsg

===========================================================================*/

void UimModule::handleSIMCloseChannelSessionRequestMsg(
    std::shared_ptr<UimSIMCloseChannelSessionReqMsg> req_ptr) {
  QCRIL_LOG_INFO("%s\n", __FUNCTION__);
  ...
  qcril_uim_close_logical_ch_session_req(req_ptr);
} /* handleSIMCloseChannelRequestMsg */

/*=========================================================================

  Function:  UimModule::handlePersoLockStatusRequestMsg

===========================================================================*/

void UimModule::handlePersoLockStatusRequestMsg(
    std::shared_ptr<UimGetPersoLockStatusRequestMsg> req_ptr) {
  QCRIL_LOG_INFO("%s\n", __FUNCTION__);
  RIL_UIM_Errno ret = RIL_UIM_E_RADIO_NOT_AVAILABLE;
  std::shared_ptr<RIL_UIM_Perso_lock_Status> resp_ptr = nullptr;
  Message::Callback::Status status = Message::Callback::Status::FAILURE;
  if (req_ptr == nullptr) {
    return;
  }
  if (mReady) {
    resp_ptr = std::make_shared<RIL_UIM_Perso_lock_Status>();

    ret = qcril_uim_get_perso_lock_status(req_ptr, resp_ptr);

    if (ret == RIL_UIM_E_SUCCESS) {
      status = Message::Callback::Status::SUCCESS;
    }
  }
  req_ptr->sendResponse(req_ptr, status, resp_ptr);
}
/*=========================================================================
...
void UimModule::handleSwitchSlotPortRequestMsg(
    std::shared_ptr<UimSwitchSlotPortRequestMsg> req_ptr) {
  QCRIL_LOG_INFO("%s\n", __FUNCTION__);
  ...
  qcril_uim_request_switch_slot_port(req_ptr);
} /* handleUimSwitchSlotRequestMsg */
/*=========================================================================
