...
/*===========================================================================
  FUNCTION:  qcril_uim_get_sim_type_resp
===========================================================================*/
/*!
    @brief
    Handle Get Sim Type resp
    @return
    None
*/
/*=========================================================================*/
void qcril_uim_get_sim_type_resp
(
  qcril_uim_callback_params_type  * params_ptr,
  const std::shared_ptr<UimGetSimTypeRequestMsg> req_ptr
)
{
  std::shared_ptr<RIL_UIM_GetSimTypeResp> rsp_ptr = NULL;
  uint8_t index = 0;
  QCRIL_LOG_INFO( "%s\n", __FUNCTION__);
  ...
  QCRIL_LOG_DEBUG( "qcril_uim_get_sim_type_resp: qmi_err_code=%d \n",
                    params_ptr->qmi_rsp_data.qmi_err_code);

  rsp_ptr = std::make_shared<RIL_UIM_GetSimTypeResp>();

  if (rsp_ptr != NULL)
  {
    rsp_ptr->err = (RIL_UIM_Errno)params_ptr->qmi_rsp_data.qmi_err_code;
    rsp_ptr->sim_type_len = params_ptr->qmi_rsp_data.rsp_data.sim_type_resp.sim_type_len;
    for(index =0;index< rsp_ptr->sim_type_len;index++)
    {
        rsp_ptr->sim_type[index] =
                  (RIL_UIM_Sim_Type)params_ptr->qmi_rsp_data.rsp_data.sim_type_resp.sim_type[index];
    }
    rsp_ptr->supported_sim_type_len =
                  params_ptr->qmi_rsp_data.rsp_data.sim_type_resp.supported_sim_type_len;
    for(index=0;index<rsp_ptr->supported_sim_type_len;index++)
    {
        rsp_ptr->supported_sim_type[index] =(RIL_UIM_Supported_Sim_Type)params_ptr->qmi_rsp_data.
                                            rsp_data.sim_type_resp.supported_sim_type[index];
    }
  }
...
/*===========================================================================
  FUNCTION:  qcril_uim_set_sim_type_resp
===========================================================================*/
/*!
    @brief
    Handle Get Sim Type resp
...
*/
/*=========================================================================*/
void qcril_uim_set_sim_type_resp
(
  qcril_uim_callback_params_type  * params_ptr,
...
)
{
  ...
  *rsp_ptr = (RIL_UIM_Errno) params_ptr->qmi_rsp_data.qmi_err_code;
