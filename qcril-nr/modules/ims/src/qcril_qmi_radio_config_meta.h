...
typedef enum
{
    ...
    QCRIL_QMI_RADIO_CONFIG_IMS_DATA_CHANNEL_PREFERENCE = 98,
    QCRIL_QMI_RADIO_CONFIG_VOLTE_PROVISIONING_RESTRICT_HOME = 99,
    QCRIL_QMI_RADIO_CONFIG_VOLTE_PROVISIONING_RESTRICT_ROAMING = 100,
