...
qcril_qmi_ims_create_ServiceStatusInfoList(const imsa_service_status_ind_msg_v01 *qmi_data) {
  ...
  if (srvStatInfoList != nullptr) {
    ...
    if (qmi_data->dc_service_status_valid) {
      srvStatInfoList->addToServiceStatusInfo(qcril_qmi_ims_create_ServiceStatusInfo(
          qcril::interfaces::CallType::DC, qmi_data->dc_service_status,
          qmi_data->dc_service_rat_valid, qmi_data->dc_service_rat));
    }
  }
...
)
{
  ...
  switch(ims_config_item)
  {
    ...
    case qcril::interfaces::ConfigItem::IMS_DATA_CHANNEL_SETTING:
      ret = QCRIL_QMI_RADIO_CONFIG_IMS_DATA_CHANNEL_PREFERENCE;
      break;

    case qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_HOME:
      ret = QCRIL_QMI_RADIO_CONFIG_VOLTE_PROVISIONING_RESTRICT_HOME;
      break;

    case qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_ROAMING:
      ret = QCRIL_QMI_RADIO_CONFIG_VOLTE_PROVISIONING_RESTRICT_ROAMING;
      break;
...
)
{
  ...
  switch(radio_config_item)
  {
    ...
    case QCRIL_QMI_RADIO_CONFIG_IMS_DATA_CHANNEL_PREFERENCE:
      ret = qcril::interfaces::ConfigItem::IMS_DATA_CHANNEL_SETTING;
      break;

    case QCRIL_QMI_RADIO_CONFIG_VOLTE_PROVISIONING_RESTRICT_HOME:
      ret = qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_HOME;
      break;

    case QCRIL_QMI_RADIO_CONFIG_VOLTE_PROVISIONING_RESTRICT_ROAMING:
      ret = qcril::interfaces::ConfigItem::VOLTE_PROVISIONING_RESTRICT_ROAMING;
      break;
