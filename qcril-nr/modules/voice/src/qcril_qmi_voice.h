...
typedef struct qcril_qmi_voice_voip_call_info_entry_type
{
    ...
    voice_prog_info_notif_type_v02            prog_info_notif;
...
qcril::interfaces::ClipStatus mapProvisionActiveStatusToClipStatus(provision_status_enum_v02 provision, active_status_enum_v02 active, sups_domain_enum_v02 domain);
...
void qcril_qmi_voice_set_call_reason(const uint8_t call_id,
...
char* qcril_qmi_voice_convert_call_reason(
    const uint16_t reason[QMI_VOICE_CALL_REASON_MAX_LEN_V02], const uint32_t length);
