...
template <>
Marshal::Result Marshal::release<RIL_GSM_SignalStrength_v12>(RIL_GSM_SignalStrength_v12 &arg) {
    release(arg.signalStrength);
    release(arg.bitErrorRate);
    release(arg.timingAdvance);
    return Result::SUCCESS;
}
...
template <>
Marshal::Result Marshal::release<RIL_LTE_SignalStrength_v8>(RIL_LTE_SignalStrength_v8 &arg) {
    release(arg.signalStrength);
    release(arg.rsrp);
    release(arg.rsrq);
    release(arg.rssnr);
...
template <>
Marshal::Result Marshal::release<RIL_SignalStrengthWcdma>(RIL_SignalStrengthWcdma &arg) {
    release(arg.signalStrength);
    release(arg.bitErrorRate);
...
template <>
Marshal::Result Marshal::release<RIL_CDMA_SignalStrength>(RIL_CDMA_SignalStrength &arg) {
    release(arg.dbm);
    release(arg.ecio);
...
template <>
Marshal::Result Marshal::release<RIL_EVDO_SignalStrength>(RIL_EVDO_SignalStrength &arg) {
    release(arg.dbm);
    release(arg.ecio);
    release(arg.signalNoiseRatio);
...
template <>
Marshal::Result Marshal::release<RIL_TD_SCDMA_SignalStrength>(RIL_TD_SCDMA_SignalStrength &arg) {
    release(arg.rscp);
    release(arg.signalStrength);
    release(arg.bitErrorRate);
...
template <>
Marshal::Result Marshal::release<RIL_NR_SignalStrength>(RIL_NR_SignalStrength &arg) {
    release(arg.ssRsrp);
    release(arg.ssRsrq);
    release(arg.ssSinr);
    release(arg.csiRsrp);
