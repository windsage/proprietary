...
template <>
Marshal::Result Marshal::release<RIL_GSM_BroadcastSmsConfigInfo>(
    RIL_GSM_BroadcastSmsConfigInfo& arg) {
  release(arg.fromServiceId);
  release(arg.toServiceId);
  release(arg.fromCodeScheme);
  release(arg.toCodeScheme);
