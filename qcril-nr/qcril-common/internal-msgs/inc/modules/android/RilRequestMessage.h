...
class RilRequestMessage: public SolicitedMessage<generic_callback_payload>
{
    ...
    public:
        ...
        RilRequestMessage(message_id_ref msg_id, const qcril_request_params_type &params):
            SolicitedMessage<generic_callback_payload>(msg_id),
            params(params)
        {
        }

        RilRequestMessage( message_id_ref msg_id, qcril_request_params_type &&params):
            SolicitedMessage<generic_callback_payload>(msg_id),
            params(params)
        {
        }
