...
enum RIL_IMS_CallType {
  ...
  RIL_IMS_CALL_TYPE_DC = 10,          /** DATA CHANNEL */
};
...
struct RIL_IMS_SubConfigInfo {
  ...
  uint32_t imsStackEnabledLen; /**< Length of the imsStackEnabled array */
...
enum RIL_IMS_CallFailCause {
  ...
  RIL_IMS_FAILCAUSE_EPSFB_FAILURE,
  RIL_IMS_FAILCAUSE_TWAIT_EXPIRED,
  RIL_IMS_FAILCAUSE_TCP_CONNECTION_REQ,
...
enum RIL_IMS_ConfigItem {
    ...
    RIL_IMS_CONFIG_ITEM_B2C_ENRICHED_CALLING_SETTING,
     ...
     /** Value for this item is: (Int)
      * Data Channel Calling Preference
      * Values:
      *   - 0 -- DISABLED
      *   - 1 -- ENABLED
      *
      ...
      * if the value is not any of the above.
      */
    RIL_IMS_CONFIG_ITEM_DATA_CHANNEL_SETTING,

    /** Value for this item is: (Int)
     * Enable VoLTE restrict in HOME network
     * Values:
     *   - 0 -- Disable
     *   - 1 -- Enable
     */
    RIL_IMS_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_HOME,

    /** Value for this item is: (Int)
     * Enable VoLTE restrict in ROAMING network
     * Values:
     *   - 0 -- Disable
     *   - 1 -- Enable
     */
    RIL_IMS_CONFIG_ITEM_VOLTE_PROVISIONING_RESTRICT_ROAMING,
...
/**
 * SRTP encryption state
 */
enum RIL_IMS_SrtpEncryptionCategories {
  RIL_IMS_SRTP_CATEGORIES_UNENCRYPTED = 0,  /**< Unencrypted */
  RIL_IMS_SRTP_CATEGORIES_VOICE = (1 << 0), /**< Voice is encrypted */
  RIL_IMS_SRTP_CATEGORIES_VIDEO = (1 << 1), /**< Video is encrypted */
  RIL_IMS_SRTP_CATEGORIES_TEXT = (1 << 2)   /**< Text is encrypted */
};

/**
 * SRTP encryption status information.
 */
struct RIL_IMS_SrtpEncryptionStatus {
  uint32_t callId;      /**< Call Id */
  uint32_t categories;  /**< Categories: Bitmask of RIL_IMS_SrtpEncryptionCategories */
};
 ...
 *
 * This API is deprecated, use ril_call.h request
...
/**
 * RIL_IMS_UNSOL_SRTP_ENCRYPTION_STATUS
 * Indicates the SRTP encryption categories.
 *
 * "data" RIL_IMS_SrtpEncryptionStatus
 */
#define RIL_IMS_UNSOL_SRTP_ENCRYPTION_STATUS 15035
