...
inline std::string toString(const ConfigItem &o) {
  ...
  if (o == ConfigItem::VOLTE_PROVISIONING_RESTRICT_HOME) {
    return "VOLTE_PROVISIONING_RESTRICT_HOME";
  }
  if (o == ConfigItem::VOLTE_PROVISIONING_RESTRICT_ROAMING) {
    return "VOLTE_PROVISIONING_RESTRICT_ROAMING";
  }
...
inline std::string toString(const Location& o) {
  std::string os;
  os += "{";
  os += ".Radius = " + std::to_string(PII(o.getRadius()));
  os += ".Latitude = " + std::to_string(PII(o.getLatitude()));
  os += ".Longitude = " + std::to_string(PII(o.getLongitude()));
  os += "}";
  return os;
}
...
class DataChannelInfo : public qcril::interfaces::BasePayload {
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(uint32_t, ModemCallId);
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(bool, IsDcCall);
};

inline std::string toString(const DataChannelInfo& o) {
    std::string os;
    os += "{";
    os += ".Modem Call Id = " + std::to_string(o.getModemCallId());
    os += ".DC call = " + std::to_string(o.getIsDcCall());
    os += "}";
    return os;
}
...
class PreAlertingCallInfo : public qcril::interfaces::BasePayload {
  ...
  QCRIL_INTERFACE_OPTIONAL_MEMBER_VAR(DataChannelInfo, DataChannelInfo);
};
...
inline std::string toString(const PreAlertingCallInfo& o) {
  ...
  os += ".DataChannelInfo = " + toString(o.getDataChannelInfo());
  os += "}";
  return os;
}
...
enum class ImsCiWlanMode {
  C_IWLAN_ONLY = 0,
  C_IWLAN_PREFERRED = 1,
};

struct ImsCiWlanConfig {
  bool c_iwlan_mode_in_home_valid;
  ImsCiWlanMode c_iwlan_mode_in_home;
  bool c_iwlan_mode_in_roam_valid;
  ImsCiWlanMode c_iwlan_mode_in_roam;
};
