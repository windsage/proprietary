...
#define RIL_UIM_MAX_PORT 3
#define RIL_UIM_MAX_ICCID_LEN 10
...
typedef enum {
    ...
    RIL_UIM_CARDSTATE_RESTRICTED = 3
} RIL_UIM_CardState;
...
typedef enum {
  ...
  RIL_UIM_PERSOSUBSTATE_SIM_NETWORK_PUK =
  ...
  RIL_UIM_PERSOSUBSTATE_RUIM_NETWORK1_PUK =
  ...
  RIL_UIM_PERSOSUBSTATE_SIM_TEMP_UNLOCK = 201,
  RIL_UIM_PERSOSUBSTATE_SIM_PERMANENT_UNLOCK = 202
...
typedef enum {
  RIL_UIM_PORT_STATE_INACTIVE = 0x00,
  RIL_UIM_PORT_STATE_ACTIVE = 0x01
} RIL_UIM_Port_State;
...
typedef enum {
  RIL_UIM_MEP_MODE_UNKNOWN = 0x00,
  RIL_UIM_MEP_MODE_A1 = 0x01,
  RIL_UIM_MEP_MODE_A2 = 0x02,
  RIL_UIM_MEP_MODE_B = 0x03
} RIL_UIM_Mep_mode;

/* -----------------------------------------------------------------------------
   ENUM:      RIL_UIM_Card_protocol
...
typedef enum {
  RIL_UIM_PROTOCOL_UNKNOWN = 0x00,
  RIL_UIM_PROTOCOL_ICC = 0x01,
  RIL_UIM_PROTOCOL_UICC = 0x02
} RIL_UIM_Card_protocol;
...
typedef enum {
  RIL_UIM_UNLOCK_STATUS_UNKNOWN = 0x00,
  RIL_UIM_UNLOCK_STATUS_TEMPORARY_UNLOCKED = 0x01,
  RIL_UIM_UNLOCK_STATUS_PERMANENTLY_UNLOCKED = 0x02
} RIL_UIM_unlock_Status;

/* -----------------------------------------------------------------------------
   Struct:      RIL_UIM_App_perso_lock
...
typedef struct {
  ...
  RIL_UIM_unlock_Status unlock_status;
} RIL_UIM_App_perso_lock;

/* -----------------------------------------------------------------------------
   Struct:      RIL_UIM_Perso_lock_Status
...
typedef struct {
  RIL_UIM_App_perso_lock applications[RIL_UIM_CARD_MAX_APPS];
} RIL_UIM_Perso_lock_Status;
...
/* -----------------------------------------------------------------------------
   STRUCT:      RIL_UIM_Port_Status_type

   DESCRIPTION:
     Structure that holds Port Status of the MEP card
-------------------------------------------------------------------------------*/
typedef struct {
  RIL_UIM_Port_State port_state;
  RIL_UIM_Card_protocol card_protocol;
  uint8_t num_app;
  uint8_t logical_slot;
  uint32_t iccid_len;
  std::vector<uint8_t> iccid;
} RIL_UIM_Port_Status_type;
/* -----------------------------------------------------------------------------
   STRUCT:      RIL_UIM_Port_Info

   DESCRIPTION:
     Structure that holds Port_information per profile
-------------------------------------------------------------------------------*/

typedef struct {
  bool is_mep;
  RIL_UIM_Mep_mode mep_mode;
  uint8_t max_jointly_supported_lsi_for_enabled_profiles;
  uint32_t uim_port_status_len;
  RIL_UIM_Port_Status_type uim_port_status[RIL_UIM_MAX_PORT];
} RIL_UIM_Port_Info;
...
/* Logical slot is valid only when the slot state is ACTIVE */
  ...
  uint8_t port_information_len;
  RIL_UIM_Port_Info port_info;
} RIL_UIM_SlotStatus;
...
/* -----------------------------------------------------------------------------
   ENUM:      RIL_UIM_Sim_Type

   DESCRIPTION:
-------------------------------------------------------------------------------*/
typedef enum {
    RIL_UIM_SIM_TYPE_PHYSICAL = 1,
    RIL_UIM_SIM_TYPE_IUICC = 2,
    RIL_UIM_SIM_TYPE_EMBEDDED = 3
} RIL_UIM_Sim_Type;

/* -----------------------------------------------------------------------------
   ENUM:      RIL_UIM_Supported_Sim_Type

   DESCRIPTION:
-------------------------------------------------------------------------------*/

typedef enum {
    RIL_UIM_SUPPORTED_SIM_TYPE_PHYSICAL = 0,
    RIL_UIM_SUPPORTED_SIM_TYPE_IUICC = 1,
    RIL_UIM_SUPPORTED_SIM_TYPE_PHYSICAL_IUICC = 2,
    RIL_UIM_SUPPORTED_SIM_TYPE_EMBEDDED = 3,
    RIL_UIM_SUPPORTED_SIM_TYPE_PHYSICAL_EMBEDDED = 4,
    RIL_UIM_SUPPORTED_SIM_TYPE_INTEGRATED_EMBEDDED = 5,
    RIL_UIM_SUPPORTED_SIM_TYPE_PHYSICAL_INTEGRATED_EMBEDDED = 6 
} RIL_UIM_Supported_Sim_Type;

/* -----------------------------------------------------------------------------
   STRUCT:      RIL_UIM_GetSimTypeResp

   DESCRIPTION:
-------------------------------------------------------------------------------*/

typedef struct RIL_UIM_GetSimTypeResp {
    RIL_UIM_Errno err;
    uint32_t sim_type_len;
    RIL_UIM_Sim_Type sim_type[RIL_UIM_MAX_CARD_COUNT];
    uint32_t supported_sim_type_len;
    RIL_UIM_Supported_Sim_Type supported_sim_type[RIL_UIM_MAX_CARD_COUNT];
} RIL_UIM_GetSimTypeResp;

/* -----------------------------------------------------------------------------
   STRUCT:      RIL_UIM_SetSimTypeResp

   DESCRIPTION:
-------------------------------------------------------------------------------*/

typedef struct RIL_UIM_SetSimTypeResp {
   RIL_UIM_Errno err;
} RIL_UIM_SetSimTypeResp;

/* -----------------------------------------------------------------------------
   STRUCT:      RIL_UIM_SwitchSlot

   DESCRIPTION:
-------------------------------------------------------------------------------*/

typedef struct RIL_UIM_SwitchSlot {
