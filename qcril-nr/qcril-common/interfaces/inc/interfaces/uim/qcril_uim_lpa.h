...
typedef enum
{
  QCRIL_UIM_LPA_NO_CONFIRMATION_REQD     = 0,
  QCRIL_UIM_LPA_SIMPLE_CONFIRMATION_REQD = 1,
  QCRIL_UIM_LPA_STRONG_CONFIRMATION_REQD = 2
}qcril_uim_lpa_user_consent_type;
typedef struct
{
...
typedef struct
{
  ...
  qcril_uim_lpa_user_consent_type       user_consent_type;
