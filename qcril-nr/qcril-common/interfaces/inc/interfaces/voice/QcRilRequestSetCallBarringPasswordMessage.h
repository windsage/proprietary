...
class QcRilRequestSetCallBarringPasswordMessage
 ...
 public:
  ...
  inline string dumpOldPassword() {
    return "mOldPassword = " + (mOldPassword ? PII(*mOldPassword,std::string("<hidden>")) : "<invalid>");
  }
  ...
  inline string dumpNewPassword() {
    return "mNewPassword = " + (mNewPassword ? PII(*mNewPassword,std::string("<hidden>")) : "<invalid>");
  }
