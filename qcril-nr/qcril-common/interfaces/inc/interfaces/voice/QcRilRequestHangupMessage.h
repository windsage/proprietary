...
class QcRilRequestHangupMessage : public QcRilRequestMessage,
                                  public add_message_id<QcRilRequestHangupMessage> {
 private:
 ...
 public:
  static constexpr const char *MESSAGE_NAME = "QcRilRequestHangupMessage";
  QcRilRequestHangupMessage() = delete;

  ~QcRilRequestHangupMessage() {}

  inline QcRilRequestHangupMessage(std::shared_ptr<MessageContext> context)
      : QcRilRequestMessage(get_class_message_id(), context), mRetryAttempted(false) {}
