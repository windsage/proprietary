...
typedef enum
{
  LPA_NO_CONFIRMATION_REQD        =0,
  LPA_STRONG_CONFIMRATION_REQD   = 1,
  LPA_SIMPLE_CONFIRMATION_REQD   = 2
}lpa_user_consent_type;
...
typedef struct
{
  ...
  lpa_user_consent_type                 user_consent_type; /*UIM_LPA_USER-CONSENT*/
...
typedef struct
{
  ...
  char                                 * profile_name;
  lpa_user_consent_type                  user_consent_type;
} lpa_service_add_profile_progress_ind_type;

typedef struct
{
  lpa_user_consent_type    user_consent_type;
} lpa_service_user_consent_type;
