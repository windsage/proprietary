...
#include "modules/uim/qcril_uim_util.h"
...
static int deep_copy(uint32_t request_type, const void *param_data_ptr,
  ...
  case QCRIL_UIM_REQUEST_WRITE_TRANSPARENT:
    memcpy(&request_ptr->write_transparent, param_data_ptr,
           sizeof(qmi_uim_write_transparent_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->write_transparent.session_info.aid.data_ptr,
        ((qmi_uim_write_transparent_params_type *)param_data_ptr)
            ->session_info.aid.data_ptr,
        ((qmi_uim_write_transparent_params_type *)param_data_ptr)
            ->session_info.aid.data_len,
        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->write_transparent.file_id.path.data_ptr,
        ((qmi_uim_write_transparent_params_type *)param_data_ptr)
            ->file_id.path.data_ptr,
        ((qmi_uim_write_transparent_params_type *)param_data_ptr)
            ->file_id.path.data_len,
        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->write_transparent.data.data_ptr,
        ((qmi_uim_write_transparent_params_type *)param_data_ptr)
            ->data.data_ptr,
        ((qmi_uim_write_transparent_params_type *)param_data_ptr)
            ->data.data_len,
  ...
  case QCRIL_UIM_REQUEST_WRITE_RECORD:
    ...
    QCRIL_UIM_DUPLICATE(request_ptr->write_record.file_id.path.data_ptr,
                        ...
                        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->write_record.data.data_ptr,
  ...
  case QCRIL_UIM_REQUEST_GET_RESPONSE:
    memcpy(&request_ptr->get_attributes, param_data_ptr,
           sizeof(qmi_uim_get_file_attributes_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->get_attributes.session_info.aid.data_ptr,
        ((qmi_uim_get_file_attributes_params_type *)param_data_ptr)
            ->session_info.aid.data_ptr,
        ((qmi_uim_get_file_attributes_params_type *)param_data_ptr)
            ->session_info.aid.data_len,
        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->get_attributes.file_id.path.data_ptr,
        ((qmi_uim_get_file_attributes_params_type *)param_data_ptr)
            ->file_id.path.data_ptr,
        ((qmi_uim_get_file_attributes_params_type *)param_data_ptr)
            ->file_id.path.data_len,
  ...
  case QCRIL_UIM_REQUEST_REFRESH_REGISTER:
    memcpy(&request_ptr->refresh_register, param_data_ptr,
           sizeof(qmi_uim_refresh_register_params_type));
    QCRIL_UIM_DUPLICATE(request_ptr->refresh_register.session_info.aid.data_ptr,
                        ((qmi_uim_refresh_register_params_type *)param_data_ptr)
                            ->session_info.aid.data_ptr,
                        ((qmi_uim_refresh_register_params_type *)param_data_ptr)
                            ->session_info.aid.data_len,
                        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->refresh_register.files_ptr,
        ((qmi_uim_refresh_register_params_type *)param_data_ptr)->files_ptr,
        (((qmi_uim_refresh_register_params_type *)param_data_ptr)->num_files) *
            sizeof(qmi_uim_file_id_type),
        (qmi_uim_file_id_type *));
    break;

  case QCRIL_UIM_REQUEST_GET_FDN:
    memcpy(&request_ptr->get_service_status, param_data_ptr,
           sizeof(qmi_uim_get_service_status_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->get_service_status.session_info.aid.data_ptr,
        ((qmi_uim_get_service_status_params_type *)param_data_ptr)
            ->session_info.aid.data_ptr,
        ((qmi_uim_get_service_status_params_type *)param_data_ptr)
            ->session_info.aid.data_len,
        (unsigned char *));
  ...
  case QCRIL_UIM_REQUEST_SET_FDN:
    memcpy(&request_ptr->set_service_status, param_data_ptr,
           sizeof(qmi_uim_set_service_status_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->set_service_status.session_info.aid.data_ptr,
        ((qmi_uim_set_service_status_params_type *)param_data_ptr)
            ->session_info.aid.data_ptr,
        ((qmi_uim_set_service_status_params_type *)param_data_ptr)
            ->session_info.aid.data_len,
        (unsigned char *));
  ...
  case QCRIL_UIM_REQUEST_VERIFY_PIN2:
    memcpy(&request_ptr->verify_pin, param_data_ptr,
           sizeof(qmi_uim_verify_pin_params_type));
    QCRIL_UIM_DUPLICATE(request_ptr->verify_pin.session_info.aid.data_ptr,
                        ((qmi_uim_verify_pin_params_type *)param_data_ptr)
                            ->session_info.aid.data_ptr,
                        ((qmi_uim_verify_pin_params_type *)param_data_ptr)
                            ->session_info.aid.data_len,
                        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->verify_pin.pin_data.data_ptr,
  ...
  case QCRIL_UIM_REQUEST_UNBLOCK_PIN:
    memcpy(&request_ptr->unblock_pin, param_data_ptr,
           sizeof(qmi_uim_unblock_pin_params_type));
    QCRIL_UIM_DUPLICATE(request_ptr->unblock_pin.session_info.aid.data_ptr,
                        ((qmi_uim_unblock_pin_params_type *)param_data_ptr)
                            ->session_info.aid.data_ptr,
                        ((qmi_uim_unblock_pin_params_type *)param_data_ptr)
                            ->session_info.aid.data_len,
                        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->unblock_pin.puk_data.data_ptr,
  ...
  case QCRIL_UIM_REQUEST_CHANGE_PIN:
    ...
    QCRIL_UIM_DUPLICATE(request_ptr->change_pin.old_pin_data.data_ptr,
                        ((qmi_uim_change_pin_params_type *)param_data_ptr)
                            ->old_pin_data.data_ptr,
                        ((qmi_uim_change_pin_params_type *)param_data_ptr)
                            ->old_pin_data.data_len,
                        (unsigned char *));
  ...
  case QCRIL_UIM_REQUEST_SET_PIN:
    memcpy(&request_ptr->set_pin, param_data_ptr,
           sizeof(qmi_uim_set_pin_protection_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->set_pin.session_info.aid.data_ptr,
        ((qmi_uim_set_pin_protection_params_type *)param_data_ptr)
            ->session_info.aid.data_ptr,
        ((qmi_uim_set_pin_protection_params_type *)param_data_ptr)
            ->session_info.aid.data_len,
        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->set_pin.pin_data.data_ptr,
        ((qmi_uim_set_pin_protection_params_type *)param_data_ptr)
            ->pin_data.data_ptr,
        ((qmi_uim_set_pin_protection_params_type *)param_data_ptr)
            ->pin_data.data_len,
  ...
  case QCRIL_UIM_REQUEST_DEPERSO:
    memcpy(&request_ptr->deperso, param_data_ptr,
           sizeof(qmi_uim_depersonalization_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->deperso.ck_data.data_ptr,
        ((qmi_uim_depersonalization_params_type *)param_data_ptr)
            ->ck_data.data_ptr,
        ((qmi_uim_depersonalization_params_type *)param_data_ptr)
            ->ck_data.data_len,
        (unsigned char *));
  ...
  case QCRIL_UIM_REQUEST_POWER_UP:
    memcpy(&request_ptr->power_up, param_data_ptr,
           sizeof(qmi_uim_power_up_params_type));
    break;

  case QCRIL_UIM_REQUEST_POWER_DOWN:
    memcpy(&request_ptr->power_down, param_data_ptr,
           sizeof(qmi_uim_power_down_params_type));
    break;

  case QCRIL_UIM_REQUEST_CHANGE_PROV_SESSION:
    memcpy(&request_ptr->change_prov_session, param_data_ptr,
           sizeof(qmi_uim_change_prov_session_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->change_prov_session.app_info.aid.data_ptr,
        ((qmi_uim_change_prov_session_params_type *)param_data_ptr)
            ->app_info.aid.data_ptr,
        ((qmi_uim_change_prov_session_params_type *)param_data_ptr)
            ->app_info.aid.data_len,
        (unsigned char *));
    break;

  case QCRIL_UIM_REQUEST_AUTHENTICATE:
    memcpy(&request_ptr->authenticate, param_data_ptr,
           sizeof(qmi_uim_authenticate_params_type));
    QCRIL_UIM_DUPLICATE(request_ptr->authenticate.session_info.aid.data_ptr,
                        ((qmi_uim_authenticate_params_type *)param_data_ptr)
                            ->session_info.aid.data_ptr,
                        ((qmi_uim_authenticate_params_type *)param_data_ptr)
                            ->session_info.aid.data_len,
                        (unsigned char *));
  ...
  case QCRIL_UIM_REQUEST_LOGICAL_CHANNEL:
    memcpy(&request_ptr->logical_channel, param_data_ptr,
           sizeof(qmi_uim_logical_channel_params_type));
    if (request_ptr->logical_channel.operation_type ==
        QMI_UIM_LOGICAL_CHANNEL_OPEN) {
      QCRIL_UIM_DUPLICATE(
          request_ptr->logical_channel.channel_data.aid.data_ptr,
          ((qmi_uim_logical_channel_params_type *)param_data_ptr)
              ->channel_data.aid.data_ptr,
          ((qmi_uim_logical_channel_params_type *)param_data_ptr)
              ->channel_data.aid.data_len,
          (unsigned char *));
    }
    break;

  case QCRIL_UIM_REQUEST_OPEN_LOGICAL_CHANNEL:
    memcpy(&request_ptr->open_logical_channel, param_data_ptr,
           sizeof(qmi_uim_open_logical_channel_params_type));
    if (((qmi_uim_open_logical_channel_params_type *)param_data_ptr)
            ->aid.data_ptr) {
      QCRIL_UIM_DUPLICATE(
          request_ptr->logical_channel.channel_data.aid.data_ptr,
          ((qmi_uim_open_logical_channel_params_type *)param_data_ptr)
              ->aid.data_ptr,
          ((qmi_uim_open_logical_channel_params_type *)param_data_ptr)
              ->aid.data_len,
          (unsigned char *));
  ...
  case QCRIL_UIM_REQUEST_SEND_APDU:
    memcpy(&request_ptr->send_apdu, param_data_ptr,
           sizeof(qmi_uim_send_apdu_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->send_apdu.apdu.data_ptr,
  ...
  case QCRIL_UIM_REQUEST_GBA:
    memcpy(&request_ptr->gba_init, param_data_ptr,
           sizeof(qmi_uim_gba_params_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->gba_init.session_info.aid.data_ptr,
        ...
        (unsigned char *));
    QCRIL_UIM_DUPLICATE(
        request_ptr->gba_init.naf_id.fqdn.data_ptr,
  ...
  case QCRIL_UIM_REQUEST_SET_TERMINAL_CAPABILITY:
    memcpy(&request_ptr->terminal_capability, param_data_ptr,
           sizeof(qmi_uim_terminal_capability_params_type));
    for (i = 0; i < ((qmi_uim_terminal_capability_params_type *)param_data_ptr)
                        ->num_tlvs &&
                i < QMI_UIM_TERMINAL_CAPABILITY_TLVS_MAX;
         i++) {
      QCRIL_UIM_DUPLICATE(
          request_ptr->terminal_capability.tlvs[i].value.data_ptr,
  ...
  case QCRIL_UIM_REQUEST_EUICC_MEMORY_RESET:
    memcpy(&request_ptr->euicc_reset, param_data_ptr,
           sizeof(qmi_uim_euicc_memory_reset_req_type));
    break;

  case QCRIL_UIM_REQUEST_USER_CONSENT:
    memcpy(&request_ptr->user_consent, param_data_ptr,
           sizeof(qmi_uim_profile_user_consent_req_type));
    break;

  case QCRIL_UIM_REQUEST_GET_EID:
    memcpy(&request_ptr->get_eid, param_data_ptr,
           sizeof(qmi_uim_get_eid_req_type));
    break;

  case QCRIL_UIM_REQUEST_GET_SET_SERVER_ADDRESS:
    memcpy(&request_ptr->euicc_server_address, param_data_ptr,
           sizeof(qmi_uim_euicc_default_server_address_req_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->euicc_server_address.default_smdp_address,
        ((qmi_uim_euicc_default_server_address_req_type *)param_data_ptr)
            ->default_smdp_address,
        strlen(((qmi_uim_euicc_default_server_address_req_type *)param_data_ptr)
                   ->default_smdp_address) +
            1,
        (char *));
    break;
  ...
  case QCRIL_UIM_REQUEST_GET_PROFILE_INFO:
    memcpy(&request_ptr->profile_info, param_data_ptr,
           sizeof(qmi_uim_get_profile_info_req_type));
    break;
  case QCRIL_UIM_REQUEST_SEND_CONF_CODE:
    memcpy(&request_ptr->confirmation_code_req, param_data_ptr,
           sizeof(qmi_uim_conf_code_req_type));
    QCRIL_UIM_DUPLICATE(
        request_ptr->confirmation_code_req.confirmation_code_ptr,
        ((qmi_uim_conf_code_req_type *)param_data_ptr)->confirmation_code_ptr,
        strlen(((qmi_uim_conf_code_req_type *)param_data_ptr)
                   ->confirmation_code_ptr) +
            1,
        (char *));
    break;
  ...
  case QCRIL_UIM_REQUEST_SET_HLOS_PROV_PREFERENCE:
    memcpy(&request_ptr->hlosProvPreference, param_data_ptr,
           sizeof(qmi_uim_hlos_prov_preference_req_type));
    break;

  case QCRIL_UIM_REQUEST_GET_EUICC_INFO2:
    memcpy(&request_ptr->get_euicc_info2, param_data_ptr,
           sizeof(qmi_uim_get_euicc_info2_req_type));
    break;
  case QCRIL_UIM_REQUEST_SET_SIM_TYPE:
    memcpy(&request_ptr->set_sim_type_req, param_data_ptr,
           sizeof(qmi_uim_set_sim_type_req));
    break;
  default:
...
static void deep_clean(uint32_t request_type, req_params *params_ptr) {
  uint32_t i = 0;

  /* Free the request */
  switch (request_type) {
  case QCRIL_UIM_REQUEST_READ_TRANSPARENT:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->read_transparent.session_info.aid.data_ptr);
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->read_transparent.file_id.path.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_READ_RECORD:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->read_record.session_info.aid.data_ptr);
    QCRIL_UIM_FREE_IF_NOT_NULL(params_ptr->read_record.file_id.path.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_WRITE_TRANSPARENT:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->write_transparent.session_info.aid.data_ptr);
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->write_transparent.file_id.path.data_ptr);
    QCRIL_UIM_FREE_IF_NOT_NULL(params_ptr->write_transparent.data.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_WRITE_RECORD:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->write_record.session_info.aid.data_ptr);
  ...
  case QCRIL_UIM_REQUEST_GET_RESPONSE:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->get_attributes.session_info.aid.data_ptr);
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->get_attributes.file_id.path.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_REFRESH_REGISTER:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->refresh_register.session_info.aid.data_ptr);
    QCRIL_UIM_FREE_IF_NOT_NULL(params_ptr->refresh_register.files_ptr);
    break;

  case QCRIL_UIM_REQUEST_GET_FDN:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->get_service_status.session_info.aid.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_SET_FDN:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->set_service_status.session_info.aid.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_VERIFY_PIN:
  case QCRIL_UIM_REQUEST_VERIFY_PIN2:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->verify_pin.session_info.aid.data_ptr);
    QCRIL_UIM_FREE_IF_NOT_NULL(params_ptr->verify_pin.pin_data.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_UNBLOCK_PIN:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->unblock_pin.session_info.aid.data_ptr);
  ...
  case QCRIL_UIM_REQUEST_CHANGE_PIN:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->change_pin.session_info.aid.data_ptr);
  ...
  case QCRIL_UIM_REQUEST_CHANGE_PROV_SESSION:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->change_prov_session.app_info.aid.data_ptr);
    break;

  case QCRIL_UIM_REQUEST_AUTHENTICATE:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->authenticate.session_info.aid.data_ptr);
  ...
  case QCRIL_UIM_REQUEST_LOGICAL_CHANNEL:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->logical_channel.channel_data.aid.data_ptr);
    break;
  ...
  case QCRIL_UIM_REQUEST_SEND_STATUS:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->send_status.session_info.aid.data_ptr);
    break;
  ...
  case QCRIL_UIM_REQUEST_SET_TERMINAL_CAPABILITY:
    for (i = 0; i < params_ptr->terminal_capability.num_tlvs &&
                i < QMI_UIM_TERMINAL_CAPABILITY_TLVS_MAX;
         i++) {
      QCRIL_UIM_FREE_IF_NOT_NULL(
          params_ptr->terminal_capability.tlvs[i].value.data_ptr);
    }
    break;

  case QCRIL_UIM_REQUEST_REMOTE_UNLOCK:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->remote_unlock_req.simlock_data.data_ptr);
    break;
  ...
  case QCRIL_UIM_REQUEST_GET_SET_SERVER_ADDRESS:
    QCRIL_UIM_FREE_IF_NOT_NULL(
        params_ptr->euicc_server_address.default_smdp_address);
    break;
...
===========================================================================*/
UimQmiUimRequestMsg::UimQmiUimRequestMsg(uint32_t msg_id, const void *dataPtr,
                                         void *rsp_data, const void *orig_ptr)
