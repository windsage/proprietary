...
#define QCRIL_ICCID_STR_MAX_SIZE      (23) // MAX ICCID is 22 characters, plus null-terminator.
...
typedef struct clir__pref_query_result {
  uint32_t clir_pref;
  bool found;
} clir_pref_query_result_t;
...
int qcril_db_query_iccid_clir_pref_oldest_entry(char *iccid);
...
#ifdef QMI_RIL_UTF
int qcril_db_clear_iccid_clir_pref_table(); // used in UTF to reset table state
#endif // QMI_RIL_UTF
