...
rm -rf $ANDROID_BUILD_TOP/out/target/product/$TARGET_BOARD_PLATFORM/obj/include/qcril/*
...
STATIC_LIBS=( qcrilAndroidAudioModule qcrilNrQmiModule qcrilNrVoiceModule qcrilNrSampleModule qcrilNrLpaModule qcrilAmModule qcrilNrImsModule qcrilNrCellInfoModule qcrilNrUimModule qcrilNrNasModule qcrilNrPbmModule qcrilNrMbnModule qcrilNrOemHookModule)
