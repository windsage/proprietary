...
// CRITICAL LEVEL would add log to persistent buffer and all hooks
...
/*
 * RPC_CRITICAL LEVEL would be added by default to persistent buffer
 * and on enabling mask would add to all hooks
 */
#define HAP_LEVEL_RPC_CRITICAL     21

#define HAP_LEVEL_RUNTIME   (1 << 31)
