...
#ifdef VERIFY_PRINT_WARN
#define VERIFY_WPRINTF(format, ...) printf(__V_FILE_LINE__ format, ##__VA_ARGS__)
#endif
...
#define VERIFY_IPRINTF(format, ...) FARF(RUNTIME_RPC_LOW, format, ##__VA_ARGS__)
#endif

#ifndef VERIFY_PRINT_ERROR
#define VERIFY_EPRINTF(format, ...) FARF(RUNTIME_RPC_ERROR, format, ##__VA_ARGS__)
#endif

#ifndef VERIFY_PRINT_ERROR_ALWAYS
#define VERIFY_EPRINTF_ALWAYS(format, ...) FARF(RUNTIME_RPC_HIGH, format, ##__VA_ARGS__)
#endif

#ifndef VERIFY_PRINT_WARN
#define VERIFY_WPRINTF(format, ...) FARF(RUNTIME_RPC_MEDIUM, format, ##__VA_ARGS__)
#endif
