...
class BoardTuna(Board):
    def __init__(self, socid):
        super(BoardTuna, self).__init__()
        self.socid = socid
        self.board_num = "tuna"
        self.cpu = 'ARMV9-A'
        self.ram_start = 0x80000000
...
class BoardTunaSVM(Board):
    def __init__(self, socid):
        super(BoardTunaSVM, self).__init__()
        self.socid = socid
        self.board_num = "tunasvm"
        self.cpu = 'ARMV9-A'
        self.ram_start = 0x80000000
        self.smem_addr = 0x1D00000
        self.smem_addr_buildinfo = 0x1D08408
...
class BoardTunaOEMVM(Board):
    def __init__(self, socid):
        super(BoardTunaOEMVM, self).__init__()
        self.socid = socid
        self.board_num = "tunaoemvm"
        self.cpu = 'ARMV9-A'
        self.ram_start = 0x80000000
        self.smem_addr = 0x1D00000
        self.smem_addr_buildinfo = 0x1D08408
...
class BoardKera(Board):
    def __init__(self, socid):
        super(BoardKera, self).__init__()
        self.socid = socid
        self.board_num = "kera"
        self.cpu = 'ARMV9-A'
        self.ram_start = 0x80000000
...
class BoardKeraSVM(Board):
    def __init__(self, socid):
        super(BoardKeraSVM, self).__init__()
        self.socid = socid
        self.board_num = "kerasvm"
        self.cpu = 'ARMV9-A'
        self.ram_start = 0x80000000
        self.smem_addr = 0x1D00000
        self.smem_addr_buildinfo = 0x1D08408
...
class BoardKeraOEMVM(Board):
    def __init__(self, socid):
        super(BoardKeraOEMVM, self).__init__()
        self.socid = socid
        self.board_num = "keraoemvm"
        self.cpu = 'ARMV9-A'
        self.ram_start = 0x80000000
        self.smem_addr = 0x1D00000
        self.smem_addr_buildinfo = 0x1D08408
...
class BoardNiobeSVM(Board):
    def __init__(self, socid):
        super(BoardNiobeSVM, self).__init__()
        self.socid = socid
        self.board_num = "niobesvm"
        self.cpu = 'ARMv8.2-A'
        self.ram_start = 0x80000000
        self.smem_addr = 0x1D00000
        self.smem_addr_buildinfo = 0x1D08408
...
BoardTuna(socid=681)
BoardTunaSVM(socid=681)
BoardTunaOEMVM(socid=681)
BoardTuna(socid=694)
BoardTunaSVM(socid=694)
BoardTunaOEMVM(socid=694)
BoardTuna(socid=655)
BoardTunaSVM(socid=655)
BoardTunaOEMVM(socid=655)

BoardKera(socid=659)
BoardKeraSVM(socid=659)
BoardKeraOEMVM(socid=659)
