...
LOCAL_SRC_FILES := \
        atfwd_daemon.c \
        SendCommand.cpp \
        AtFwdNativeModule/AtFwdServiceImpl.cpp \
        SetupMinijail.cpp
...
LOCAL_VINTF_FRAGMENTS := atfwd-saidl.xml
