...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/6.5/nas_ext/api/network_access_service_ext_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define NAS_EXT_V01_IDL_MINOR_VERS 0x1D
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_EXT_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_EXT_V01_MAX_MESSAGE_ID 0x100B
/**
    @}
  */
...
typedef enum {
  ...
  NAS_EMERG_TYPE_SMS_V01 = 2, /**<  Emergency SMS   */
 ...
 */
  ...
  */
  ...
  /**<   Bitmask representing the emergency mode preference to use.
 Values: \n
 ...
 */
  ...
  /**<   ELENL call information to enforce. 
 ...
 */
  ...
  /**<   Emergency type. Default value if this TLV is not 
 set is NAS_EMERG_TYPE_CALL.\n
 Values: \n
      - NAS_EMERG_TYPE_CALL (0) --  Regular emergency calls\n 
      - NAS_EMERG_TYPE_TEXT (1) --  Emergency text \n 
      - NAS_EMERG_TYPE_SMS (2) --  Emergency SMS  
 */
...
typedef enum {
  ...
  NAS_IMS_CALL_STATUS_HOLD_V01 = 0x03, /**<  All IMS calls are on hold \n  */
  NAS_IMS_CALL_STATUS_RESUME_V01 = 0x04, /**<  Call has resumed  */
...
/** @addtogroup nas_ext_qmi_enums
  ...
  */
typedef enum {
  NAS_IMS_CALL_END_REASON_ENUM_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NAS_IMS_CALL_END_REASON_NORMAL_RELEASE_V01 = 0x00, /**<  Normal release call end reason \n  */
  NAS_IMS_CALL_END_REASON_ABNORMAL_RELEASE_V01 = 0x01, /**<  Abnormal release call end reason  */
  NAS_IMS_CALL_END_REASON_ENUM_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nas_ims_call_end_reason_enum_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Call status. Values: \n 
      ...
      - NAS_IMS_CALL_STATUS_HOLD (0x03) --  All IMS calls are on hold \n 
      - NAS_IMS_CALL_STATUS_RESUME (0x04) --  Call has resumed 
 */
 ...
 \vspace{3pt}
 The call type that must be handled as a part of this request.
 Set only one call type while notifying
 ...
 */
  ...
  nas_ims_call_end_reason_enum_type_v01 call_end_reason;
  /**<   Indicates the call end reason. Values: \n
      - NAS_IMS_CALL_END_REASON_NORMAL_RELEASE (0x00) --  Normal release call end reason \n 
      - NAS_IMS_CALL_END_REASON_ABNORMAL_RELEASE (0x01) --  Abnormal release call end reason 
 */

  /* Optional */
  /*  Call Termination */
  uint8_t call_termination_valid;  /**< Must be set to true if call_termination is being passed */
  uint8_t call_termination;
  /**<   Indicates whether the call terminates or redials. 
       This TLV only applies when the Call State TLV has the value of NAS_IMS_CALL_STATUS_STOP. 
       When this TLV is not present, it has a value of 0x01. 
       Values: \n
       - 0x00 -- Redial call \n
       - 0x01 -- Terminate call
  */
...
typedef struct {
  ...
  /**<   Bitmask representing the mode preference to use for redialing the 
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Concurrent Call Not Possible */
  uint8_t concurrent_call_not_possible_valid;  /**< Must be set to true if concurrent_call_not_possible is being passed */
  uint8_t concurrent_call_not_possible;
  /**<   TRUE indicates the request was rejected due to a concurrent call on the other subscription. \n
       Applies only when the Result Code indicates failure. \n
       Values : \n
        - TRUE -- Failure is due to a concurrent call on the other subscription \n
        - FALSE -- Otherwise
  */
...
typedef enum {
  ...
  NAS_MMTEL_SUCCESS_V01 = 1, /**<  Proceed with the call (UAC check is performed when sys_mode is NR5G-SA) \n */
  NAS_MMTEL_ACCESS_BARRED_V01 = 2, /**<  Access barred. Applicable only to NR5G-SA \n */
  NAS_MMTEL_INVALID_RAT_V01 = 3, /**<  Sys_mode requested in QMI_NAS_IMS_CALL_STATE_NOTIFICATION_REQ_MSG is different from the camped RAT. Backoff and retry. No UAC check performed \n */
  NAS_MMTEL_INVALID_STATE_V01 = 4, /**<  UE is not in a state to handle MMTEL; no UAC check performed.\n  */
  ...
  NAS_MMTEL_SERVICE_AREA_RESTRICTION_V01 = 7, /**<  Service area is restricted; no UAC check performed. Applicable only to NR5G-SA \n  */
...
typedef struct {
  ...
  /**<   MMTEL Response. Values: \n
      - NAS_MMTEL_SUCCESS (1) --  Proceed with the call (UAC check is performed when sys_mode is NR5G-SA) \n
      - NAS_MMTEL_ACCESS_BARRED (2) --  Access barred. Applicable only to NR5G-SA \n
      - NAS_MMTEL_INVALID_RAT (3) --  Sys_mode requested in QMI_NAS_IMS_CALL_STATE_NOTIFICATION_REQ_MSG is different from the camped RAT. Backoff and retry. No UAC check performed \n
      - NAS_MMTEL_INVALID_STATE (4) --  UE is not in a state to handle MMTEL; no UAC check performed.\n 
      ...
      - NAS_MMTEL_SERVICE_AREA_RESTRICTION (7) --  Service area is restricted; no UAC check performed. Applicable only to NR5G-SA \n 
 */
  ...
  /*  Sys Mode */
  nas_radio_if_enum_v01 sys_mode;
  /**<   Radio interface system mode; the same sys_mode 
       specified in the MMTEL call state indication.\n
       Values: \n  
       - NAS_RADIO_IF_LTE        -- 0x08 --LTE \n 
       - NAS_RADIO_IF_NR5G       -- 0x0C --NR5G 
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Request Message; Controls NR5G deprioritization during voice and video Wi-Fi calls. */
typedef struct {

  /* Mandatory */
  /*  Deprioritize NR5G */
  uint8_t deprioritize_nr5g;
  /**<    Enable/disable NR5G deprioritization during voice/video Wi-Fi call. 
        Values : \n
        - TRUE -- Enable NR5G deprioritization. \n
        - FALSE -- Disable NR5G deprioritization.
  */
}nas_wifi_ho_deprioritize_nr5g_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Response Message; Controls NR5G deprioritization during voice and video Wi-Fi calls. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
       ...
       - qmi_error_type  -- Error code. Possible error code values are described in
                          the error codes section of each message definition.
  */
}nas_wifi_ho_deprioritize_nr5g_resp_msg_v01;  /* Message */
/**
    @}
  */

typedef uint64_t nas_avoid_rat_mask_type_v01;
#define NAS_AVOID_RAT_LTE_V01 ((nas_avoid_rat_mask_type_v01)0x01ull) /**<  LTE \n  */
#define NAS_AVOID_RAT_NR5G_V01 ((nas_avoid_rat_mask_type_v01)0x02ull) /**<  NR5G  */
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Request Message; Updates the PLMN and RAT to avoid for an emergency call. */
typedef struct {

  /* Optional */
  /*  Avoid PLMN */
  uint8_t plmn_valid;  /**< Must be set to true if plmn is being passed */
  nas_plmn_id_ext_type_v01 plmn;
  /**<   Contains the PLMN to avoid. If this TLV is not present,
       the modem avoids the current serving PLMN.
  */

  /* Optional */
  /*  Avoid System */
  uint8_t rat_mask_valid;  /**< Must be set to true if rat_mask is being passed */
  nas_avoid_rat_mask_type_v01 rat_mask;
  /**<   Bitmask representing the RAT to avoid. If the TLV is not present,
 the modem avoids both LTE and NR5G.
 Values: \n
      - NAS_AVOID_RAT_LTE (0x01) --  LTE \n 
      - NAS_AVOID_RAT_NR5G (0x02) --  NR5G 
 */
}nas_emerg_avoid_plmn_rat_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Response Message; Updates the PLMN and RAT to avoid for an emergency call. */
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
}nas_emerg_avoid_plmn_rat_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Indication Message; Indicates the clients of a mobile-originated IMS registration related signaling access attempt.  */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_mo_ims_reg_uac_barring_alleviation_ind_msg_v01;
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Indication Message; Indicates clients that the network is congested.  */
typedef struct {

  /* Optional */
  /*  Network Congestion  */
  uint8_t nw_congestion_valid;  /**< Must be set to true if nw_congestion is being passed */
  uint8_t nw_congestion;
  /**<   Indicates whether network congestion is from the network or due to an internal cause. Values: \n
       - TRUE -- Network \n
       - FALSE -- Internal.    
  */
  ...
  /**<   Remaining timer value (in milliseconds); based on value from the Network Congestion TLV: \n 
       - T3346 -- Network congestion \n
       - T3525 -- Internal cause.     
  */
}nas_notify_nw_congestion_ind_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Request Message; Commands the modem to start the UAC check for IMS registration for a specified RAT. */
typedef struct {

  /* Mandatory */
  /*  Radio Access Technology */
  nas_radio_if_enum_v01 sys_mode;
  /**<   RAT for which the UAC check must start for IMS registration. Values: \n 
      - NAS_RADIO_IF_LTE (0x08) --  LTE \n 
      - NAS_RADIO_IF_NR5G (0x0C) --  NR5G \n .
 */
}nas_start_ims_reg_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Response Message; Commands the modem to start the UAC check for IMS registration for a specified RAT. */
typedef struct {
  ...
  uint8_t timer_value_valid;  /**< Must be set to true if timer_value is being passed */
  uint32_t timer_value;
  /**<   Remaining timer value (in milliseconds); based on value from the UAC Check Response TLV:\n
       NAS_MMTEL_ACCESS_BARRED -- Barring Duration.\n
       NAS_MMTEL_T3346_ACTIVE  -- Timer 3346 remaining time.
  */

  /* Optional */
  /*  UAC Check Response */
  uint8_t status_valid;  /**< Must be set to true if status is being passed */
  nas_mmtel_response_enum_type_v01 status;
  /**<   UAC check response for IMS registration on a specified mode. Values: \n
      - NAS_MMTEL_SUCCESS (1) --  Proceed with the call (UAC check is performed when sys_mode is NR5G-SA) \n
      - NAS_MMTEL_ACCESS_BARRED (2) --  Access barred. Applicable only to NR5G-SA \n
      - NAS_MMTEL_INVALID_RAT (3) --  Sys_mode requested in QMI_NAS_IMS_CALL_STATE_NOTIFICATION_REQ_MSG is different from the camped RAT. Backoff and retry. No UAC check performed \n
      - NAS_MMTEL_INVALID_STATE (4) --  UE is not in a state to handle MMTEL; no UAC check performed.\n 
      ...
      - NAS_MMTEL_SERVICE_AREA_RESTRICTION (7) --  Service area is restricted; no UAC check performed. Applicable only to NR5G-SA \n .
 */
}nas_start_ims_reg_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Request Message; Commands the modem to stop the UAC check for IMS registration for a specified RAT.  */
typedef struct {

  /* Mandatory */
  /*  Radio Access Technology */
  nas_radio_if_enum_v01 sys_mode;
  /**<   RAT for which to stop the UAC check for IMS registration: \n
      - NAS_RADIO_IF_LTE (0x08) --  LTE \n 
      - NAS_RADIO_IF_NR5G (0x0C) --  NR5G \n 
 */
}nas_stop_ims_reg_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Response Message; Commands the modem to stop the UAC check for IMS registration for a specified RAT.  */
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 result;
  /**<   Standard response type. Contains the following data members:
     - qmi_result_type -- QMI_RESULT_SUCCESS or QMI_RESULT_FAILURE \n
     - qmi_error_type  -- Error code. Possible error code values are described in \n
                          the error codes section of each message definition.
   */
}nas_stop_ims_reg_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Request Message; Commands the modem to attempt LTE acquistion during an external IMS call. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_force_lte_fallback_req_msg_v01;
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Response Message; Commands the modem to attempt LTE acquistion during an external IMS call. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described in
                          the error codes section of each message definition.
  */
}nas_force_lte_fallback_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Indication Message; Indicates that a Voice over New Radio (VoNR) call is not possible. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_vonr_not_possible_ind_msg_v01;
...
/** @addtogroup nas_ext_qmi_messages
    @{
  */
/** Indication Message; Reports if UE can originate the E911 SMS.  */
typedef struct {

  /* Optional */
  /*  SMS Ready */
  uint8_t sms_ready_valid;  /**< Must be set to true if sms_ready is being passed */
  uint8_t sms_ready;
  /**<   Indicates if SMS can be originated. Values: \n        
       - TRUE -- SMS can be originated \n
       - FALSE -- SMS cannot be originated   
    */
}nas_e911_sms_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_NAS_E911_SMS_STATUS_IND_V01
//#define REMOVE_QMI_NAS_E911_STATE_READY_IND_V01
//#define REMOVE_QMI_NAS_EMERG_AVOID_PLMN_RAT_V01
//#define REMOVE_QMI_NAS_FORCE_LTE_FALLBACK_V01
...
//#define REMOVE_QMI_NAS_MO_IMS_REG_UAC_BARRING_ALLEVIATION_IND_V01
//#define REMOVE_QMI_NAS_NOTIFY_NW_CONGESTION_IND_V01
//#define REMOVE_QMI_NAS_SET_E911_STATE_V01
//#define REMOVE_QMI_NAS_START_IMS_REG_V01
//#define REMOVE_QMI_NAS_STOP_IMS_REG_V01
...
//#define REMOVE_QMI_NAS_VONR_NOT_POSSIBLE_IND_V01
//#define REMOVE_QMI_NAS_WIFI_HO_DEPRIORITIZE_NR5G_V01
...
#define QMI_NAS_WIFI_HO_DEPRIORITIZE_NR5G_REQ_MSG_V01 0x1003
#define QMI_NAS_WIFI_HO_DEPRIORITIZE_NR5G_RESP_MSG_V01 0x1003
#define QMI_NAS_EMERG_AVOID_PLMN_RAT_REQ_MSG_V01 0x1004
#define QMI_NAS_EMERG_AVOID_PLMN_RAT_RESP_MSG_V01 0x1004
#define QMI_NAS_MO_IMS_REG_UAC_BARRING_ALLEVIATION_IND_V01 0x1005
#define QMI_NAS_NOTIFY_NW_CONGESTION_IND_V01 0x1006
#define QMI_NAS_START_IMS_REG_REQ_V01 0x1007
#define QMI_NAS_START_IMS_REG_RESP_V01 0x1007
#define QMI_NAS_STOP_IMS_REG_REQ_V01 0x1008
#define QMI_NAS_STOP_IMS_REG_RESP_V01 0x1008
#define QMI_NAS_FORCE_LTE_FALLBACK_REQ_MSG_V01 0x1009
#define QMI_NAS_FORCE_LTE_FALLBACK_RESP_MSG_V01 0x1009
#define QMI_NAS_VONR_NOT_POSSIBLE_IND_V01 0x100A
#define QMI_NAS_E911_SMS_STATUS_IND_V01 0x100B
/**
    @}
  */
